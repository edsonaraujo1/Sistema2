...
Pedimos para todos os usuários que utilizam o programa
Sindificios, que opinem e de sugestões para que o programa
supra as necessidades tanto do usuário quanto do Sindicato,
de sua sugestão para melhorar o Modulo que você usa, saiba que 
esse programa só será 100% funcional se você funcionário e
usuário relatar erros e falhas assim como comando que não
estão funcionando problemas nos acessos, consultas, e demais
funções, assim como relatórios e impressões.
Um Grande abraço<br /><br />

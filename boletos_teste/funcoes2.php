...
function Salva_conf_avul1(Var1)
{
     ...
     if(Var1.value.length >0)
     {
     window.location = "salva_session_conf_avul.php?Var_1="+Var1.value;     
	 }
}
function Salva_conf_avul2(Var2)
{
     ...
     if(Var2.value.length >0)
     {
     window.location = "salva_session_conf_avul.php?Var_2="+Var2.value;     
	 }
}
function Salva_conf_avul3(Var3)
{
     ...
     if(Var3.value.length >0)
     {
     window.location = "salva_session_conf_avul.php?Var_3="+Var3.value;     
	 }
}
function Salva_conf_avul4(Var4)
{
     ...
     if(Var4.value.length >0)
     {
     window.location = "salva_session_conf_avul.php?Var_4="+Var4.value;     
	 }
}

...
<form style="margin-bottom: 0" id="Unit2" name="Unit2" method="post"  action="salva3.php">
...
<div id="Label11x_outer" style="Z-INDEX: 4; LEFT: 624px; WIDTH: 103px; POSITION: absolute; TOP: 182px; HEIGHT: 26px">
<div id="Label11x" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:103px;"   ><STRONG>Nº Linhas.:</STRONG>&nbsp;</div>
</div>

<div id="Edit5_outer" style="Z-INDEX: 6; LEFT: 716px; WIDTH: 60px; POSITION: absolute; TOP: 178px; HEIGHT: 27px">
<input type="text" id="linha1" name="linha1" value="<?php echo $linha1 ?>" style=" font-family: Verdana; font-size: 14px;  height:26px;width:60px;"    tabindex="0"    />
</div>

<div id="Label1_outer" style="Z-INDEX: 5; LEFT: 221px; WIDTH: 370px; POSITION: absolute; TOP: 87px; HEIGHT: 32px">
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?php echo $color_bor ?>; background-color: #FFFFFF;height:32px;width:370px;"   ><STRONG>Coluna Principal</STRONG></div>
</div>
...
<div id="Edit2_outer" style="Z-INDEX: 7; LEFT: 224px; WIDTH: 552px; POSITION: absolute; TOP: 205px; HEIGHT: 190px">

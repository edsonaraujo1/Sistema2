...
<div id="Label2" style=" font-family: Verdana; font-size: 14px; font-weight: bold; height:18px;width:128px;"   > Consultar: </div>
</div>
...
<div id="Label31_outer" style="Z-INDEX: 7; LEFT: 225px; WIDTH: 400px; POSITION: absolute; TOP: 84px; HEIGHT: 32px">
<div id="Label31" style=" font-family: Verdana; font-size: 20px; color: <?php echo $color_bor ?>;font-weight: bold;text-align: left; height:32px;width:400px;"   >Consultar Noticias (materias)</div>
</div>

...
<form style="margin-bottom: 0" id="Unit2" name="Unit2" method="post"  action="salva12.php">
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?php echo $color_bor ?>; background-color: #FFFFFF;height:32px;width:370px;"   ><STRONG>Link Odontologico</STRONG></div>
</div>

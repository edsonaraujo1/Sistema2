...
/*
 ...
 Finalidade.........: Consultar Cadastro Instrucao
...
<form name="form1" type='hidden' method='POST' action='instrupesquisa.php'>
...
<select id="Edit1" name="Edit1" value="<?=$Edit1;?>" onfocus="this.className='anormal'" onblur="this.className='normal'" style=" font-family: Verdana; font-size: 14px;  height:23px;width:169px;"  maxlength=10  tabindex="0"    />
...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" onfocus="this.className='anormal'" onblur="this.className='normal'"  style=" font-family: Verdana; font-size: 14px;  height:23px;width:446px;"  maxlength=40  tabindex="0"    />
</div>
...
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>;font-weight: bold;text-align: left; height:32px;width:320px;"   > Consultar Instrução </div>
</div>

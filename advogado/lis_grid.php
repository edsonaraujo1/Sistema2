...
if ($Opcao == "CODIGO"){
   ...
   $sql  = "SELECT * FROM cadadv WHERE CODIGO >= '$Procura' ORDER BY CODIGO ASC";
	
}
if ($Opcao == "NOME"){

   $sql  = "SELECT * FROM cadadv WHERE NOME >= '$Procura' ORDER BY NOME ASC";
	
}
if ($Opcao == "C.P.F."){

   $sql  = "SELECT * FROM cadadv WHERE CPF >= '$Procura' ORDER BY CPF ASC";
     ...
     <td><input type=image name='Voltar' src='../imagens/botao_voltar.PNG'></td>
      ...
      echo "
       ...
       while ($linha = mysql_fetch_array($resultado))
       {
		...
		$coluna3  = $linha["FONE"];
		$coluna4  = trim($linha["CELULAR"]);


        if ($faz == 1){
           ?>
           
  	       <td valign=top><b>CODIGO</b><th><b>NOME</b><th><b>FONE</b><th><b>CELULAR</b></td>

...
$consulta0  = "SELECT * FROM cadadv WHERE id = '$Cod_2'";
...
$consulta1 = "INSERT INTO cadadv_excluir   (CODIGO,
											NOME,
		                                    CPF,
											RG,
											OAB,
...
// Exclui Edificio
$consulta2 = "DELETE FROM cadadv WHERE id = '$Cod_2'";

@mysql_query($consulta2, $link);


// Organiza Tabela apos a Exclusao
$sql0 = 'ALTER TABLE `cadadv` ORDER BY `CODIGO`';
$res0 = mysql_query($sql0);

$sql3 = 'ALTER TABLE `cadadv` DROP `id`';
$res3 = mysql_query($sql3);

$sql4 = 'ALTER TABLE `cadadv` ADD `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST';
$res4 = mysql_query($sql4);


$consulta4  = "SELECT * FROM cadadv ORDER BY id ASC LIMIT 0,50";

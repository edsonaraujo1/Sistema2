...
if ($Opcao == "CODIGO"){
    ...
    $consulta  = "SELECT * FROM cadadv WHERE CODIGO = '$Procura' ORDER BY CODIGO";
}
if ($Opcao == "NOME"){

    $consulta  = "SELECT * FROM cadadv WHERE NOME like '$Procura%' ORDER BY NOME";
}
if ($Opcao == "C.P.F"){

    $consulta  = "SELECT * FROM cadadv WHERE CPF like '$Procura%' ORDER BY CPF";
}

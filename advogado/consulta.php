...
<select id="Edit1" name="Edit1" value="<?=$Edit1;?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:169px; background-color: #FFFFFF;"  maxlength='10' onchange="Salva_Etq_edif1(this)"  tabindex="0"    />
	...
	<option value="<?=$Edit1;?>"> <?=$Edit1;?> </option>
            ...
            <option value="C.P.F"> C.P.F </option>
...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:446px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit2', '999.999.999-99', event);"  maxlength='18'  tabindex="0"    />
</div>
...
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>;font-weight: bold;text-align: left; height:32px;width:320px;"   >Consultar Advogados </div>
</div>

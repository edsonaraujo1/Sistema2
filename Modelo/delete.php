...
// Salva Registro excluido em tabela temporaria
		$consulta1 = "INSERT INTO edif_excluido (COD,
											    ATIV,
		                                    	DATA,
												COND,
												NOME,
...
// Exclui Edificio
//$consulta2 = "DELETE FROM edificios WHERE id = '$Cod_2'";

$consulta2 = "DELETE FROM edificios WHERE id = '". anti_sql_injection($Cod_2) ."'";
...
$consulta4  = "SELECT * FROM edificios ORDER BY id ASC LIMIT 0,50";
...
<div id="Menssage" style=" font-family: Verdana; font-size: 14px;  height:24px;width:208px;"  align="Center"   ><STRONG>*** Excluido ***</STRONG></div>
</div>

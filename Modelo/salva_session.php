...
if (!empty($cep_2)){
    ...
    $Edit9 = $_GET["Edit9"];
	$add9  = "UPDATE $nome3a SET Edit6    = '$Logra_2',
	                             Edit7    = '$rua_2',
	                             Edit9    = '$Edit9',
	                             Edit10   = '$bairro',
...
$consulta2 = "SELECT cod,nomeadm FROM adms Where cod = $_GET[Edit19]";
...
$cod_adm      = @$row2["cod"];
$nome2_adms   = retirar_carac(@$row2["nomeadm"]);

$Edit19 = $_GET["Edit19"];
$add19 = "UPDATE $nome3a SET Edit19    = '$Edit19', mensage3  = '$nome2_adms' WHERE Nome1 = '$nome3a'";

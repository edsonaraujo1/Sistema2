...
// Primeiro Bloco
		...
		$operadora = 'NILVA';
		$sql1a  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana1' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND TIPO_MOV = '29'";
		...
		while($linhaa = @mysql_fetch_array($resultado1a)) {
            ...
            $total_sub1a4 = $total_sub1a4 +  $vlr_tot;
		}


		$pdf->SetXY(12,$lin+30);
		$pdf->MultiCell(35,5, 'Prom. S/CH.Pre-Datado', 1, 'L',0); // J Justificado
		...
		$sql1b  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana2' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND TIPO_MOV = '29'";
		...
		while($linhab = @mysql_fetch_array($resultado1b)) {
			...
			$total_sub2a4 = $total_sub2a4 +  $vlr_tot;
		...
		$sql1c  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana3' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND TIPO_MOV = '29'";
		...
		while($linhac = @mysql_fetch_array($resultado1c)) {
            ...
            $total_sub3a4 = $total_sub3a4 +  $vlr_tot;
		}
		...
		$sql1d  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana4' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND TIPO_MOV = '29'";
		...
		while($linhad = @mysql_fetch_array($resultado1d)) {
			...
			$total_sub4a4 = $total_sub4a4 +  $vlr_tot;
		...
		$sql1e  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana5' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND TIPO_MOV = '29'";
		...
		while($linhae = @mysql_fetch_array($resultado1e)) {
			...
			$total_sub5a4 = $total_sub5a4 +  $vlr_tot;
		...
		$sql1f  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana6' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND TIPO_MOV = '29'";
		...
		while($linhaf = @mysql_fetch_array($resultado1f)) {
			...
			$total_sub6a4 = $total_sub6a4 +  $vlr_tot;
		...
		$sql1g  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana7' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND TIPO_MOV = '29'";
		...
		while($linhag = @mysql_fetch_array($resultado1g)) {
			...
			$total_sub7a4 = $total_sub7a4 +  $vlr_tot;

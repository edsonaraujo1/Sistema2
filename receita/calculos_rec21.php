...
// Primeiro Bloco
		...
		$mensa1 = 145;
		$mensa2 = 151
		$sql1a  = "SELECT * FROM `caixa` WHERE TIPO_MOV >= '$mensa1' AND TIPO_MOV <= '$mensa2' AND SUBSTRING(DATA,1,2) = '$semana1' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		$pdf->SetXY(12,$lin+10);
		$pdf->MultiCell(35,5, 'NASA', 1, 'L',0); // J Justificado
		...
		$sql1b  = "SELECT * FROM `caixa` WHERE TIPO_MOV >= '$mensa1' AND TIPO_MOV <= '$mensa2' AND SUBSTRING(DATA,1,2) = '$semana2' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		$sql1c  = "SELECT * FROM `caixa` WHERE TIPO_MOV >= '$mensa1' AND TIPO_MOV <= '$mensa2' AND  SUBSTRING(DATA,1,2) = '$semana3' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		$sql1d  = "SELECT * FROM `caixa` WHERE TIPO_MOV >= '$mensa1' AND TIPO_MOV <= '$mensa2' AND  SUBSTRING(DATA,1,2) = '$semana4' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		while($linhad = @mysql_fetch_array($resultado1d)) {
			...
			if ($t_moe_cart1 == 'T'){
				...
				$total_cart4h = $total_cart4h + $vlr_tot;
				
			}else{
				
				$total_dinhei4h = $total_dinhei4h + $vlr_tot;
			}
		...
		$sql1e  = "SELECT * FROM `caixa` WHERE TIPO_MOV >= '$mensa1' AND TIPO_MOV <= '$mensa2'  AND  SUBSTRING(DATA,1,2) = '$semana5' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		$sql1f  = "SELECT * FROM `caixa` WHERE TIPO_MOV >= '$mensa1' AND TIPO_MOV <= '$mensa2' AND  SUBSTRING(DATA,1,2) = '$semana6' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		$sql1g  = "SELECT * FROM `caixa` WHERE TIPO_MOV >= '$mensa1' AND TIPO_MOV <= '$mensa2' AND  SUBSTRING(DATA,1,2) = '$semana7' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";

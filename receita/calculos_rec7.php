...
// Primeiro Bloco
		...
		$operadora = 'NILVA';
		$sql1a  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana1' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		while($linhaa = @mysql_fetch_array($resultado1a)) {
            ...
            $total_sub1a3 = $total_sub1a3 +  $vlr_tot;
		}


		$pdf->SetXY(12,$lin+30);
		$pdf->MultiCell(35,5, 'Cartao Credito/Deb.', 1, 'L',0); // J Justificado
		...
		$sql1b  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana2' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		while($linhab = @mysql_fetch_array($resultado1b)) {
			...
			$total_sub2a3 = $total_sub2a3 +  $vlr_tot;
		...
		$sql1c  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana3' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		while($linhac = @mysql_fetch_array($resultado1c)) {
            ...
            $total_sub3a3 = $total_sub3a3 +  $vlr_tot;
		}
		...
		$sql1d  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana4' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		while($linhad = @mysql_fetch_array($resultado1d)) {
			...
			$total_sub4a3 = $total_sub4a3 +  $vlr_tot;
		...
		$sql1e  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana5' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		while($linhae = @mysql_fetch_array($resultado1e)) {
			...
			$total_sub5a3 = $total_sub5a3 +  $vlr_tot;
		...
		$sql1f  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana6' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		while($linhaf = @mysql_fetch_array($resultado1f)) {
			...
			$total_sub6a3 = $total_sub6a3 +  $vlr_tot;
		...
		$sql1g  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana7' AND OPERADORA = '$operadora' AND SUBSTRING(DATA,4,7) = '$inicio' AND T_MOEDA = 'T'";
		...
		while($linhag = @mysql_fetch_array($resultado1g)) {
			...
			$total_sub7a3 = $total_sub7a3 +  $vlr_tot;

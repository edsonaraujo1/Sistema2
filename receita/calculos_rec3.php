...
// Primeiro Bloco
		...
		$operadora_sub = 'SANTANA';
		$sql1a  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana1' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio'";
		...
		while($linhaa = @mysql_fetch_array($resultado1a)) {
            ...
            $total_sub1a = $total_sub1a +  $vlr_tot;
		}


		$pdf->SetXY(12,$lin+10);
		$pdf->MultiCell(35,5, 'Santana', 1, 'L',0); // J Justificado
		...
		$sql1b  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana2' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio'";
		...
		while($linhab = @mysql_fetch_array($resultado1b)) {
			...
			$total_sub2a = $total_sub2a +  $vlr_tot;
		...
		$sql1c  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana3' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio'";
		...
		while($linhac = @mysql_fetch_array($resultado1c)) {
            ...
            $total_sub3a = $total_sub3a +  $vlr_tot;
		}
		...
		$sql1d  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana4' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio'";
		...
		while($linhad = @mysql_fetch_array($resultado1d)) {
			...
			$total_sub4a = $total_sub4a +  $vlr_tot;
		...
		$sql1e  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana5' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio'";
		...
		while($linhae = @mysql_fetch_array($resultado1e)) {
			...
			$total_sub5a = $total_sub5a +  $vlr_tot;
		...
		$sql1f  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana6' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio'";
		...
		while($linhaf = @mysql_fetch_array($resultado1f)) {
			...
			$total_sub6a = $total_sub6a +  $vlr_tot;
		...
		$sql1g  = "SELECT * FROM `caixa` WHERE SUBSTRING(DATA,1,2) = '$semana7' AND OPERADORA = '$operadora_sub' AND SUBSTRING(DATA,4,7) = '$inicio'";
		...
		while($linhag = @mysql_fetch_array($resultado1g)) {
			...
			$total_sub7a = $total_sub7a +  $vlr_tot;
        ...
        $total_1b   = $total_semana1+$total_semana2+$total_semana3+$total_semana4+$total_semana5+$total_semana6+$total_semana7+$total_semana8;

		$pdf->SetXY(222,$lin+10);
		$pdf->MultiCell(25,5, number_format($total_1b,2,",","."), 1, 'R',0); // J Justificado

...
$titulo_tabela = "Tabela 'CLASSE' Alterar";
?>
...
$sql  = "SELECT * FROM classe WHERE codigo = '" . $_GET['Cod_2'] . "'";
...
<form type="hidden" method="POST" action="cadastrar_categoria.php?Acao=update">

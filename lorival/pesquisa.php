...
if ($Opcao == "MATRICULA"){
    ...
    $consulta  = "SELECT * FROM atendimento_soc WHERE CODP = '$Procura' ORDER BY CODP";
}
if ($Opcao == "RG"){

    $consulta  = "SELECT * FROM atendimento_soc WHERE RGASSOC = '$Procura' ORDER BY RGASSOC";
}
if ($Opcao == "CPF"){

    $consulta  = "SELECT * FROM atendimento_soc WHERE CPF = '$Procura' ORDER BY CPF";
}
if ($Opcao == "NOME"){

    $consulta  = "SELECT * FROM atendimento_soc WHERE NOMEASSOC like '$Procura%' ORDER BY NOMEASSOC";
}

if ($Opcao == "DATA"){

    $consulta  = "SELECT * FROM atendimento_soc WHERE str_to_date( DATINSC, '%d/%m/%Y') >= str_to_date( '$Procura', '%d/%m/%Y') ORDER BY str_to_date( DATINSC, '%d/%m/%Y')";
}

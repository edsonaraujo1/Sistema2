...
<form style="margin-bottom: 0" id="Unit2" name="Unit2" method="post"  action="atendisoclayout.php">
...
<div id="Label3" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:18px;width:114px;"   > <STRONG>Dat.Inscricao.:</STRONG> </div>
</div>
...
<input type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:254px; background-color: #FFFFFF;" disabled   tabindex="5"    />
</div>

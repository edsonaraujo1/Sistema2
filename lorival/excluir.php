...
if (!empty($Cod_2)){
   ...
   $consulta  = "SELECT * FROM atendimento_soc Where id = '$Cod_2'";
	
}

if (!empty($id_navega)){

   $consulta  = "SELECT * FROM atendimento_soc Where id = '$id_navega'";
...
if (empty($id)){
   ...
   $consulta  = "SELECT * FROM atendimento_soc Where COD = '$id_navega'";

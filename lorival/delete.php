...
$consulta0  = "SELECT * FROM atendimento_soc WHERE id = '$Cod_2'";
...
$consulta1 = "INSERT INTO atendimento_soc_excluido     (COD,
                                     			DAT2,
								     			DATINSC,
											    RGASSOC,
											    CPF,
...
// Exclui Edificio
$consulta2 = "DELETE FROM atendimento_soc WHERE id = '$Cod_2'";

@mysql_query($consulta2, $link);

$consulta4  = "SELECT * FROM atendimento_soc ORDER BY id ASC LIMIT 0,50";

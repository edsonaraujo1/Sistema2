...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:95px;" onfocus="this.className='anormal'; nextfield ='Edit4';" onblur="this.className='normal'"  onchange="Salva2(this.value)" style="text-transform: uppercase;"  tabindex="0"    />
</div>
...
<div id="Image1_container" style=" width: 104;  height: 112; overflow: hidden;" ><img id="Image1" src="<?=$cami2;?>"  width="104"  height="112"  border="0"       /></div>
</div>

...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:95px;" onfocus="this.className='anormal'; nextfield ='Edit3';" onblur="this.className='normal'"  onchange="Salva2(this.value)" style="text-transform: uppercase;"  tabindex="0"    />
</div>
...
<input type="text" id="Edit3" name="Edit3" value="<?=$Edit3;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:111px;" onfocus="this.className='anormal'; nextfield ='Edit4';" onblur="this.className='normal'"  onchange="Salva3(this.value)" style="text-transform: uppercase;"  tabindex="0"    />
</div>
...
<select type="text" id="Edit4" name="Edit4" value="<?=$Edit4;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:391px;" onfocus="this.className='anormal'; nextfield ='Edit5';" onblur="this.className='normal'"  onchange="Salva4(this.value)" style="text-transform: uppercase;" tabindex="0"    />
...
if (!empty($Edit4)){
	...
	?>
	<option value="<?='0,'.$Edit4;?>"><?=$Edit4;?></option>
	<option value="<?='1,'.$dep_[1];?>"><?=$dep_[1];?></option>
	<?	
	...
	for ($si = 2; $si < 11; $si++){
		...
		if (!empty($dep_[$si])){
           ...
           if ($soma1 >= 18){ 
			   ...
			   ?>
			   <option value="<?=$si.','.$dep_[$si];?>"><?=$dep_[$si];?><?=$maior_18;?></option>
			   <?
			   $maior_18 = "";
			   ...
			   ?>
			   <option value="<?=$si.','.$dep_[$si];?>"><?=$dep_[$si];?></option>
			   <?
	...
	?>
	<option value="<?=$si.','.$Edit4;?>;?>"><?=$Edit4;?></option>
	<?	

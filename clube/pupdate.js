/*
 ...
 Finalidade.........: Rotina Auxiliares JavaScript PopUp Calendar v2.1
...
var ppcWN = new Array("Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sabado");
var ppcER = new Array(4);
ppcER[0] = "Necessário DHTML funções não são suportadas neste navegador.";
ppcER[1] = "Alvo formulário de campo não é atribuída ou não acessíveis.";
ppcER[2] = "Lamentamos, mas a data escolhida não é aceitável. Por favor, leia as instruções na página.";
ppcER[3] = "Ocorreu um erro desconhecido durante executar este script.";
var ppcUC = false;
 var ppcUX = 4;
 var ppcUY = 4;
...
var ppcWE=new Array("Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sabado");
...
function restoreLayers(e) {
 if (ppcNN) {
  with (window.document) {
   open("text/html");
   write("<html><head><title>Restabelecimento da camada estrutura ...</title></head>");

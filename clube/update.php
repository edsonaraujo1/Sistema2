...
$Edit18		= trim(retirar_carac2(@$row0["Edit18"]));
...
$Edit22		= trim(retirar_carac2(@$row0["memo1"]));
$id_a       = trim(retirar_carac2(@$row0["mensage6"]));
...
$consulta = "UPDATE clube_tiete    SET          DATA 		= '$Edit3',  
												NOME 		= '$Edit4',  
												SEXO 		= '$Edit5',  
												DATNASC 	= '$Edit6',  
												NACION1 	= '$Edit7',  
...
<table border='0' aling=center>
          ...
          <form method="POST" action="cadastro.php?cod_5=<?=$id_a;?>">

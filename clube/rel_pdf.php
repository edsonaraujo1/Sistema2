...
$sql  = "SELECT * FROM clube_tiete ORDER BY CODIGO, LETRA ASC";
...
if ($cont_linha == 0){
	...
	$pdf->SetXY(12,20);
	$pdf->MultiCell(268,5, 'Listagem de Convenio Clube Tiete', 0, 'C',0); // J Justificado
	$pdf->SetFont('Arial', 'B', 7);

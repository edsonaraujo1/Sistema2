...
$mat  = trim($_POST['mat']).trim(strtoupper($_POST['mat2']));
	...
	$consulta = "SELECT * FROM tb_quarta WHERE codp = '$mat'";
...
<input type="text" id="mat" name="mat" value="<?=$mat;?>                        " style=" font-family: Courier New; font-size: 14px;  height:23px;width:100px;" style="text-transform: uppercase;"   tabindex="1"    />
</div>

<div id="Edit3_outer" style="Z-INDEX: 20; LEFT: 610px; WIDTH: 50px; POSITION: absolute; TOP: 217px; HEIGHT: 24px">
<input type="text" id="mat2" name="mat2" value="<?=$mat2;?>                     " style=" font-family: Courier New; font-size: 14px;  height:23px;width:50px;"  style="text-transform: uppercase;"  tabindex="2"    />
</div>

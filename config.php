...
//	echo"Nгo foi possнvel localizar o banco de dados!";
	...
	$total  = count($linha);
	for ($i = "0"; $i < $total; $i++){
	     list($dado1,$dado2,$dado3,$dado4,$dado5,$dado6,$dado7,$dado8,$dado9,$dado10,$dado11,$dado12,$dado13,$dado14,$dado15,$dado16,$dado17,$dado18,$dado19,$dado20,$dado21,$dado22,) = explode(";",$linha[$i]);
	}

...
If (!empty($id)){
		...
		<layers id="fixacam"> 
			...
			<a rel="home" class="home" href="javascript:janelaSecundaria('propostasocios.php?Cod_2=<?=$new_fot;?>')">
			<img alt="Proposta" src="../imagens/botaoazul18.PNG" border="0"/></a>
			
			<a rel="home" class="home" href="javascript:janelaSecundaria('soccarteira.php?Cod_2=<?=$new_fot;?>')">
			<img alt="Carteira" src="../imagens/botaoazul19.PNG" border="0"/></a>
		
			<a rel="home" class="home" href="../boletos/boletos_socios.php?cod_matr_1=<?=$new_fot;?>&cod_matr_2=<?=$new_fot;?>&cod_matr_3=<?=$new_fot;?>">
		...
		?>
			...
			<a rel="home" class="home" href="socexcluir.php?Cod_3=<?=$id;?>">
		...
		?>
			...
			<a rel="home" class="home" href="sochistorico.php?Cod_2=<?=$id;?>">
			...
			<a rel="home" class="home" href="aberto_soc.php?Cod_2=<?=$id;?>">

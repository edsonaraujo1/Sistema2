...
<input type="text" id="Edit1e" name="Edit1e" value="<?=$Edit1e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:56px; background-color: #FFFFFF;" disabled   tabindex="1"    />
</div>
...
<input type="text" id="Edit2e" name="Edit2e" value="<?=$Edit2e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:137px; background-color: #FFFFFF;" disabled   tabindex="2"    />
</div>
...
<input type="text" id="Edit3e" name="Edit3e" value="<?=$Edit3e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:93px; background-color: #FFFFFF;" disabled  tabindex="3"    />
</div>
...
<input type="text" id="Edit5e" name="Edit5e" value="<?=$Edit5e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:352px; background-color: #FFFFFF;" disabled  tabindex="5"    />
</div>
...
<input type="text" id="Edit6e" name="Edit6e" value="<?=$Edit6e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:192px; background-color: #FFFFFF;" disabled   tabindex="6"    />
</div>
<div id="Edit7_outer" style="Z-INDEX: 15; LEFT: 334px; WIDTH: 352px; POSITION: absolute; TOP: 149px; HEIGHT: 26px">
<input type="text" id="Edit7e" name="Edit7e" value="<?=$Edit7e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:352px; background-color: #FFFFFF;" disabled   tabindex="7"    />
</div>
...
<input type="text" id="Edit8e" name="Edit8e" value="<?=$Edit8e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px; background-color: #FFFFFF;" disabled  tabindex="8"    />
</div>
...
<input type="text" id="Edit10e" name="Edit10e" value="<?=$Edit10e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:180px; background-color: #FFFFFF;" disabled  tabindex="10"    />
</div>
...
<input type="text" id="Edit9e" name="Edit9e" value="<?=$Edit9e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:83px; background-color: #FFFFFF;" disabled  tabindex="9"    />
</div>
...
<input type="text" id="Edit12e" name="Edit12e" value="<?=$Edit12e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px; background-color: #FFFFFF;" disabled   tabindex="12"    />
</div>
...
<input type="text" id="Edit11e" name="Edit11e" value="<?=$Edit11e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:39px; background-color: #FFFFFF;" disabled  tabindex="11"    />
</div>
...
<input type="text" id="Edit13e" name="Edit13e" value="<?=$Edit13e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:153px; background-color: #FFFFFF;" disabled  tabindex="13"    />
</div>
...
<input type="text" id="Edit15e" name="Edit15e" value="<?=$Edit15e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px; background-color: #FFFFFF;" disabled   tabindex="15"    />
</div>
...
<input type="text" id="Edit16e" name="Edit16e" value="<?=$Edit16e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:153px; background-color: #FFFFFF;" disabled  tabindex="16"    />
</div>
...
<textarea id="obse" name="obse" style=" font-family: Verdana; font-size: 14px;  height:109px;width:544px; color: #696969; background-color: #FFFFFF;"  readonly tabindex="17"    wrap="virtual"><?=$Edit20e;?></textarea>
</div>
...
<input type="text" id="Edit4e" name="Edit4e" value="<?=$Edit4e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px; background-color: #FFFFFF;" disabled   tabindex="4"    />
</div>
...
<input type="text" id="Edit14e" name="Edit14e" value="<?=$Edit14e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:39px; background-color: #FFFFFF;" disabled  tabindex="14"    />
</div>
<div id="Edit19_outer" style="Z-INDEX: 39; LEFT: 142px; WIDTH: 81px; POSITION: absolute; TOP: 297px; HEIGHT: 26px">
<input type="text" id="Edit19e" name="Edit19e" value="<?=$Edit19e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:81px; background-color: #FFFFFF;" disabled  tabindex="19"    />
</div>
<div id="Label6_outer" style="Z-INDEX: 40; LEFT: 225px; WIDTH: 459px; POSITION: absolute; TOP: 301px; HEIGHT: 18px">
<div id="Label6" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:18px;width:459px;"   ><STRONG><FONT color=#0000ff><?=$nome_adme;?></FONT></STRONG></div>
</div>
...
<input type="text" id="Edit17e" name="Edit17e" value="<?=$Edit17e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:346px; background-color: #FFFFFF;" disabled  tabindex="17"    />
</div>
...
<input type="text" id="Edit18e" name="Edit18e" value="<?=$Edit18e;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:39px; background-color: #FFFFFF;" disabled  tabindex="18"    />
</div>
<div id="Image1_outer" style="Z-INDEX: 45; LEFT: 560px; WIDTH: 56px; POSITION: absolute; TOP: 251px; HEIGHT: 19px">
<div id="Image1_container" style=" width: 56;  height: 19; overflow: hidden;" ><a href="conf.php?Cod_Edif=<?=$Edit1e;?>"><img id="Image1" src="../imagens/conf1.PNG"  width="56"  height="19"  border="0"       /></a></div>
</div>
<div id="Image2_outer" style="Z-INDEX: 46; LEFT: 623px; WIDTH: 56px; POSITION: absolute; TOP: 250px; HEIGHT: 21px">
<div id="Image2_container" style=" width: 56;  height: 21; overflow: hidden;" ><a href="sind.php?Cod_Edif=<?=$Edit1e;?>"><img id="Image2" src="../imagens/sind1.PNG"  width="56"  height="21"  border="0"       /></a></div>
</div>
</td></tr></table>
</form></body>
</html>

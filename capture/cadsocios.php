...
<layers id="fixacam"> 
	...
	<a rel="home" class="home" href="javascript:janelaSecundaria('propostasocios.php?Cod_2=<?=Trim($Edit1s).Trim($Edit2s);?>')">
	<img alt="Proposta" src="../imagens/botaoazul18.PNG" border="0"/></a>
	
	<a rel="home" class="home" href="javascript:janelaSecundaria('soccarteira.php?Cod_2=<?=Trim($Edit1s).Trim($Edit2s);?>')">
	<img alt="Carteira" src="../imagens/botaoazul19.PNG" border="0"/></a>

	<a rel="home" class="home" href="../boletos/boletos_socios.php?cod_matr_3=<?=Trim($Edit1).Trim($Edit2);?>">
...
?>
	<a rel="home" class="home" href="soclis_grid.php?Cod_2=<?=$id1;?>">
...
?>
	...
	<a rel="home" class="home" href="socexcluir.php?Cod_2=<?=$id1;?>">
...
?>
	...
	<a rel="home" class="home" href="socalterar.php?Cod_3=<?=$id1;?>">
...
?>
	...
	<a rel="home" class="home" href="sochistorico.php?Cod_2=<?=$id1;?>">
	<img alt="Historico" src="../imagens/botaoazul37.PNG" border="0"/></a>

	<a rel="home" class="home" href="seg_tela.php?Cod_2=<?=$new_fot;?>">
	<img alt="Debitos" src="../imagens/botaoazul38.PNG" border="0"/></a>
	
	<a rel="home" class="home" href="aberto_soc.php?Cod_2=<?=$id1;?>">
	...
	<a rel="home" class="home" href="Javascript:Anterior(<?=$id1-1;?>)">
	<img alt="Digite seta <-- para Anterior" src="../imagens/botaoazul31.PNG" border="0"/></a>

	<a rel="home" class="home" href="Javascript:Proximo(<?=$id1+1;?>);">
	...
	<a rel="home" class="home" href="<?=$path;?>avaleht.php">

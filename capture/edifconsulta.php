...
<form name="Form1" type='hidden' method='POST' action='edifpesquisa.php'>
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>; height:32px;width:543px;"   ><STRONG>Consultar Empresa</STRONG></div>
</div>
...
<select id="Edit1_ed" name="Edit1_ed" value="<?=$Edit1_ed;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:176px; background-color: #FFFFFF;"  onchange="Salva_Etq_edif1(this)"  tabindex="0"    />
...
<input type="text" id="Edit2_ed" name="Edit2_ed" value="<?=$Edit2_ed;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:440px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit2_ed', '99.999.999/9999-99', event);"   tabindex="0"    />
</div>
...
<div id="Edit2_outer" style="Z-INDEX: 7; LEFT: 184px; WIDTH: 440px; POSITION: absolute; TOP: 124px; HEIGHT: 26px">
<input type="text" id="Edit2_ed" name="Edit2_ed" value="<?=$Edit2_ed;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:440px; background-color: #FFFFFF;"    tabindex="0"    />
</div>

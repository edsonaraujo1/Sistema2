...
<input type="text" id="Edit1" name="Edit1" value="<?=$Edit1;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:56px; background-color: #FFFFFF;" onchange="Salva1(this.value)"  onFocus="nextfield ='Edit2';" tabindex="1" maxlength="11"  />
</div>

...
function keyCatcher() 
{
   ...
   if (event.keyCode == 27) 
   {
		window.location="cadsocios.php?cod_3=<?=$id_navega;?>";
   }
        ...
        if ($faz == 1){
           ...
           $faz = 0;
					  ...
					  if ($negrita==1){
						 ...
						 <td align='left'>            <font style=' font-family: Verdana; font-size: 12px;'>   <?=$Edit2;?>
						 ...
						 <td align='right'>            <font style=' font-family: Verdana; font-size: 12px;'>   <?=$PARCELA1;?>
						 <td align='center'>            <font style=' font-family: Verdana; font-size: 12px;'>   <?=$Edit6;?>
						 <td align='left'>            <font style=' font-family: Verdana; font-size: 12px;'>   <?=$Edit4;?>
                         <td  bgcolor="#FFFFFF">
                         <?
                         if ($per3 == "SIM"){
                         ?>	
						     <A HREF='alterar_segt.php?Cod_2=<?=$id;?>'><img alt='Alterar' id='Image2' src='../imagens/editar.gif' border='0'></A>
						 <?
						 }
						 ?>    
						 <td  bgcolor="#FFFFFF">
                         ...
                         if ($per2 == "SIM"){
                         ?>	
						     <A HREF='excluir_segt.php?Cod_2=<?=$id;?>'><img alt='Excluir' id='Image3' src='../imagens/excluir.gif' border='0'></A>
						 <?
						 }
						 ?>    
						 </font>

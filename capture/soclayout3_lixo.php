...
<input type="text" id="Edit11" name="Edit11" value="<?=$Edit11;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:407px; background-color: #FFFFFF;"  onchange="Salva11(this.value)"  onFocus="nextfield ='Edit71';" style="text-transform: uppercase;" tabindex="11"  maxlength="60"   />
</div>
...
<select id="Edit71" name="Edit71" value="<?=$Edit71;?>" style=" font-family: Verdana; font-size: 14px;   background-color: #FFFFFF; height:25px;width:41px;" onchange="Salva71(this.value)"  onFocus="nextfield ='Edit12';" style="text-transform: uppercase;" tabindex="12"    />
...
<select id="Edit72" name="Edit72" value="<?=$Edit72;?>" style=" font-family: Verdana; font-size: 14px;   background-color: #FFFFFF; height:25px;width:226px;" onchange="Salva72(this.value)"  onFocus="nextfield ='Edit25';" style="text-transform: uppercase;"  tabindex="25"    />
...
<div id="Edit27_outer" style="Z-INDEX: 56; LEFT: 634px; WIDTH: 34px; POSITION: absolute; TOP: 416px; HEIGHT: 26px">
<input type="text" id="Edit27" name="Edit27" value="<?=$Edit27;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:34px; background-color: #FFFFFF;"  readonly onchange="Salva27(this.value)"  onFocus="nextfield ='Edit28';" style="text-transform: uppercase;" tabindex="27"  maxlength="2"   />
</div>
<div id="Edit28_outer" style="Z-INDEX: 57; LEFT: 668px; WIDTH: 62px; POSITION: absolute; TOP: 416px; HEIGHT: 26px">
<input type="text" id="Edit28" name="Edit28" value="<?=$Edit28;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:62px; background-color: #FFFFFF;" readonly onchange="Salva28(this.value)"  onFocus="nextfield ='Edit29';" style="text-transform: uppercase;" tabindex="28"  maxlength="4"   />
</div>
...
<input type="text" id="Edit46" name="Edit46" value="<?=$Edit46;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px; background-color: #FFFFFF;"  onchange="Salva46(this.value)"  onFocus="nextfield ='Edit47';" style="text-transform: uppercase;" tabindex="46" maxlength="35"    />
</div>
<div id="Edit47_outer" style="Z-INDEX: 127; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 641px; HEIGHT: 26px">
<input type="text" id="Edit47" name="Edit47" value="<?=$Edit47;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit47', '99/99/9999', event);"  onchange="Salva47(this.value)"  onFocus="nextfield ='Edit48';" style="text-transform: uppercase;" tabindex="47"  maxlength="10"   />
</div>

		                              ...
		                              <td><div align="center">
		                                  <table width="103%" border="0" cellpadding="0">
		                                    ...
		                                    <tr>
		                                      ...
		                                      <td><select name="Edit6" type="text" id="Edit6" style=" font-family: Verdana; font-size: 14px;  height:23px;width:200px;  " onfocus="this.className='anormal'"  onblur="this.className='normal'" value="<?=$Edit6;?>" />

...
if (intval($fim_insc_ano) >= $ano_hj and intval($fim_insc_mes) >= $mes_hj){
	...
	if($mes_inicio == 0 and $ano_inicio == 0){
		...
		<script language='JavaScript'>
		        alert("Socio ATRASADO COM PAGAMENTO, acertar no CAIXA ! \n Quantidade de <?php echo $qtd_fim ?> Mensalidades atrasada num total de \n R$ <?php echo $valor_3 ?>,00 Reais !!!");
		</script>
		<?php
		}
}
...
<input type="text" id="Edit1" name="Edit1" value="<?php echo $Edit1 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:56px;"  disabled  tabindex="0"    />
</div>
<div id="Edit2_outer" style="Z-INDEX: 7; LEFT: 283px; WIDTH: 33px; POSITION: absolute; TOP: 151px; HEIGHT: 26px">
<input type="text" id="Edit2" name="Edit2" value="<?php echo $Edit2 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:33px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit3" name="Edit3" value="<?php echo $Edit3 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:137px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit4" name="Edit4" value="<?php echo $Edit4 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:137px;"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit5" name="Edit5" value="<?php echo $Edit5 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:91px;"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit6" name="Edit6" value="<?php echo $Edit6 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:91px;"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit7" name="Edit7" value="<?php echo $Edit7 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:91px;"  disabled  tabindex="0"    />
</div>
<?php
//Criar Sessecao
session_start();
...
if ($per2 == "SIM"){
   ...
   <div id="Image1_container" style=" width: 112;  height: 146; overflow: hidden;" ><A href="cadsocios.php?cod_5=<?php echo $new_fot ?>"><img id="Image1" src="ver.php?new_fot=<?php echo $new_fot ?>"  width="107"  height="137"  border="1"  style=" border-color: #000000 "       /></A></div>
   </div>
   <?php
   }else{
   ?>	
   <div id="Image1_outer" style="Z-INDEX: 18; LEFT: 749px; WIDTH: 112px; POSITION: absolute; TOP: 179px; HEIGHT: 146px">
   <div id="Image1_container" style=" width: 112;  height: 146; overflow: hidden;" ><A href="cadsocios.php?cod_5=<?php echo $new_fot ?>"><img id="Image1" src="<?php echo $cami2 ?>"  width="107"  height="137"  border="1"  style=" border-color: #000000 "       /></A></div>
   </div>
   <?php
   }
...
<input type="text" id="Edit8" name="Edit8" value="<?php echo $Edit8 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:159px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit9" name="Edit9" value="<?php echo $Edit9 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:28px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit10" name="Edit10" value="<?php echo $Edit10 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:55px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit11" name="Edit11" value="<?php echo $Edit11 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:407px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit12" name="Edit12" value="<?php echo $Edit12 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:127px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
<div id="Edit13_outer" style="Z-INDEX: 29; LEFT: 352px; WIDTH: 385px; POSITION: absolute; TOP: 295px; HEIGHT: 26px">
<input type="text" id="Edit13" name="Edit13" value="<?php echo $Edit13 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:385px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit14" name="Edit14" value="<?php echo $Edit14 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:127px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit15" name="Edit15" value="<?php echo $Edit15 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:216px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit16" name="Edit16" value="<?php echo $Edit16 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:83px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit17" name="Edit17" value="<?php echo $Edit17 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:216px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit18" name="Edit18" value="<?php echo $Edit18 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:36px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit19" name="Edit19" value="<?php echo $Edit19 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit20" name="Edit20" value="<?php echo $Edit20 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:116px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit21" name="Edit21" value="<?php echo $Edit21 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:102px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit22" name="Edit22" value="<?php echo $Edit22 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:42px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit23" name="Edit23" value="<?php echo $Edit23 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit24" name="Edit24" value="<?php echo $Edit24 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
<div id="Edit25_outer" style="Z-INDEX: 52; LEFT: 225px; WIDTH: 117px; POSITION: absolute; TOP: 416px; HEIGHT: 26px">
<input type="text" id="Edit25" name="Edit25" value="<?php echo $Edit25 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px; background-color: #FFFFFF"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit26" name="Edit26" value="<?php echo $Edit26 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:34px; background-color: #FFFFFF"  disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit27" name="Edit27" value="<?php echo $Edit27 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:34px; background-color: #FFFFFF"  disabled   tabindex="0"    />
</div>
<div id="Edit28_outer" style="Z-INDEX: 57; LEFT: 668px; WIDTH: 62px; POSITION: absolute; TOP: 416px; HEIGHT: 26px">
<input type="text" id="Edit28" name="Edit28" value="<?php echo $Edit28 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:62px; background-color: #FFFFFF"  disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit29" name="Edit29" value="<?php echo $Edit29 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:29px; background-color: #FFFFFF"  disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit30" name="Edit30" value="<?php echo $Edit30 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px; background-color: #FFFFFF"  disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit31" name="Edit31" value="<?php echo $Edit31 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:34px; background-color: #FFFFFF"  disabled     tabindex="0"    />
</div>
...
<input type="text" id="Edit32" name="Edit32" value="<?php echo $Edit32 ?>" style=" font-family: Verdana; font-size: 14px;  height:27px;width:92px; background-color: #FFFFFF"  disabled      tabindex="0"    />
</div>
...
<input type="text" id="Edit33" name="Edit33" value="<?php echo $Edit33 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px; background-color: #FFFFFF"  disabled      tabindex="0"    />
</div>
...
<input type="text" id="Edit34" name="Edit34" value="<?php echo $Edit34 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF"  disabled    tabindex="0"    />
</div>
...
<input type="text" id="Edit35" name="Edit35" value="<?php echo $Edit35 ?>" style=" font-family: Verdana; font-size: 14px;  height:27px;width:179px; background-color: #FFFFFF"  disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit36" name="Edit36" value="<?php echo $Edit36 ?>" style=" font-family: Verdana; font-size: 14px;  height:26px;width:409px; background-color: #FFFFFF"  disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit37" name="Edit37" value="<?php echo $Edit37 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:409px; background-color: #FFFFFF"  disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit38" name="Edit38" value="<?php echo $Edit38 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px; background-color: #FFFFFF"  disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit39" name="Edit39" value="<?php echo $Edit39 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF"  disabled    tabindex="0"    />
</div>
...
<input type="text" id="Edit40" name="Edit40" value="<?php echo $Edit40 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha1 ?>; background-color: #FFFFFF" readonly="readonly"    tabindex="0"    />
</div>
...
<input type="text" id="Edit41" name="Edit41" value="<?php echo $Edit41 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF"  disabled    tabindex="0"    />
</div>
...
<input type="text" id="Edit42" name="Edit42" value="<?php echo $Edit42 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;"  disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit43" name="Edit43" value="<?php echo $Edit43 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha2 ?>; background-color: #FFFFFF"  readonly="readonly"     tabindex="0"    />
</div>
...
<input type="text" id="Edit44" name="Edit44" value="<?php echo $Edit44 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF"  disabled    tabindex="0"    />
</div>
...
<input type="text" id="Edit45" name="Edit45" value="<?php echo $Edit45 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;" disabled   tabindex="0"    />
</div>
...
<textarea id="Memo1" name="Memo1" style=" font-family: Verdana; font-size: 14px;  height:77px;width:501px; background-color: #FFFFFF;" disabled   tabindex="0"    wrap="virtual"><?php echo $Edit70 ?></textarea>
</div>
...
<input type="text" id="Edit46" name="Edit46" value="<?php echo $Edit46 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha3 ?>; background-color: #FFFFFF;" readonly="readonly"    tabindex="0"    />
</div>
<div id="Edit47_outer" style="Z-INDEX: 127; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 641px; HEIGHT: 26px">
<input type="text" id="Edit47" name="Edit47" value="<?php echo $Edit47 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF;"  disabled  tabindex="0"    />
</div>
<div id="Edit48_outer" style="Z-INDEX: 128; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 641px; HEIGHT: 26px">
<input type="text" id="Edit48" name="Edit48" value="<?php echo $Edit48 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;"  disabled  tabindex="0"    />
</div>
<div id="Edit49_outer" style="Z-INDEX: 129; LEFT: 225px; WIDTH: 329px; POSITION: absolute; TOP: 666px; HEIGHT: 26px">
<input type="text" id="Edit49" name="Edit49" value="<?php echo $Edit49 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha4 ?>; background-color: #FFFFFF;"  readonly="readonly"   tabindex="0"    />
</div>
<div id="Edit50_outer" style="Z-INDEX: 130; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 666px; HEIGHT: 26px">
<input type="text" id="Edit50" name="Edit50" value="<?php echo $Edit50 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF;" disabled   tabindex="0"    />
</div>
<div id="Edit51_outer" style="Z-INDEX: 131; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 666px; HEIGHT: 26px">
<input type="text" id="Edit51" name="Edit51" value="<?php echo $Edit51 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;"  disabled  tabindex="0"    />
</div>
<div id="Edit52_outer" style="Z-INDEX: 132; LEFT: 225px; WIDTH: 329px; POSITION: absolute; TOP: 691px; HEIGHT: 26px">
<input type="text" id="Edit52" name="Edit52" value="<?php echo $Edit52 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha5 ?>; background-color: #FFFFFF;"  readonly="readonly"   tabindex="0"    />
</div>
<div id="Edit53_outer" style="Z-INDEX: 133; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 691px; HEIGHT: 26px">
<input type="text" id="Edit53" name="Edit53" value="<?php echo $Edit53 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF;" disabled   tabindex="0"    />
</div>
<div id="Edit54_outer" style="Z-INDEX: 134; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 691px; HEIGHT: 26px">
<input type="text" id="Edit54" name="Edit54" value="<?php echo $Edit54 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;"  disabled  tabindex="0"    />
</div>
<div id="Edit55_outer" style="Z-INDEX: 135; LEFT: 225px; WIDTH: 329px; POSITION: absolute; TOP: 716px; HEIGHT: 26px">
<input type="text" id="Edit55" name="Edit55" value="<?php echo $Edit55 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha6 ?>; background-color: #FFFFFF;"  readonly="readonly"   tabindex="0"    />
</div>
<div id="Edit56_outer" style="Z-INDEX: 136; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 716px; HEIGHT: 26px">
<input type="text" id="Edit56" name="Edit56" value="<?php echo $Edit56 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF;" disabled   tabindex="0"    />
</div>
<div id="Edit57_outer" style="Z-INDEX: 137; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 716px; HEIGHT: 26px">
<input type="text" id="Edit57" name="Edit57" value="<?php echo $Edit57 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;" disabled   tabindex="0"    />
</div>
<div id="Edit58_outer" style="Z-INDEX: 138; LEFT: 225px; WIDTH: 329px; POSITION: absolute; TOP: 741px; HEIGHT: 26px">
<input type="text" id="Edit58" name="Edit58" value="<?php echo $Edit58 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha7 ?>; background-color: #FFFFFF;" readonly="readonly"    tabindex="0"    />
</div>
<div id="Edit59_outer" style="Z-INDEX: 139; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 741px; HEIGHT: 26px">
<input type="text" id="Edit59" name="Edit59" value="<?php echo $Edit59 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF;" disabled   tabindex="0"    />
</div>
<div id="Edit60_outer" style="Z-INDEX: 140; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 741px; HEIGHT: 26px">
<input type="text" id="Edit60" name="Edit60" value="<?php echo $Edit60 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;" disabled   tabindex="0"    />
</div>
<div id="Edit61_outer" style="Z-INDEX: 141; LEFT: 225px; WIDTH: 329px; POSITION: absolute; TOP: 766px; HEIGHT: 26px">
<input type="text" id="Edit61" name="Edit61" value="<?php echo $Edit61 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha8 ?>; background-color: #FFFFFF;" readonly="readonly"    tabindex="0"    />
</div>
<div id="Edit62_outer" style="Z-INDEX: 142; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 766px; HEIGHT: 26px">
<input type="text" id="Edit62" name="Edit62" value="<?php echo $Edit62 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF;" disabled   tabindex="0"    />
</div>
<div id="Edit63_outer" style="Z-INDEX: 143; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 766px; HEIGHT: 26px">
<input type="text" id="Edit63" name="Edit63" value="<?php echo $Edit63 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;"  disabled  tabindex="0"    />
</div>
<div id="Edit64_outer" style="Z-INDEX: 144; LEFT: 225px; WIDTH: 329px; POSITION: absolute; TOP: 791px; HEIGHT: 26px">
<input type="text" id="Edit64" name="Edit64" value="<?php echo $Edit64 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha9 ?>; background-color: #FFFFFF;" readonly="readonly"   tabindex="0"    />
</div>
<div id="Edit65_outer" style="Z-INDEX: 145; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 791px; HEIGHT: 26px">
<input type="text" id="Edit65" name="Edit65" value="<?php echo $Edit65 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF;" disabled   tabindex="0"    />
</div>
<div id="Edit66_outer" style="Z-INDEX: 146; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 791px; HEIGHT: 26px">
<input type="text" id="Edit66" name="Edit66" value="<?php echo $Edit66 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;" disabled   tabindex="0"    />
</div>
<div id="Edit67_outer" style="Z-INDEX: 147; LEFT: 225px; WIDTH: 329px; POSITION: absolute; TOP: 816px; HEIGHT: 26px">
<input type="text" id="Edit67" name="Edit67" value="<?php echo $Edit67 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;<?php echo $cod_linha10 ?>; background-color: #FFFFFF;" readonly="readonly"   tabindex="0"    />
</div>
<div id="Edit68_outer" style="Z-INDEX: 148; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 816px; HEIGHT: 26px">
<input type="text" id="Edit68" name="Edit68" value="<?php echo $Edit68 ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px; background-color: #FFFFFF;" disabled   tabindex="0"    />
</div>
<div id="Edit69_outer" style="Z-INDEX: 149; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 816px; HEIGHT: 26px">
<input type="text" id="Edit69" name="Edit69" value="<?php echo $Edit69 ?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:41px;"  disabled  tabindex="0"    />
</div>


<div id="label1_outer" style="Z-INDEX: 124; LEFT: 257px; WIDTH: 462px; POSITION: absolute; TOP: 227px; HEIGHT: 20px">
<input type="text" id="label1" name="label1" value="<?php echo $categ_1 ?>" style=" font-family: Verdana; font-size: 14px; color: #0000FF;font-weight: bold; border-width: 0px; border-style: none;height:20px;width:462px;"  readonly  tabindex="0"    />
</div>


<div id="label1_outer" style="Z-INDEX: 125; LEFT: 345px; WIDTH: 511px; POSITION: absolute; TOP: 443px; HEIGHT: 20px">
<input type="text" id="label1" name="label1" value="<?php echo $nome_cad_si ?>" style=" font-family: Verdana; font-size: 14px; color: #0000FF;font-weight: bold; border-width: 0px; border-style: none;height:20px;width:511px;"  readonly  tabindex="0"    />
</div>
...
<div id="Image2_container" style=" width: 112;  height: 28; overflow: hidden;" ><a href="javascript:janelaSecundaria6('capture.php?Cod_cap=<?php echo $Edit1.$Edit2 ?>&Cod_nu=<?php echo $Edit1 ?>')"><img  alt="Capturar Foto do Socio" id="Image2" src="../imagens/botaoazul17.PNG"  border="0"       /></a></div>
</div>


<div id="Image4_outer" style="Z-INDEX: 150; LEFT: 283px; WIDTH: 17px; POSITION: absolute; TOP: 250px; HEIGHT: 18px">
<div id="Image4_container" style=" width: 17;  height: 18; overflow: hidden;" ><a href="javascript:janelaSecundaria3('edificioconsulta.php?Cod_2=<?php echo $Edit10 ?>')"><img alt="Consulta Informações do Edificio" id="Image4" src="../imagens/lupa.PNG"  width="17"  height="18"  border="0"       /></div>
</div>

<div id="label1_outer" style="Z-INDEX: 123; LEFT: 305px; WIDTH: 442px; POSITION: absolute; TOP: 249px; HEIGHT: 20px">
<input type="text" id="label1" name="label1" value="<?php echo $nome_do_edif ?>" style=" font-family: Verdana; font-size: 14px; color: #0000FF;font-weight: bold; border-width: 0px; border-style: none;height:20px;width:442px;"  readonly  tabindex="0"    />
</div>
...
<input type="text" id="Edit71" name="Edit71" value="<?php echo $Edit71 ?>" style=" font-family: Verdana; font-size: 14px;   background-color: #FFFFFF; height:25px;width:41px;"    disabled  tabindex="0"    />
</div>
...
<input type="text" id="Edit72" name="Edit72" value="<?php echo $Edit72 ?>" style=" font-family: Verdana; font-size: 14px;   background-color: #FFFFFF; height:25px;width:223px;"    disabled  tabindex="0"    />
</div>

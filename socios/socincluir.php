    ...
    if ($Faz_uma_vez != "nao"){
		...
		echo ("
				...
				function keyCatcher() 
				{
				   ...
				   if (event.keyCode == 83) 
				   {
					   window.location='socincluir.php?Faz_xxx=sim';
				   }

				   if (event.keyCode == 78) 
				   {
					   window.location='socincluir.php?Faz_xxx=nao';
				   }
		     ...
		     <table align=center>
		     <form method='POST' action='socincluir.php?Faz_xxx=sim'>
		     <td><input type=image name='sim' src='../imagens/botaosim.PNG'></td>
		     </form> 

		     <form method='POST' action='socincluir.php?Faz_xxx=nao'>
...
if (strtoupper($nome3) == "SANTANA"){
	$se_1 = "C";
}
if (strtoupper($nome3) == "TATUAPE"){
	$se_1 = "D";
}
if (strtoupper($nome3) == "SANTO"){
	$se_1 = "B";
}
if (strtoupper($nome3) == "ELCIO"){
	$se_1 = "B";
}
if (strtoupper($nome3) == "RICARDO"){
	$se_1 = "B";
}
if (strtoupper($nome3) == "SANTO1"){
	$se_1 = "B";
}
if (strtoupper($nome3) == "JEANNE"){
	$se_1 = "B";
}
if (strtoupper($nome3) == "LAPA"){
	$se_1 = "E";
}
if (strtoupper($nome3) == "LAPA1"){
	$se_1 = "E";
}
...
$add3 = "UPDATE $nome3a         SET Edit1    = '$Edit1',
                                    Edit2    = '$Edit2',
								    Edit5    = '$dat_insc' WHERE Nome1 = '$nome3a'";

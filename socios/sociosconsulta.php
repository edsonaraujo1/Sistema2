...
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: <?php echo $color_bor ?>;font-weight: bold;text-align: left; height:32px;width:320px;"   > Consultar Socios </div>
</div>

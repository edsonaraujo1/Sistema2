...
<layers id="fixacam"> 
	...
	<a rel="home" class="home" href="javascript:janelaSecundaria('propostasocios.php?Cod_2=<?php echo $id ?>')">
	<img alt="Proposta" src="../imagens/botaoazul18.PNG" border="0"/></a>
	
	<a rel="home" class="home" href="javascript:janelaSecundaria('soccarteira.php?Cod_2=<?php echo $id ?>')">
...
?>
	...
	<a rel="home" class="home" href="socexcluir.php?Cod_2=<?php echo $Edit1 ?><?php echo $Edit2 ?>">
...
?>
	...
	<a rel="home" class="home" href="sochistorico.php?Cod_2=<?php echo $Edit1 ?><?php echo $Edit2 ?>">
	<img alt="Historico" src="../imagens/botaoazul37.PNG" border="0"/></a>

	<a rel="home" class="home" href="<?php echo $path ?>ts2.php" target="new">
	<img alt="Debitos" src="../imagens/botaoazul38.PNG" border="0"/></a>
	
	<a rel="home" class="home" href="aberto_soc.php?Cod_2=<?php echo $Edit1 ?><?php echo $Edit2 ?>">

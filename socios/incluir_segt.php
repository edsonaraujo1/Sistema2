...
<td align='center'> <font style=' font-family: Verdana; font-size: 12px;'><b><input type="text" name="Edit1" value="<?php echo $cod_6 ?>" readonly  style=" font-family: Verdana; font-size: 14px;  height:25px;width:100px;"></b>

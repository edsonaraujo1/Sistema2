...
<div style="Z-INDEX: 0; LEFT: 0px; WIDTH: 412px; POSITION: absolute; TOP: 15; HEIGHT: 429px">
    <table  width="380" style="height:395px" bgcolor="#FFFFFF" border="15" bordercolor ='<?php echo $color_bor ?>' align="Center" >
	        <tr>
			<td valign="top">
			
				<div id="Label2_outer" style="Z-INDEX: 4; LEFT: 47px; WIDTH: 187px; POSITION: absolute; TOP: 35px; HEIGHT: 26px">
				<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?php echo $color_bor ?>; background-color: #FFFFFF;height:32px;width:329px;"><STRONG>&nbsp;Pesquisa Socios</STRONG></div></div>
				...
				<input type="text" id="Edit1" name="Edit1" value="<?php echo $Edit1 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;" readonly  tabindex="1"    />
				</div>
				...
				<input type="text" id="Edit3" name="Edit3" value="<?php echo $Edit3 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;"  readonly  tabindex="6"    />
				</div>
				...
				<input type="text" id="Edit4" name="Edit4" value="<?php echo $Edit4 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;"  readonly  tabindex="8"    />
				</div>
				...
				<input type="text" id="Edit5" name="Edit5" value="<?php echo $Edit5 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;" readonly   tabindex="9"    />
				</div>
				...
				<input type="text" id="Edit6" name="Edit6" value="<?php echo $Edit6 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;" readonly   tabindex="12"    />
				</div>
				...
				<input type="text" id="Edit7" name="Edit7" value="<?php echo $Edit7 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;"  readonly  tabindex="15"    />
				</div>
				...
				<input type="text" id="Edit2" name="Edit2" value="<?php echo $Edit2 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;" readonly  tabindex="4"    />
				</div>
				...
				<input type="text" id="Edit8" name="Edit8" value="<?php echo $Edit8 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;"  readonly  tabindex="12"    />
				</div>
				<div id="Edit9_outer" style="Z-INDEX: 21; LEFT: 239px; WIDTH: 113px; POSITION: absolute; TOP: 297px; HEIGHT: 26px">
				<input type="text" id="Edit9" name="Edit9" value="<?php echo $Edit9 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;"  readonly  tabindex="15"    />
				</div>
				...
				<input type="text" id="Edit10" name="Edit10" value="<?php echo $Edit10 ?>" style=" font-family: Verdana; font-size: 14px;  border-width: 0px; border-style: none;height:25px;width:113px;"  readonly  tabindex="15"    />
				</div>

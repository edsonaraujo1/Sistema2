...
<form style="margin-bottom: 0" id="form1" name="form1" method="post"  action="acao_tes2.php" target="new">
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: #5a9cb1; height:32px;width:383px;"   ><STRONG>Relação de Empregados</STRONG></div>
</div>
...
<input type="text" id="Edit1" name="Edit1" value="<?=$Edit1;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:101px;" onfocus="this.className='anormal'; nextfield ='Edit2';" onblur="this.className='normal'"   tabindex="0"    />
</div>

...
if ($Opcao == "CODIGO"){
    ...
    $consulta  = "SELECT * FROM email_boletim WHERE id = '$Procura' ORDER BY id";
}
if ($Opcao == "NOME"){

    $consulta  = "SELECT * FROM email_boletim WHERE nome like '$Procura%' ORDER BY nome";
}
if ($Opcao == "EMAIL"){

    $consulta  = "SELECT * FROM email_boletim WHERE email like '$Procura%' ORDER BY email";
}

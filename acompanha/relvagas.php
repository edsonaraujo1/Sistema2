		     ...
		     if ($faz == 1){
		        ...
		        $faz = 0;
					  ...
					  if ($negrita==1){
		                 ...
		                 <tr> 
			             <td align='right'>  <font style=' font-family: Verdana; font-size: 8px;'><b><?php echo $id ?></b>
						 <td align='left'>   <font style=' font-family: Verdana; font-size: 8px;'><?php echo $cod ?>
						 <td align='left'>   <font style=' font-family: Verdana; font-size: 8px;'><b><?php echo $cpf ?></b>
						 <td align='center'> <font style=' font-family: Verdana; font-size: 8px;'><?php echo $qtd ?>
						 <td align='left'>   <font style=' font-family: Verdana; font-size: 8px;'><?php echo $cond ?>
						 <td align='left'>   <font style=' font-family: Verdana; font-size: 8px;'><?php echo $nome ?>
						 <td align='center'> <font style=' font-family: Verdana; font-size: 8px;'><?php echo $numero ?></td> 

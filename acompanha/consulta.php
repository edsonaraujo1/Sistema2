...
<select id="Edit1" name="Edit1" value="<?php echo $Edit1 ?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:169px;" onfocus="this.className='anormal'" onblur="this.className='normal'"   maxlength='10' onchange="Salva_Etq_edif1(this)"  tabindex="0"    />
	...
	<option value="<?php echo $Edit1 ?>"> <?php echo $Edit1 ?> </option>
            <option value="MATRICULA SOCIO"> MATRICULA SOCIO </option>
...
<div id="Label31_outer" style="Z-INDEX: 7; LEFT: 225px; WIDTH: 450px; POSITION: absolute; TOP: 84px; HEIGHT: 32px">
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: <?php echo $color_bor ?>;font-weight: bold;text-align: left; height:32px;width:450px;"   > Consultar Acompa... </div>
</div>

...
if (!empty($Cod_2)){
   ...
   $consulta  = "SELECT * FROM saude_atendi Where id = '$Cod_2'";
	
}

if (!empty($id_navega)){

   $consulta  = "SELECT * FROM saude_atendi Where id = '$id_navega'";
...
if (empty($id)){
   ...
   $consulta  = "SELECT * FROM saude_atendi Where matricula = '$id_navega'";

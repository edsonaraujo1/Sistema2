...
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>;font-weight: bold;text-align: left; height:32px;width:400px;"   > Consultar Atendimento </div>
</div>
<div id="Label6_outer" style="Z-INDEX: 8; LEFT: 552px; WIDTH: 288px; POSITION: absolute; TOP: 93px; HEIGHT: 24px">

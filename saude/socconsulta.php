...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>; height:32px;width:543px;"   ><STRONG>Consultar Socio</STRONG></div>
</div>
...
<input type="text" id="Edit2_ed" name="Edit2_ed" value="<?=$Edit2_ed;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:440px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit2_ed', '999.999.999-99', event);"   tabindex="0"    />
</div>

...
$consulta0  = "SELECT * FROM saude_atendi WHERE id = '$Cod_2'";
...
$consulta1 = "INSERT INTO saude_excluir  (matricula,
                                     	titular,
                                     	mes,
								     	ano,
								     	dependente,
...
// Exclui Registro
$consulta2 = "DELETE FROM saude_atendi WHERE id = '$Cod_2'";

@mysql_query($consulta2, $link);

$consulta4  = "SELECT * FROM saude_atendi ORDER BY id ASC LIMIT 0,50";
...
$id      = @$row["id"];
			...
			$sql17 = 'ALTER TABLE `saude_atendi` ORDER BY `COD`';
			$res17 = mysql_query($sql17);
			
			$sql18 = 'ALTER TABLE `saude_atendi` DROP `id`';
			$res18 = mysql_query($sql18);
			
			$sql19 = 'ALTER TABLE `saude_atendi` ADD `id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST';
			$res19 = mysql_query($sql19);

			// Atualiza arquivo Log
			$data_log = date("d/m/Y");
			$hora_log = date("H:i:s"); 
			$even_log = $menssagens."/Medico/".$Edit1;

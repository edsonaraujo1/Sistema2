...
<form style="margin-bottom: 0" id="Unit2" name="Unit2" method="post"  action="/saude.php">
...
<?
$consulta5 = "SELECT * FROM saude_atendi WHERE matricula = '$Edit1' ORDER BY str_to_date( data, '%d/%m/%Y') DESC, id DESC";

...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>; background-color: #FFFFFF;height:32px;width:518px;"   ><P><STRONG>Atendimento Medico</STRONG></P></div>
</div>
...
<select type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>"  style=" font-family: Verdana; font-size: 14px; height:26px;width:441px;"   onfocus="this.className='anormal'; nextfield ='Edit6';" onblur="this.className='normal'"  onchange="Salva5(this.value)" style="text-transform: uppercase;" tabindex="2"    />
...
<div id="Label4" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:133px;"   ><STRONG>medico.:</STRONG>&nbsp;</div>
</div>
...
<div id="Image3_container" style=" width: 17;  height: 18; overflow: hidden;" ><a href="javascript:janelaSecundaria('socconsulta.php')"><img id="Image3" src="../imagens/lupa.PNG"  width="17"  height="18"   border="0"       /></a></div>
</div>


<div id="Image4_outer" style="Z-INDEX: 25; LEFT: 755px; WIDTH: 24px; POSITION: absolute; TOP: 166px; HEIGHT: 24px">
<div id="Image4_container" style=" width: 24;  height: 24; " ><img id="Image4" src="../imagens/obs1.PNG"  width="24"  height="24"  border="0"       /></div>
</div>
...
function janelaSecundaria2 (URL){ 
   window.open(URL,"janela3","width=690,height=235,resizable=NO,status=NO,Scrollbars=NO,location=NO,menubar=NO,toolbar=NO"); 
} 

...
<input type="text" id="Edit1" name="Edit1" value="<?=$Edit1;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:89px;"  onfocus="this.className='anormal'; nextfield ='Edit2';" onblur="this.className='normal'"   onchange="Salva1(this.value)" onclick="Salva1x(this.value)" style="text-transform: uppercase;" tabindex="0"    />
</div>
...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:441px;"   onfocus="this.className='anormal'; nextfield ='Edit5';" onblur="this.className='normal'"   onchange="Salva2(this.value)" style="text-transform: uppercase;"  tabindex="1"    />
</div>
...
<input type="text" id="Edit3" name="Edit3" value="<?=$Edit3;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:49px;"   onfocus="this.className='anormal'; nextfield ='Edit4';" onblur="this.className='normal'"   onchange="Salva3(this.value)" style="text-transform: uppercase;" disabled tabindex="2"    />
</div>
...
<input type="text" id="Edit4" name="Edit4" value="<?=$Edit4;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:81px;"   onfocus="this.className='anormal'; nextfield ='Edit5';" onblur="this.className='normal'"   onchange="Salva4(this.value)" style="text-transform: uppercase;" disabled tabindex="3"    />
</div>
...
<select type="text" id="Edit5" name="Edit5" value="" onfocus="this.className='anormal'" onblur="this.className='normal'" style=" font-family: Verdana; font-size: 14px; height:26px;width:441px;"  onchange="Salva5(this.value)"    tabindex="2"    />
	...
	for ($si = 2; $si < 11; $si++){
		...
		if (!empty($dep_[$si])){
           ...
           if ($soma1 >= 18){ 
           	   ...
           	   $maior_18 = "|&nbsp;18 anos |";
			   ?>
			   <option value="<?=$dep_[$si];?>"><?=$dep_[$si];?><?=$maior_18;?><?=$ani_[$si];?></option>
			   <?
			   $maior_18 = "";
...
<div id="Image3_outer" style="Z-INDEX: 24; LEFT: 405px; WIDTH: 17px; POSITION: absolute; TOP: 143px; HEIGHT: 18px">
<div id="Image3_container" style=" width: 17;  height: 18; overflow: hidden;" ><img id="Image3" src="../imagens/lupa.PNG"  width="17"  height="18"  border="0"       /></div>
</div>

<div id="Image4_outer" style="Z-INDEX: 25; LEFT: 755px; WIDTH: 24px; POSITION: absolute; TOP: 166px; HEIGHT: 24px">
<div id="Image4_container" style=" width: 24;  height: 24; " ><a href="javascript:janelaSecundaria2('obs.php?matri=<?=$Edit1;?>')"><img id="Image4" src="../imagens/obs1.PNG"  width="24"  height="24"  border="0"       /></a></div>
</div>

<div id="Label8_outer" style="Z-INDEX: 26; LEFT: 669px; WIDTH: 32px; POSITION: absolute; TOP: 195px; HEIGHT: 22px">
<div id="Label8" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:22px;width:32px;"   ><P><STRONG>Ret.</STRONG></P></div>
</div>
<div id="Edit9_outer" style="Z-INDEX: 27; LEFT: 701px; WIDTH: 114px; POSITION: absolute; TOP: 190px; HEIGHT: 26px">
<input type="text" id="Edit9" name="Edit9" value="<?=$Edit22;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:114px;"  disabled  tabindex="5"    />
</div>

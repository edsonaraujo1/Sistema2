...
if (strlen($cod_1) > 0){
   ...
   $consulta  = "SELECT * FROM saude_atendi  WHERE id = '$cod_1' ORDER BY id ASC";

}else{

   $consulta  = "SELECT * FROM saude_atendi  ORDER BY id ASC LIMIT 0,50";
	
}
if (!empty($Cod_xx)){
	
   $consulta  = "SELECT * FROM saude_atendi  WHERE id = '$Cod_xx' ORDER BY id ASC";
	
}

if (!empty($cod_3)){
	
   $consulta  = "SELECT * FROM saude_atendi  WHERE id = '$cod_3' ORDER BY id ASC";
	
}

if (!empty($cod_5)){
	
   $consulta  = "SELECT * FROM saude_atendi  WHERE id = '$cod_5' ORDER BY id ASC";

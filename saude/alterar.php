...
if (!empty($id_navega)){
	...
	$consulta0  = "SELECT * FROM saude_atendi Where id = '$Cod_3'";

}else{
			
	$consulta0  = "SELECT * FROM saude_atendi Where matricula = '$Cod_2'";
...
$id     = @$row0["id"];
$Edit1  = trim(strtoupper(retirar_carac2(@$row0["matricula"])));
$Edit2  = trim(strtoupper(retirar_carac2(@$row0["titular"])));
$Edit3  = trim(strtoupper(retirar_carac2(@$row0["mes"])));
$Edit4  = trim(strtoupper(retirar_carac2(@$row0["ano"])));
$Edit5  = trim(strtoupper(retirar_carac2(@$row0["dependente"])));
$Edit6  = trim(strtoupper(retirar_carac2(@$row0["dentista"])));
$Edit7  = trim(strtoupper(retirar_carac2(@$row0["procedimento"])));

...
$titulo_tabela = "Tabela 'CATEGORIA' Incluir";
?>
...
$sql  = "SELECT * FROM categ ORDER BY codigo DESC LIMIT 0,1";
...
<tr> 
<td align='left'> <font style=' font-family: Verdana; font-size: 14px;'> <b><input type="text" name="codigo" value=""  style=" font-family: Verdana; font-size: 14px;  height:25px;width:78px;"></b>

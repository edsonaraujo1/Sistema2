...
<select id="Edit1" name="Edit1" value="<?=$Edit1;?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:169px;" onfocus="this.className='anormal'" onblur="this.className='normal'"  maxlength=10 onchange="Salva_Etq_edif1(this)"  tabindex="0"    />
	...
	<option value="<?=$Edit1;?>"> <?=$Edit1;?> </option>
            ...
            <option value="VENCTO">     VENCTO </option>
            <option value="VALOR">      VALOR </option>
            <option value="DATA BAIXA"> DATA BAIXA </option>
...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:446px;" onfocus="this.className='anormal'" onblur="this.className='normal'" onkeypress="return txtBoxFormat(document.Form1, 'Edit2', '99/99/9999', event);"  maxlength='18'  tabindex="0"    />
</div>
...
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>;font-weight: bold;text-align: left; height:32px;width:400px;"   > Consultar Conf. </div>
</div>

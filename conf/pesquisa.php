...
if ($Opcao == "CODIGO"){
    ...
    $consulta  = "SELECT * FROM conf WHERE CONFCOD = '". anti_sql_injection($Procura) ."' ORDER BY CONFCOD";
}
if ($Opcao == "NOME"){

    $consulta  = "SELECT * FROM conf WHERE NOME like '". anti_sql_injection($Procura) ."%' ORDER BY NOME";
}
if ($Opcao == "ENDEREÇO"){

    $consulta  = "SELECT * FROM edificios WHERE ENDERECO like '". anti_sql_injection($Procura) ."%' ORDER BY ENDERECO";
}
if ($Opcao == "CNPJ"){

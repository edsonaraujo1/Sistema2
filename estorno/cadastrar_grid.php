...
if ($Acao == "insert"){
   ...
   $consulta = "INSERT INTO estorno (id, DATA,  QTDEST,  OPERADORA)
                           VALUES ('$id', '$Edit1', '$Edit2', '$Edit3')";
$Acao = " ";                           
...
if ($Acao == "update"){
   ...
   $consulta = "UPDATE estorno SET DATA       = '$Edit1',
                                   QTDEST     = '$Edit2',
                                   OPERADORA  = '$Edit3' WHERE id = '$id'";
								   $Acao = " ";                           
...
if ($Acao == "deletar"){
   ...
   $consulta = "DELETE FROM estorno WHERE id = '$id'";
   $Acao = " ";                           

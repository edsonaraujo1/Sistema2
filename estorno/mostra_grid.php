...
$sql  = "SELECT * FROM estorno ORDER BY id ASC";
...
if ($Opcao == "CODIGO"){
   ...
   $sql  = "SELECT * FROM estorno ORDER BY str_to_date( DATA , '%d/%m/%Y') ASC";
        ...
        if ($faz == 1){
           ...
           $faz = 0;
					  ...
					  if ($negrita==1){
		                 ?>	
		                 <tr> 
						 <td align='right'>           <font style=' font-family: Verdana; font-size: 12px;'><b><?=$id;?></b>
						 <td align='left'>            <font style=' font-family: Verdana; font-size: 12px;'>   <?=$Edit1;?>
						 <td align='center'>   		  <font style=' font-family: Verdana; font-size: 12px;'>   <?=$Edit2;?>

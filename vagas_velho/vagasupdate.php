...
/*
 ...
 Finalidade.........: Update Cadastro Vagas
...
$Edit1    = strtoupper(retirar_carac($_SESSION['Edit1']));
$Edit2    = strtoupper(retirar_carac($_SESSION['Edit2']));
$Edit3    = strtoupper(retirar_carac($_SESSION['Edit3']));
$Edit4    = strtoupper(retirar_carac($_SESSION['Edit4']));
$Edit5    = strtoupper(retirar_carac($_SESSION['Edit5']));
$Edit6    = strtoupper(retirar_carac($_SESSION['Edit6']));
$Edit7    = strtoupper(retirar_carac($_SESSION['Edit7']));
$Edit8    = strtoupper(retirar_carac($_SESSION['Edit8']));
$Edit9    = strtoupper(retirar_carac($_SESSION['Edit9']));
$Edit10   = strtoupper(retirar_carac($_SESSION['Edit10']));
$Edit11   = strtoupper(retirar_carac($_SESSION['Edit11']));
$Edit12   = strtoupper(retirar_carac($_SESSION['Edit12']));
$Edit13   = strtoupper(retirar_carac($_SESSION['Edit13']));
$Edit14   = strtoupper(retirar_carac($_SESSION['Edit14']));
$Edit15   = strtoupper(retirar_carac($_SESSION['Edit15']));
...
$consulta = "UPDATE vaga      SET SITU      = '$Edit2',
                                  DATA      = '$Edit3',
								  FUNCAO    = '$Edit4',
								  QTD       = '$Edit5',
                                  ENCA      = '$Edit6',

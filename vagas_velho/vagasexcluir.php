...
/*
 ...
 Finalidade.........: Deletar Cadastro Vagas
 Criado em Data.....: 07/12/2007
 Ultima Atualização : 08/07/2008 
...
// Salva Sessao
session_name("Val_Adms");
session_start();

$_SESSION['Edit0']      = $Edit0;     
...
<table  width="1000"   style="height:300px"  border="0" cellpadding="0" cellspacing="0"   align="Center" ><tr><td valign="top">
...
<script type="text/javascript">
  ...
  Shape3_Canvas.fillRect(1, 1, 656 - 1, 368 - 1);
...
<table border='0' aling=center>
          <td> </td>
          <form type="hidden" method="POST" action="vagasdelete.php?cod_1=<?=$Edit0;?>">
          <td><input type=image name="guias" src="../imagens/botaoazul4.PNG"></td>
          </form>

          <form method="POST" action="cadvagas.php?cod_1=<?=$Edit1;?>">

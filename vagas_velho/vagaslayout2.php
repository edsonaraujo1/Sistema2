...
/*
 ...
 Finalidade.........: Layout Cadastro Vagas
...
<form name="form1" type="hidden" method="POST" action="vagasinsert.php" onSubmit="return checa(this);">
...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:34px;" onchange="Salva_vagas2(this)" onFocus="nextfield ='Edit3';"  style="text-transform: uppercase;" tabindex="1"    />
</div>
...
<input type="text" id="Edit3" name="Edit3" value="<?=$Edit3;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:93px;  background-color: #FFFFFF;" onchange="Salva_vagas3(this)" onFocus="nextfield ='Edit4';"  style="text-transform: uppercase;" tabindex="2"  readonly  />
</div>
...
<input type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:32px;" onchange="Salva_vagas5(this)" onFocus="nextfield ='Edit6';"  style="text-transform: uppercase;" tabindex="4"    />
</div>
...
<input type="text" id="Edit7" name="Edit7" value="<?=$Edit7;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:450px;" onchange="Salva_vagas7(this)" onFocus="nextfield ='Edit8';"  style="text-transform: uppercase;" tabindex="5"    />
</div>
...
<input type="text" id="Edit8" name="Edit8" value="<?=$Edit8;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:450px;" onchange="Salva_vagas8(this)" onFocus="nextfield ='Edit9';"  style="text-transform: uppercase;" tabindex="7"    />
</div>
...
<input type="text" id="Edit9" name="Edit9" value="<?=$Edit9;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:180px;" onchange="Salva_vagas9(this)" onFocus="nextfield ='Edit10';"  style="text-transform: uppercase;" tabindex="9"    />
</div>
...
<input type="text" id="Edit12" name="Edit12" value="<?=$Edit12;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:83px;" onchange="Salva_vagas12(this)" onFocus="nextfield ='Edit13';"  style="text-transform: uppercase;" tabindex="8"    />
</div>
...
<input type="text" id="Edit13" name="Edit13" value="<?=$Edit13;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:218px;"  onchange="Salva_vagas13(this)" onFocus="nextfield ='Edit14';"  style="text-transform: uppercase;" tabindex="11"    />
</div>
...
<input type="text" id="Edit11" name="Edit11" value="<?=$Edit11;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:39px;" onchange="Salva_vagas11(this)" onFocus="nextfield ='Edit12';"  style="text-transform: uppercase;" tabindex="10"    />
</div>
...
<input type="text" id="Edit14" name="Edit14" value="<?=$Edit14;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:244px;" onchange="Salva_vagas14(this)" onFocus="nextfield ='Edit15';"  style="text-transform: uppercase;" tabindex="12"    />
</div>
...
<textarea id="Edit15" name="Edit15" style=" font-family: Verdana; font-size: 14px;  height:130px;width:544px;"           onchange="Salva_vagas15(this)" onFocus="nextfield ='Edit16';"  style="text-transform: uppercase;" tabindex="17"    wrap="virtual"><?=$Edit15;?></textarea>
</div>
...
<input type="text" id="Edit4" name="Edit4" value="<?=$Edit4;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px;" onchange="Salva_vagas4(this)" onFocus="nextfield ='Edit5';"  style="text-transform: uppercase;" tabindex="3"    />
</div>
...
<input type="text" id="Edit6" name="Edit6" value="<?=$Edit6;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:38px;" onchange="Salva_vagas6(this)" onFocus="nextfield ='Edit7';"  style="text-transform: uppercase;"  tabindex="4"    />
</div>
...
<input type="text" id="Edit10" name="Edit10" value="<?=$Edit10;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:201px;" onchange="Salva_vagas10(this)" onFocus="nextfield ='Edit11';"  style="text-transform: uppercase;" tabindex="9"    />
</div>
</td></tr></table>
</form></body>

<div style="Z-INDEX: 34; LEFT: 187px; WIDTH: 544px; POSITION: absolute; TOP: 475px; HEIGHT: 80px">

<table border='0'>
          <td> </td>
          <form method="POST" action="vagasinsert.php">
          <td><input type=image name="guias" src="../imagens/botaoazul10.PNG"></td>
          </form>

          <form method="POST" action="cadvagas.php?cod_1=1">

...
function keyCatcher() 
{
   ...
   if (event.keyCode == 27) 
   {
		window.location="../avaleht.php?servletjs2=20$$20";
   }
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>; background-color: #FFFFFF;height:32px;width:400px;"   ><P><STRONG>Relatorios Socio do Dia</STRONG></P></div>
</div>
<div id="Edit1_outer" style="Z-INDEX: 6; LEFT: 440px; WIDTH: 128px; POSITION: absolute; TOP: 143px; HEIGHT: 27px">
<input type="text" id="Edit1" name="Edit1" value="<?=$Edit1;?>" onfocus="this.className='anormal'" onblur="this.className='normal'" onkeypress="return txtBoxFormat(document.form1, 'Edit1', '99/99/9999', event);" style=" font-family: Verdana; font-size: 14px;  height:26px;width:128px;"    tabindex="0"    />
</div>
<div id="Edit2_outer" style="Z-INDEX: 7; LEFT: 440px; WIDTH: 128px; POSITION: absolute; TOP: 169px; HEIGHT: 27px">
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" onfocus="this.className='anormal'" onblur="this.className='normal'" onkeypress="return txtBoxFormat(document.form1, 'Edit2', '99/99/9999', event);" style=" font-family: Verdana; font-size: 14px;  height:26px;width:128px;"    tabindex="0"    />
</div>
</td></tr></table>
</body>

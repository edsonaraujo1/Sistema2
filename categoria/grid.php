        ...
        if ($faz == 1){
           ...
           $faz = 0;
					  ...
					  if ($negrita==1){
                         ...
                         <td>
						 <A HREF='alterar.php?Cod_2=<?php echo $Edit1 ?>'><img alt='Alterar' id='Image2' src='../imagens/editar.gif' border='0'></A><td>
						 <A HREF='excluir.php?Cod_2=<?php echo $Edit1 ?>'><img alt='Excluir' id='Image3' src='../imagens/excluir.gif' border='0'></A>
						 </font>
						 </td>
						 <?php 
			             $conta_p = $conta_p + 1;
						 ...
						 <td align='center'>   		  <font style=' font-family: Verdana; font-size: 12px;'>   <?php echo $Edit4 ?>
                         <td bgcolor="#FFFFFF">
						 <A HREF='alterar.php?Cod_2=<?php echo $Edit1 ?>'><img alt='Alterar' id='Image2' src='../imagens/editar.gif' border='0'></A>
						 <td bgcolor="#FFFFFF">
						 <A HREF='excluir.php?Cod_2=<?php echo $Edit1 ?>'><img alt='Excluir' id='Image3' src='../imagens/excluir.gif' border='0'></A>
						 </font>
						 </td>

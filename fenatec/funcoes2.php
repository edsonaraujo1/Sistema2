...
// Funcao Salva Sessao incluir Fenatec
function Salva_fena1(Var1)
{
     if(Var1.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_1="+Var1.value;     
	 }
}
function Salva_fena2(Var2)
{

     if(Var2.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_2="+Var2.value;     
	 }
}
function Salva_fena3(Var3)
{

     if(Var3.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_3="+Var3.value;     
	 }
}
function Salva_fena4(Var4)
{

     if(Var4.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_4="+Var4.value;     
	 }
}
function Salva_fena5(Var5)
{

     if(Var5.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_5="+Var5.value;     
	 }
}
function Salva_fena6(Var6)
{

     if(Var6.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_6="+Var6.value;     
	 }
}
function Salva_fena7(Var7)
{

     if(Var7.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_7="+Var7.value;     
	 }
}
function Salva_fena8(Var8)
{

     if(Var8.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_8="+Var8.value;     
	 }
}
function Salva_fena9(Var9)
{

     if(Var9.value.length >0)
     {
	 window.location = "proc_cep_fena.php?Cep_2x="+Var9.value;     
     window.location = "salva_session_fena.php?Var_9="+Var9.value;     
	 }
}
function Salva_fena10(Var10)
{

     if(Var10.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_10="+Var10.value;     
	 }
}
function Salva_fena11(Var11)
{

     if(Var11.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_11="+Var11.value;     
	 }
}
function Salva_fena12(Var12)
{

     if(Var12.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_12="+Var12.value;     
	 }
}
function Salva_fena13(Var13)
{

     if(Var13.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_13="+Var13.value;     
	 }
}
function Salva_fena14(Var14)
{

     if(Var14.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_14="+Var14.value;     
	 }
}
function Salva_fena15(Var15)
{

     if(Var15.value.length >0)
     {
     window.location = "salva_session_fena.php?Var_15="+Var15.value;     
	 }
}


// Funcao Salva Sessao Alterar fenainistradora
function Salva_fena_up1(Var1)
{
     if(Var1.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_1="+Var1.value;     
	 }
}
function Salva_fena_up2(Var2)
{

     if(Var2.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_2="+Var2.value;     
	 }
}
function Salva_fena_up3(Var3)
{

     if(Var3.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_3="+Var3.value;     
	 }
}
function Salva_fena_up4(Var4)
{

     if(Var4.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_4="+Var4.value;     
	 }
}
function Salva_fena_up5(Var5)
{

     if(Var5.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_5="+Var5.value;     
	 }
}
function Salva_fena_up6(Var6)
{

     if(Var6.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_6="+Var6.value;     
	 }
}
function Salva_fena_up7(Var7)
{

     if(Var7.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_7="+Var7.value;     
	 }
}
function Salva_fena_up8(Var8)
{

     if(Var8.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_8="+Var8.value;     
	 }
}
function Salva_fena_up9(Var9)
{

     if(Var9.value.length >0)
     {
	 window.location = "proc_cep_fena_update.php?Cep_2x="+Var9.value;     
     window.location = "salva_session_fena_up.php?Var_9="+Var9.value;    
 	 }
}
function Salva_fena_up10(Var10)
{

     if(Var10.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_10="+Var10.value;     
	 }
}
function Salva_fena_up11(Var11)
{

     if(Var11.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_11="+Var11.value;     
	 }
}
function Salva_fena_up12(Var12)
{

     if(Var12.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_12="+Var12.value;     
	 }
}
function Salva_fena_up13(Var13)
{

     if(Var13.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_13="+Var13.value;     
	 }
}
function Salva_fena_up14(Var14)
{

     if(Var14.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_14="+Var14.value;     
	 }
}
function Salva_fena_up15(Var15)
{

     if(Var15.value.length >0)
     {
     window.location = "salva_session_fena_up.php?Var_15="+Var15.value;     
	 }
}
...
/*
 ------------------------
 Funcao verifica CEP fenainistradora
 ------------------------
*/

function Verifica_fena(Cep)
{
     if(Cep.value.length >0)
     {
     window.location = "proc_cep_fena.php?Cep_2x="+Cep.value;     
	 }
}

function Verifica_fena2(Cep)
{
     if(Cep.value.length >0)
     {
     window.location = "proc_cep_fena_update.php?Cep_2x="+Cep.value;     
	 }
}

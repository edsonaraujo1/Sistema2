...
/*
 ...
 Finalidade.........: Excluir Cadastro Fenatec
...
$consulta = "DELETE FROM fenatec WHERE Edit1 = '$cod_1'";
...
<form style="margin-bottom: 0" id="Unit2" name="Unit2" method="post"  action="cadfenatec.php">

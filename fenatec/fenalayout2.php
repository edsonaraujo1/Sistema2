...
<form name="form1" type="hidden" method="POST" action="fenainsert.php" onSubmit="return checa(this);">
...
<input type="text" id="Edit1" name="Edit1" value="<?=$Edit1;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:56px; background-color: #FFFFFF;" onchange="Salva_fena1(this)" onFocus="nextfield ='Edit2';"      style="text-transform: uppercase;" readonly tabindex="0"    />
</div>
...
<select id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:137px; background-color: #FFFFFF;" onchange="Salva_fena2(this)" onFocus="nextfield ='Edit3';"      style="text-transform: uppercase;"   tabindex="1"    />
...
<input type="text" id="Edit3" name="Edit3" value="<?=$Edit3;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:93px; background-color: #FFFFFF;"  onchange="Salva_fena3(this)" onFocus="nextfield ='Edit4';"      style="text-transform: uppercase;"  readonly tabindex="2"    />
</div>
...
<input type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:352px; background-color: #FFFFFF;" onchange="Salva_fena5(this)" onFocus="nextfield ='Edit6';"      style="text-transform: uppercase;"  tabindex="4"    />
</div>
...
<input type="text" id="Edit6" name="Edit6" value="<?=$Edit6;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:192px; background-color: #FFFFFF;" onchange="Salva_fena6(this)" onFocus="nextfield ='Edit7';"      style="text-transform: uppercase;"  tabindex="5"    />
</div>
<div id="Edit7_outer" style="Z-INDEX: 15; LEFT: 470px; WIDTH: 352px; POSITION: absolute; TOP: 189px; HEIGHT: 26px">
<input type="text" id="Edit7" name="Edit7" value="<?=$Edit7;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:352px;" onchange="Salva_fena7(this)" onFocus="nextfield ='Edit8';"      style="text-transform: uppercase;"   tabindex="6"    />
</div>
...
<input type="text" id="Edit8" name="Edit8" value="<?=$Edit8;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px; background-color: #FFFFFF;" onchange="Salva_fena8(this)" onFocus="nextfield ='Edit9';"      style="text-transform: uppercase;"  tabindex="7"    />
</div>
...
<input type="text" id="Edit10" name="Edit10" value="<?=$Edit10;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:180px; background-color: #FFFFFF;" onchange="Salva_fena10(this)" onFocus="nextfield ='Edit11';"      style="text-transform: uppercase;" tabindex="9"    />
</div>
...
<input type="text" id="Edit9" name="Edit9" value="<?=$Edit9;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:83px; background-color: #FFFFFF;" onchange="Salva_fena9(this)" onFocus="nextfield ='Edit10';"      style="text-transform: uppercase;"  tabindex="8"    />
</div>
...
<input type="text" id="Edit12" name="Edit12" value="<?=$Edit12;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px; background-color: #FFFFFF;" onchange="Salva_fena12(this)" onFocus="nextfield ='Edit13';"      style="text-transform: uppercase;" tabindex="11"    />
</div>
...
<select type="text" id="Edit11" name="Edit11" value="<?=$Edit11;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:39px; background-color: #FFFFFF;" onchange="Salva_fena11(this)" onFocus="nextfield ='Edit12';"      style="text-transform: uppercase;" tabindex="10"    />
...
<input type="text" id="Edit13" name="Edit13" value="<?=$Edit13;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:153px; background-color: #FFFFFF;"  onchange="Salva_fena13(this)" onFocus="nextfield ='Edit14';"      style="text-transform: uppercase;" tabindex="12"    />
</div>
...
<textarea id="Edit15" name="Edit15" style=" font-family: Verdana; font-size: 14px;  height:81px;width:544px; background-color: #FFFFFF;"  onchange="Salva_fena15(this)" onFocus="nextfield ='Edit2';"      style="text-transform: uppercase;"  tabindex="17"    wrap="virtual"><?=$Edit15;?></textarea>
</div>
...
<input type="text" id="Edit4" name="Edit4" value="<?=$Edit4;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px; background-color: #FFFFFF;" onchange="Salva_fena4(this)" onFocus="nextfield ='Edit5';"      style="text-transform: uppercase;" tabindex="3"    />
</div>
...
<input type="text" id="Edit14" name="Edit14" value="<?=$Edit14;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:39px; background-color: #FFFFFF;" onchange="Salva_fena14(this)" onFocus="nextfield ='Edit15';"      style="text-transform: uppercase;"  tabindex="13"    />
</div>
...
<table border='0'>
          <td> </td>
          <form method="POST" action="fenainsert.php">
          <td><input type=image name="guias" src="../imagens/botaoazul10.PNG"></td>
          </form>

          <form method="POST" action="cadfenatec.php?cod_1=1">

	...
	if ($deixar == "SIM"){
		...
		switch ($opcao){
			...
			case 'excluir';
					...
					// Organiza id     
					$con_dele_id = "ALTER TABLE  `cracha` ORDER BY  `id`";
					@mysql_query($con_dele_id, $link);     
		                                      ...
		                                      <td><div align="center">
		                                          <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                                            ...
                                                            <tr>
                                                              <td width="380">
                                                                <table width="375" border="0" cellpadding="0" cellspacing="0">
                                                                  <tr>
                                                                    <td width="360"><input name="matricula" type="text" id="matricula" style=" font-family: Verdana; font-size: 14px;  height:23px;width:56px; background-color: #FFFFFF;" value="<?php echo $id ?>"  />
                                                      ...
                                                      <td><div align="left">
                                                          ...
                                                          <table width="496" border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                              ...
                                                              <a href="uploadi.php?id_up_ar=<?php echo $id ?>" ><img src="../imagens/botaoazul17.PNG" width="92" height="22" border="0" /></a>
                                                              </div></td>
                                                            </tr>
                                                          </table>
                                                        </div></td>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <input type="button" value="" onclick="displayCalendar(document.forms[0].campo8,'dd/mm/yyyy',this)" style="font-family: Verdana; font-size: 5pt; font-weight:bold; color:000000;background:url(../imagens/calendario.gif);border=0;width:18px;height:18px;">

        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="0">
            ...
            <tr>
              ...
              <td width="75%"><div align="left">
                <input name="matricula2" type="text" value="<?php echo $novo_1 ?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:56px;"  onfocus="this.className='anormal'; nextfield ='Edit2';" onblur="this.className='normal'"  onchange="Salva1(this.value)"  style="text-transform: uppercase;"  tabindex="0"/>
              </div></td>
            </tr>
            <tr>

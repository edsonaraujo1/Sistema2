...
$sql  = "SELECT * FROM aposentados ORDER BY NOME, ENDER ASC";
...
if ($cont_linha == 0){
	...
	$pdf->Text(14,16, 'Uniao do Aposent. Pens. Est. SP');
	...
	$pdf->SetXY(12,20);
	$pdf->MultiCell(268,5, 'Listagem de Aposentados', 0, 'C',0); // J Justificado
	$pdf->SetFont('Arial', 'B', 7);

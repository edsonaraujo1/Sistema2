      ...
      <td><div align="center">
        <table width="100%" border="0" cellpadding="1" cellspacing="0">
          <form name="form1" method="post"  action="barcode1.php" target="new">
            <div align="left"></div>
            <tr>
              <td width="25%" valign="bottom" class="style3"><div align="right">
                <table width="200" height="48" border="0">
                  <tr>
                    <td><div align="right"><b><font size="2" face="Verdana">Codigo.: </font></b></div></td>
                  </tr>
                  <tr>
                    <td><div align="right"><b><font size="2" face="Verdana">Nome de Guerra.:</font></b></div></td>
                  </tr>
                </table>
                <b></b></div></td>
              <td width="75%"><div align="left">                <table width="426" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="229" valign="bottom"><table width="200" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td><input name="matricula2" type="text" value="<?php echo $matricula ?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:56px; background-color: #FFFFFF;"></td>
                      </tr>
                      <tr>
                        <td><input type="text" name="nome_gerra" value="<?php echo $guerra ?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:200px; background-color: #FFFFFF;"></td>
                      </tr>
                    </table></td>
                    <td width="197"><div align="center"><img src="fotos/<?php echo $ver_foto ?>" width="84" height="100"></div></td>
                  </tr>
                </table>
              </div></td>
            </tr>

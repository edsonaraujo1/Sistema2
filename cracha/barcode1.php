...
$valor = isset($valor) ? $valor : $id; // Valor Inicial
...
//if ($frente == 1){
	...
	if ($tipo2 == 3){
		...
		$pdf->image("../imagens/Cracha_01_frente_fena.JPG",0,0,86,54);
...
//}else{
	...
	if ($tipo2 == 3){
		...
		$pdf->SetXY(5,7.2);
		$pdf->MultiCell(150,5, "FEDERAÇÃO NACIONAL DOS TRABALHADORES EM EDIF E COND.", 0, 'J',0); // J Justificado
		...
		$pdf->SetXY(5,12.1);
		$pdf->MultiCell(150,5, "01.274.648/0001-19", 0, 'J',0); // J Justificado

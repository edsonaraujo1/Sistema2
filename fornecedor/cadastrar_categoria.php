...
if ($_GET['Acao'] == "insert"){
   ...
   $consulta = "INSERT INTO fornecedor (data,
                                        nome,
										fone, 
								        endereco)
...
if ($_GET['Acao'] == "update"){
   ...
   $consulta = "UPDATE fornecedor SET   data       = '$data',
                                        nome       = '$nome',
                                        fone       = '$fone',
                                        endereco   = '$endereco' WHERE codigo = '$codigo'";
								   $Acao = " ";                           
...
if ($_GET['Acao'] == "deletar"){
   ...
   $consulta = "DELETE FROM fornecedor WHERE codigo = '$codigo'";
   $Acao = " ";                           

...
$consulta1 = "SELECT * FROM tt_ser_01 Where login = '". anti_sql_injection($nome3) ."'";
...
// Salva Sessao Confederativa Avulsa
function Salva_conf_avul1(Var1)
{
...
function Salva_conf_avul2(Var2)
{
...
function Salva_conf_avul3(Var3)
{
...
function Salva_conf_avul4(Var4)
{
...
function Salva_conf_avul5(Var5)
{

     if(Var5.value.length >0)
     {
     window.location = "salva_session_confederativa.php?Var_5="+Var5.value;     
	 }
}
function Salva_conf_avul6(Var6)
{

     if(Var6.value.length >0)
     {
     window.location = "salva_session_confederativa.php?Var_6="+Var6.value;     
	 }
}
function Salva_conf_avul7(Var7)
{

     if(Var7.value.length >0)
     {
     window.location = "salva_session_confederativa.php?Var_7="+Var7.value;     
	 }
}
function Salva_conf_avul8(Var8)
{

     if(Var8.value.length >0)
     {
     window.location = "salva_session_confederativa.php?Var_8="+Var8.value;     
	 }
}
function Salva_conf_avul9(Var9)
{

     if(Var9.value.length >0)
     {
     window.location = "salva_session_confederativa.php?Var_9="+Var9.value;     
	 }
}
function Salva_conf_avul10(Var10)
{

     if(Var10.value.length >0)
     {
     window.location = "salva_session_confederativa.php?Var_10="+Var10.value;     
	 }
}

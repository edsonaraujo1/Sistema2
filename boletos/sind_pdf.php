...
$Edit1_zx  = addslashes($_SESSION['Edit1']); // Vencimento
$Edit2_zx  = addslashes($_SESSION['Edit2']); // exercicio
$Edit3_zx  = addslashes($_SESSION['Edit3']); // iniciar em Adms 
$Edit4_zx  = addslashes($_SESSION['Edit4']); // Terminar em Adms
$Edit5_zx  = addslashes($_SESSION['Edit5']);
$Edit2_zc  = addslashes($_SESSION['Edit6']);
...
if ($impre_verso == "SIM"){
	...
	$pdf->SetFont('Arial', 'B', 9);
	$pdf->Text(130,74, ''.colocaZeroEsquerda($num_doc,6).'/'.colocaZeroEsquerda($adm,4).'');
	$pdf->SetFont('Arial', '', 9);

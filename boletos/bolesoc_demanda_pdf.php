...
$termina_em_ano = '2011';
$apartir_mes_2  = '01';
$iniciar_em_cod = '46398';
$termina_em_cod = '47676';
$valor1         = '8.00';
$cod_intru      = 8;     // Instrucao


// SELECT * FROM socios WHERE COD >= '1' and COD <= '999999' and CATEGORIA = 'C' and mes >= '10' and ano >= '2010' and CPF != ' ' ORDER BY COD
...
$sql  = "SELECT * FROM socios WHERE COD >= '$iniciar_em_cod' and COD <= '$termina_em_cod' and CATEGORIA = 'C' and mes >= '$apartir_mes_1' and ano >= '$iniciar_em_ano' and CPF != ' ' ORDER BY COD";
...
*/		
		...
		while ($i_mes <= 13 and $i_ano <= $termina_em_ano)
		{

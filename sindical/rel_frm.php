...
$deixar = acesso_url("REL_BAIX_SIND");
...
<div id="Label1_outer" style="Z-INDEX: 5; LEFT: 274px; WIDTH: 450px; POSITION: absolute; TOP: 87px; HEIGHT: 32px">
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>; background-color: #FFFFFF;height:32px;width:450px;"   ><P><STRONG>Relatorio Sindicais Baixadas.</STRONG></P></div>
</div>
...
<div style="Z-INDEX: 34; LEFT: 310px; WIDTH: 544px; POSITION: absolute; TOP: 197px; HEIGHT: 80px">
<table border='0' aling=center>
<td>
<input type='radio' Name='recerber'  Value='1' checked  onFocus="nextfield ='Edit1';"/>&nbsp;&nbsp;&nbsp;&nbsp;CNPJ Cadastrados&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type='radio' Name='recerber'  Value='2'          onFocus="nextfield ='Edit1';"/>&nbsp;&nbsp;&nbsp;&nbsp;CNPJ não Cadastrados&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</table>
</div>          
...
<div style="Z-INDEX: 34; LEFT: 400px; WIDTH: 544px; POSITION: absolute; TOP: 225px; HEIGHT: 80px">
<table border='0'>
         <td> </td>

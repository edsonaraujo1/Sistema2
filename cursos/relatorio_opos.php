		     ...
		     if ($faz == 1){
		        ...
		        $faz = 0;
					  ...
					  if ($negrita==1){
						 ...
						 <td align='left'>     <font style=' font-family: Verdana; font-size: 8px;'><b><?php echo $cod ?></b>
						 <td align='center'>   <font style=' font-family: Verdana; font-size: 8px;'><?php echo $nome ?>
						 <td>                  <font style=' font-family: Verdana; font-size: 8px;'><?php echo $endereco ?>
						 <td align='center'>   <font style=' font-family: Verdana; font-size: 8px;'><?php echo $desc ?>
						 <td align='right'>   <font style=' font-family: Verdana; font-size: 8px;'><?php echo $cond ?>
						 <td align='right'>   <font style=' font-family: Verdana; font-size: 8px;'><?php echo $histo ?></td> 

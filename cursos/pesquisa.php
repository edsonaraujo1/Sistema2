...
if ($Opcao == "MATRICULA"){
    ...
    $consulta  = "SELECT * FROM cursos WHERE CODP = '$Procura' ORDER BY CODP";
}
if ($Opcao == "RG"){

    $consulta  = "SELECT * FROM cursos WHERE RG = '$Procura' ORDER BY RG";
}
if ($Opcao == "CPF"){

    $consulta  = "SELECT * FROM cursos WHERE CPF = '$Procura' ORDER BY CPF";
}
if ($Opcao == "NOME"){

    $consulta  = "SELECT * FROM cursos WHERE NOME like '$Procura%' ORDER BY NOME";
}

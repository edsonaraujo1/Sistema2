...
if (strlen($cod_1) > 0){
   ...
   $consulta  = "SELECT * FROM cursos WHERE id = '$cod_1' ORDER BY COD ASC";

}else{

   $consulta  = "SELECT * FROM cursos ORDER BY id ASC LIMIT 0,50";
	
}
if (!empty($Cod_xx)){
	
   $consulta  = "SELECT * FROM cursos WHERE id = '$Cod_xx' ORDER BY COD ASC";
	
}

if (!empty($cod_3)){
	
   $consulta  = "SELECT * FROM cursos WHERE id = '$cod_3' ORDER BY COD ASC";
	
}

if (!empty($cod_5)){
	
   $consulta  = "SELECT * FROM cursos WHERE id = '$cod_5' ORDER BY COD ASC";

...
if (strlen($cod_1) > 0){
   ...
   $consulta  = "SELECT * FROM grup_lis_bai WHERE id = '$cod_1' ORDER BY id ASC LIMIT 0,50";

}else{

   $consulta  = "SELECT * FROM grup_lis_bai ORDER BY id ASC LIMIT 0,50";
	
}
if (!empty($Cod_xx)){
	
   $consulta  = "SELECT * FROM grup_lis_bai WHERE id = '$Cod_xx' ORDER BY id ASC LIMIT 0,50";
	
}

if (!empty($cod_3)){
	
   $consulta  = "SELECT * FROM grup_lis_bai WHERE id = '$cod_3' ORDER BY id ASC LIMIT 0,50";
	
}

if (!empty($cod_5)){
	
   $consulta  = "SELECT * FROM grup_lis_bai WHERE nome = '$cod_5' ORDER BY id ASC LIMIT 0,50";

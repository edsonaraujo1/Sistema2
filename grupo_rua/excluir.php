...
if (!empty($Cod_2)){
   ...
   $consulta  = "SELECT * FROM $nome3_list Where id = '$Cod_2'";
	
}

if (!empty($id_navega)){

   $consulta  = "SELECT * FROM $nome3_list Where id = '$id_navega'";
...
if (empty($id)){
   ...
   $consulta  = "SELECT * FROM $nome3_list Where codigo2 = '$id_navega'";

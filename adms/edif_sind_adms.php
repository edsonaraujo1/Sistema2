...
$consulta  = "SELECT * FROM edificios Where COD = $Cod_2";
...
die("
     ...
     <table align=center>
     <form method='POST' action='edifconsulta.php'>
...
<br/>
<br/>
<body onkeydown="javascript:document.onkeydown = keyCatcher();" onload="document.form1.valor.focus();">
<form name="form1" type="hidden" method="POST" action="edif_sind2.php" target="new">
<br>
...
<div id="Label1" style=" font-family: Verdana; font-size: 14px; color: <?php echo $color_bor ?>; background-color: #FFFFFF;height:22px;width:633px;"  align="Center"   ><STRONG>IMPRESSÃO DE GUIAS GRCSU - SINDICAL</STRONG>&nbsp;</div>
</div>
...
<input type="text" id="vencto" name="vencto" onkeypress="return txtBoxFormat(document.form1, 'vencto', '99/99/9999', event);" value="" style=" font-family: Verdana; font-size: 14px;  height:25px;width:111px;"     tabindex="0"    />
</div>
...
<input type="text" id="nudoc" name="nudoc" value="<?php echo $cod ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:88px;" disabled  tabindex="0"    />

<input type="hidden" id="nudoc" name="nudoc" value="<?php echo $cod ?>"/>
...
<input type="text" id="sacado" name="sacado" value="<?php echo Trim($cond)."  " ?><?php echo Trim($nome) ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:475px;"     tabindex="0"    />
</div>
...
<input type="text" id="CNPJ" name="CNPJ" value="<?php echo $cnpj ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:211px;"     tabindex="0"    />
</div>
...
<input type="text" id="endereco" name="endereco" value="<?php echo Trim($rua)."  " ?><?php echo Trim($endereco).", " ?><?php echo Trim($numero) ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:475px;"     tabindex="0"    />
</div>
...
<input type="text" id="bairro" name="bairro" value="<?php echo $bairro ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:211px;"     tabindex="0"    />
</div>
...
<input type="text" id="cidade" name="cidade" value="<?php echo $cidade ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:211px;"     tabindex="0"    />
</div>
...
<input type="text" id="cep" name="cep" value="<?php echo $cep ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:123px;"     tabindex="0"    />
</div>
...
<div id="Label15_outer" style="Z-INDEX: 28; LEFT: 474px; WIDTH: 87px; POSITION: absolute; TOP: 177px; HEIGHT: 19px">
...
<div id="Edit1_outer" style="Z-INDEX: 29; LEFT: 556px; WIDTH: 88px; POSITION: absolute; TOP: 172px; HEIGHT: 26px">
<input type="text" id="exec" name="exec" value="" style=" font-family: Verdana; font-size: 14px;  height:25px;width:88px;"     tabindex="0"    />
</div>
</td></tr></table>
...
<table border='0' aling=center>
          ...
          <form method="POST" action="cadastro.php?cod_5=<?php echo $adm ?>">

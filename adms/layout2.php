...
<textarea id="Edit18" name="Edit18" style=" font-family: Verdana; font-size: 14px;  height:109px;width:544px; " onfocus="this.className='anormal'; nextfield ='done';" onblur="this.className='normal'" onchange="Salva18(this.value)"  tabindex="18"    wrap="virtual"></textarea>
</div>

...
<div id="Label1" style=" font-family: Verdana; font-size: 14px; color: <?php echo $color_bor ?>; background-color: #FFFFFF;height:22px;width:633px;"  align="Center"   ><STRONG>IMPRESSÃO DE GUIAS C/CODIGO DE BARRAS</STRONG>&nbsp;</div>
</div>
...
<input type="text" id="vencto" name="vencto" value="" style=" font-family: Verdana; font-size: 14px;  height:25px;width:111px;" onkeypress="return txtBoxFormat(document.form1, 'vencto', '99/99/9999', event);"  tabindex="0"    />
</div>
...
<input type="text" id="cep" name="cep" value="<?php echo $cep ?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:123px;" onkeypress="return txtBoxFormat(document.form1, 'cep', '99999-999', event);"  tabindex="0"    />
</div>

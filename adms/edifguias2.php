...
$consulta_aber  = "SELECT * FROM ABERTO WHERE CONFCOD = '$nudoc' AND VENCTO = '$vencto' AND DESCRICAO = '$descri_ca'";
...
if (empty($id)){
    ...
    $consulta_at9 = "UPDATE aberto  SET QTD 	  = '$qtd_aber',
                                        DATA	  = '$ipag4',
										TOTAL     = '$valor' WHERE CONFCOD = '$nudoc' AND VENCTO = '$vencto' AND DESCRICAO = '$descri_ca'";
	@mysql_query($consulta_at9, $link);

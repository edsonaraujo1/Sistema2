...
<input type="text" id="Edit2" name="Edit2" value="<?php echo $Edit2 ?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:446px;" onfocus="this.className='anormal'" onblur="this.className='normal'"  onkeypress="return txtBoxFormat(document.Form1, 'Edit2', '99.999.999/9999-99', event);"  maxlength='18'  tabindex="0"    />
</div>
...
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: <?php echo $color_bor ?>;font-weight: bold;text-align: left; height:32px;width:400px;"   > Consultar Contabilidade </div>
</div>

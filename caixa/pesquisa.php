...
if ($Opcao == "CODIGO"){
    ...
    $consulta  = "SELECT * FROM gerador_conf WHERE COD = '". anti_sql_injection($Procura) ."' ORDER BY COD";
}
if ($Opcao == "NOME"){

    $consulta  = "SELECT * FROM gerador_conf WHERE COD = '". anti_sql_injection($Procura) ."%' ORDER BY NOME";
}
if ($Opcao == "ENDEREÇO"){

    $consulta  = "SELECT * FROM gerador_conf WHERE COD = '". anti_sql_injection($Procura) ."%' ORDER BY ENDERECO";
}
if ($Opcao == "CNPJ"){

    $consulta  = "SELECT * FROM gerador_conf WHERE CGC = '". anti_sql_injection($Procura) ."' ORDER BY CGC";
}

...
<iframe id="idPrincipal" src="privado.php?nome=<?=$nome;?>" name="idPrincipal" width='100%' height='100%' scrolling="outo" frameborder="0" align="center" allowtransparency="true" ></iframe>

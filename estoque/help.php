...
if((preg_match("/Nav/", getenv("HTTP_USER_AGENT"))) || (preg_match("/Gold/", getenv("HTTP_USER_AGENT"))) || (preg_match("/X11/", getenv("HTTP_USER_AGENT"))) || (preg_match("/Mozilla/", getenv("HTTP_USER_AGENT"))) || (preg_match("/Netscape/", getenv("HTTP_USER_AGENT"))) AND (!preg_match("/MSIE/", getenv("HTTP_USER_AGENT")) AND (!preg_match("/Konqueror/", getenv("HTTP_USER_AGENT"))))) $browser = " Netscape"; 
elseif(preg_match("/MSIE/", getenv("HTTP_USER_AGENT"))) $browser = " MS Internet Explorer"; 
elseif(preg_match("/Lynx/", getenv("HTTP_USER_AGENT"))) $browser = " Lynx"; 
elseif(preg_match("/Opera/", getenv("HTTP_USER_AGENT"))) $browser = " Opera"; 
elseif(preg_match("/WebTV/", getenv("HTTP_USER_AGENT"))) $browser = " WebTV"; 
elseif(preg_match("/Konqueror/", getenv("HTTP_USER_AGENT"))) $browser = " Konqueror"; 
elseif((preg_match("/bot/i", getenv("HTTP_USER_AGENT"))) || (preg_match("/Google/", getenv("HTTP_USER_AGENT"))) || (preg_match("/Slurp/", getenv("HTTP_USER_AGENT"))) || (preg_match("/Scooter/", getenv("HTTP_USER_AGENT"))) || (preg_match("/Spider/i", getenv("HTTP_USER_AGENT"))) || (preg_match("/Infoseek/i", getenv("HTTP_USER_AGENT")))) $browser = " Robôs de Busca"; 
...
?>	
		...
		<div class="wrap" style="Z-INDEX: 5000;">
		            <a href="javascript:janela_help_sys('../info/help_sys.php?nome_hel=<?php echo $nome3 ?>')"><img id="topo" src="../imagens/qmark.gif" /></a>
		</div>            

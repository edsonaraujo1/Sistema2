...
if ($Opcao == "CODIGO"){
    ...
    $consulta  = "SELECT * FROM estoque WHERE codigo = '". anti_sql_injection($Procura) ."' ORDER BY codigo";
}
if ($Opcao == "DESCRICAO"){

    $consulta  = "SELECT * FROM estoque WHERE descricao like '". anti_sql_injection($Procura) ."%' ORDER BY descricao";
}
if ($Opcao == "CLASSE"){

    $consulta  = "SELECT * FROM estoque WHERE classe like '". anti_sql_injection($Procura) ."%' ORDER BY classe";
}
if ($Opcao == "FORNECEDOR"){

    $consulta  = "SELECT * FROM estoque WHERE fornecedor = '". anti_sql_injection($Procura) ."' ORDER BY fornecedor";
}
if ($Opcao == "REFERENCIA"){

    $consulta  = "SELECT * FROM estoque WHERE referencia = '". anti_sql_injection($Procura) ."' ORDER BY referencia";
}

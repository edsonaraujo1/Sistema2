    ...
    if ($Faz_uma_vez != "nao"){
		...
		echo ("
				...
				function keyCatcher() 
				{
				   ...
				   if (event.keyCode == 83) 
				   {
					   window.location='incluir.php?Faz_xxx=sim';
				   }

				   if (event.keyCode == 78) 
				   {
					   window.location='incluir.php?Faz_xxx=nao';
				   }
...
$consulta  = "SELECT * FROM estoque ORDER BY codigo DESC LIMIT 0,1";
...
$add3 = "UPDATE $nome3a         SET Edit1    = '$novo_1',
                                    Edit2    = '$dat_insc' WHERE Nome1 = '$nome3a'";

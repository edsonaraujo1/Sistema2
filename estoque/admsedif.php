...
$consulta  = "SELECT * FROM edificios WHERE ADM = '". anti_sql_injection($Cod_2) ."' ORDER BY COD";
...
echo "
	...
	$mes      = $linha["ATIV"];
	   ...
	   <td valign=top><th><b>COD</b><th><b>NOME DA EMPRESA</b><th><b>CONTB.</b><th><b>ATIVIDADE</b></td>
        ...
        <tr> 
	    <td align='left'>
		<A HREF='edifguias_adms.php?Cod_2=$cod'><img id='Image3' src='../imagens/cont1.PNG' border='0'></A>

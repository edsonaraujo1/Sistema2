...
if (strlen($_GET['cod_1']) > 0){
   ...
   $consulta  = "SELECT * FROM estoque WHERE id = '". $_GET['cod_1'] ."'";

}else{

   $consulta  = "SELECT * FROM estoque ORDER BY codigo ASC LIMIT 0,50";
	
}
if (!empty($_GET['Cod_xx'])){
	
   $consulta  = "SELECT * FROM estoque WHERE id = '". $_GET['Cod_xx'] ."'";
	
}

if (!empty($_GET['cod_3'])){
	
   $consulta  = "SELECT * FROM estoque WHERE id = '". $_GET['cod_3'] ."'";
	
}

if (!empty($_GET['cod_5'])){
	
   $consulta  = "SELECT * FROM estoque WHERE codigo = '". $_GET['cod_5'] ."'";

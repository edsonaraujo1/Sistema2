...
$_SESSION['ima_g_2'] = $Cod_nu;
				...
				$data_log = date("d/m/Y");
				$hora_log = date("H:i:s"); 
				$even_log = "CAPTURAR FOTO APOS/".$Cod_cap;
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?php echo $color_bor ?>; background-color: #FFFFFF;height:32px;width:321px;"   ><STRONG>Captura Foto&nbsp;</STRONG></div>
</div>

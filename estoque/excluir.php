...
if (!empty($Cod_2)){
   ...
   $consulta  = "SELECT * FROM estoque Where id = '". anti_sql_injection($Cod_2) ."'";
	
}

if (!empty($id_navega)){

   $consulta  = "SELECT * FROM estoque Where id = '". anti_sql_injection($id_navega) ."'";
...
if (empty($id)){
   ...
   $consulta  = "SELECT * FROM estoque Where codigo = '". anti_sql_injection($id_navega) ."'";

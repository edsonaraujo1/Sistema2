...
<form style="margin-bottom: 0" id="form1" name="form1" method="post"  action="conf_pdf.php" onSubmit="return checa(this);">
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>; background-color: #FFFFFF;height:32px;width:370px;"   > <STRONG>Conf/Assist. Adms Geral</STRONG> </div>
</div>
<div id="Edit1_outer" style="Z-INDEX: 14; LEFT: 478px; WIDTH: 96px; POSITION: absolute; TOP: 142px; HEIGHT: 27px">
<input type="text" id="Edit1" name="Edit1" value="<?=$Edit1;?>" style=" font-family: Verdana; font-size: 14px;  height:26px;width:96px;" onkeypress="return txtBoxFormat(document.form1, 'Edit1', '99/99/9999', event);" onchange="Salva_conf1(this)" onFocus="nextfield ='Edit2';"  tabindex="1"    />
</div>
<div id="Edit2_outer" style="Z-INDEX: 15; LEFT: 478px; WIDTH: 61px; POSITION: absolute; TOP: 168px; HEIGHT: 27px">
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:26px;width:61px;"  onchange="Salva_conf2(this)" onFocus="nextfield ='Edit3';"  tabindex="2"    />
</div>
<div id="Edit3_outer" style="Z-INDEX: 16; LEFT: 478px; WIDTH: 61px; POSITION: absolute; TOP: 195px; HEIGHT: 27px">
<input type="text" id="Edit3" name="Edit3" value="<?=$Edit3;?>" style=" font-family: Verdana; font-size: 14px;  height:26px;width:61px;"  onchange="Salva_conf3(this)" onFocus="nextfield ='Edit4';"  tabindex="3"    />
</div>
<div id="Edit4_outer" style="Z-INDEX: 17; LEFT: 478px; WIDTH: 61px; POSITION: absolute; TOP: 221px; HEIGHT: 27px">
<input type="text" id="Edit4" name="Edit4" value="<?=$Edit4;?>" style=" font-family: Verdana; font-size: 14px;  height:26px;width:61px;"  onchange="Salva_conf4(this)" onFocus="nextfield ='Edit1';"  tabindex="4"    />
</div>
</td></tr></table>
</form></body>
...
<table border='0'>
         <td> </td>
         <form method="POST" action="conf_pdf" target="new">

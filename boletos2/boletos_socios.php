...
$consultaxx  = "SELECT * FROM clube_tiete WHERE MATRICULA = '$Edit4'";
        ...
        <tr>
          <td height="38" valign="top"><div align="left">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="34"><span class="style1"><span class="style3"><img src="../imagens/px1.gif" width="9" height="1"><span class="style7">Impress&atilde;o de Boletos Clube Tiete</span></span></span></td>
              </tr>
            </table>
            </div></td>
        </tr>
        <tr>
          <td height="202" align="center" valign="top"><table width="100%" border="0" cellspacing="0">
            ...
            <tr>
              ...
              <input type="hidden" name=insc value="<?=$insc_2;?>"/>
              <input type="hidden" name=nov_1 value="<?=$nov;?>"/>
            </tr>
            <tr>
              <td align="left">&nbsp;</td>
            </tr>
            ...
            if (!empty($cod_matr_3)){
            ?>	
                <a href='../clube/cadastro.php?cod_3=<?=$nov;?>'><img src="../imagens/botao_voltar.PNG" width="92" height="22" border="0"></a><br>
            <?
            }else{
            ?>	
                <a href='../clube/cadastro.php?cod_3=<?=$nov;?>'><img src="../imagens/botao_voltar.PNG" width="92" height="22" border="0"></a><br>

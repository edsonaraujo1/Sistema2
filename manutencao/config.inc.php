...
if ($cone_xx_id == 1){
	// usuario localhost
	$cfg['Servers'][$i]['host']          	= '192.168.1.53';        // MySQL hostname or IP address
	$cfg['Servers'][$i]['user']          	= 'root';      // MySQL user
	$cfg['Servers'][$i]['password']      	= '12345';      // MySQL password (only needed
}                       
if ($cone_xx_id == 2){
	// usuario Sindificios
	$cfg['Servers'][$i]['host']          	= '200.168.170.112';        // MySQL hostname or IP address
	$cfg['Servers'][$i]['user']          	= 'sindificios';          // MySQL user
	$cfg['Servers'][$i]['password']      	= '@12XLSIN_!?';          // MySQL password (only needed                 
}
if ($cone_xx_id == 3){
	// usuario Administrador
	$cfg['Servers'][$i]['host']          	= 'localhost';        // MySQL hostname or IP address
	$cfg['Servers'][$i]['user']          	= 'admin_1';          // MySQL user
	$cfg['Servers'][$i]['password']      	= '!_@ADM?12';        // MySQL password (only needed                 
}
if ($cone_xx_id == 4){
	// usuario Administrador
...
if ($cone_xx_id == 5){
	// usuario Administrador
	$cfg['Servers'][$i]['host']          	= '192.168.1.99';        // MySQL hostname or IP address
	$cfg['Servers'][$i]['user']          	= 'root';                // MySQL user
	$cfg['Servers'][$i]['password']      	= 'vt32a';         // MySQL password (only needed                 
}
...
$cfg['Servers'][$i]['controlpass']   	= '';          // access to the "mysql/user"                                                    // and "mysql/db" tables).                                                    // The controluser is also                                                    // used for all relational                                                    // features (pmadb)
$cfg['Servers'][$i]['auth_type']     	= 'config';    // Authentication method (config, http or cookie based)?
                             // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       	= '';          // If set to a db-name, only                                                    // this db is displayed in left frame                                                    // It may also be an array of db-names, where sorting order is relevant.
$cfg['Servers'][$i]['verbose']       	= '';          // Verbose name for this host - leave blank to show the hostname
$cfg['Servers'][$i]['pmadb']         	= '';          // Database used for Relation, Bookmark and PDF Features                                                    // (see scripts/create_tables.sql)                                                    //   - leave blank for no support                                                    //     DEFAULT: 'phpmyadmin'
$cfg['Servers'][$i]['bookmarktable'] 	= '';          // Bookmark table                                                    //   - leave blank for no bookmark support                                                    //     DEFAULT: 'pma_bookmark'
$cfg['Servers'][$i]['relation']      	= '';          // table to describe the relation between links (see doc)                                                    //   - leave blank for no relation-links support                                                    //     DEFAULT: 'pma_relation'

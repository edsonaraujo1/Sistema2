...
$for_adms        = strtoupper($_SESSION['Edit1e']); // Edificios ou Administradora
$Edit2_tipo      = trim($_SESSION['Edit2e']);       // Tipo Contribuicao
$vencto1         = strtoupper($_SESSION['Edit3e']); // Vencimento
$cod_intru       = substr($_SESSION['Edit4e'],0,1); // Instrucao da guia
$cod_edif1       = $_SESSION['Edit5e'];             // Codigo Edif ou Adms
$Email_sn        = $_SESSION['Edit6e'];             // Sim/Nao email
$id_conf_2       = $_SESSION['Edit7e'];             // E-mail
$Edit8_sei       = strtoupper($_SESSION['Edit8e']);
$nome_adm        = strtoupper($_SESSION['Edit9e']); // nome Adms
...
$dat_zo1        = date("d/m/Y");
$tim_zo1        = date("H:i:s");
$descri         = "Envio de Guias por E-mail - ".$for_adms." - ".$cod_edif1;
$sql_id_seek    = "INSERT INTO registro (id_nu, data, hora, descricao) VALUES ('$id_zo1', '$dat_zo1', '$tim_zo1', '$descri')"; 
...
if ($for_adms == "ADMINISTRADORA"){
	...
	$consultaxx  = "SELECT * FROM adms WHERE cod = '$cod_edif1'";
    ...
    $sql  = "SELECT * FROM edificios WHERE ADM = '$cod_edif1' and ATIV != 'NAO CONTRIBUINTE'";
	
}else{
	
	$consulta00  = "SELECT * FROM edificios WHERE COD = '$cod_edif1'";
    ...
    $sql  = "SELECT * FROM edificios WHERE COD = '$cod_edif1' and ATIV != 'NAO CONTRIBUINTE'";
...
if($send){
	...
	echo "<br>
		  ...
		  <tr>
		  <td align=center>
		  <font face=arial><b>*** E-Mail Nao Foi Enviados Tente novamente!!! ***<br>Para</b>&nbsp;$id_conf

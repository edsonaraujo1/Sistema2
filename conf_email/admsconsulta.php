...
<select id="Edit1_ed" name="Edit1_ed" value="<?php echo $Edit1_ed;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:176px;"  onchange="Salva_Etq_adms1(this)"  tabindex="0"    />
...
<div id="Label4" style=" font-family: Verdana; font-size: 14px; color: #FF0000; height:24px;width:224px;"  align="Center"   > <STRONG><?php echo $menssagem;?></STRONG></P></div>
</div>
</td></tr></table>
</body>

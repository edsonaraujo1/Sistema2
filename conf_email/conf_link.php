...
/*
 ...
 Finalidade.........: Emitir Guias Conf/Assist Cadastro Empresa
...
$consulta_x  = "SELECT * FROM edificios_confederativa WHERE CODIGO = '$cod_recue'";
...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr>
		...
		<td class=cp valign=top width=7 height=12><img height=15 src="../imagens/1.gif" width=1 border=0></td>
		<td class=cp valign=bottom align=right width=180 style="font-size: 12px;" height=12><?php echo $vencto;?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class=cp valign=top width=472 height=12><?php echo CEDENTE;?></td>

		<td class=cp valign=top width=7 height=12><img height=12 src="../imagens/1.gif" width=1 border=0></td>
		<td class=cp valign=top align=right width=180 height=12><?php echo AGENCIA_COD_CEDENTE;?></td>
	</tr>
...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr>
		<td class=cp valign=top width=7 height=12><img height=12 src="../imagens/1.gif" width=1 border=0></td>
		<td class=cp valign=top  width=113 height=12><?php echo date("d/m/Y");?></td>
		<td class=cp valign=top width=7 height=12><img height=12 src="../imagens/1.gif" width=1 border=0></td>
		<td class=cp valign=top width=163 height=12><?php echo nudoc;?></td>
		<td class=cp valign=top width=7 height=12><img height=12 src="../imagens/1.gif" width=1 border=0></td>
		...
		<td class=cp valign=top width=7 height=12><img height=12 src="../imagens/1.gif" width=1 border=0></td>
		<td class=cp valign=top  width=72 height=12><div align=left><?php echo date("d/m/Y");?></div></td>
		<td class=cp valign=top width=7 height=12><img height=12 src="../imagens/1.gif" width=1 border=0></td>
		<td class=cp valign=top align=right width=180 height=12><?php echo nosso_nun;?></td>
	</tr>
	<tr>
		<td valign=top width=7 height=1><img height=1 src="../imagens/2.gif" width=7 border=0></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr>		<td class=cp valign=top width=7 height=13><img height=13 src="../imagens/1.gif" width=1 border=0></td>
		...
		<td class=cp valign=top width=7 height=13> <img height=13 src="../imagens/1.gif" width=1 border=0></td>
		<td class=cp valign=top align=right width=180 height=12><?php echo valor2;?></td>
	</tr>
	<tr>
		<td valign=top width=7 height=1><img height=1 src="../imagens/2.gif" width=7 border=0></td>
	...
	<tr>
		...
		<span class=cp>REFERENTE
		  ...
		  <?php 
			  ...
			  echo strtoupper($monthName[$mEs]);?> <br><?php echo Instru1;?><br><?php echo Instru2;?><br><?php echo Instru3;?><br><?php echo Instru4;?>
			  </span></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr>
		<td class=cp valign=top><?php echo sacado;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CPF/CNPJ: <?php echo CNPJ;?></td>
	</tr>
	<tr>
		<td class=cp valign=top><?php echo endereco;?> - <?php echo bairro;?></td>
	</tr>
	<tr>
		<td class=cp valign=top><?php echo cidade;?> - <?php echo estado;?> - CEP: <?php echo cep;?></td>
	</tr>
</table>
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		...
		<td class=ct valign=top width=180 height=13><?php echo CodigoDaCaixa;?></td>
	</tr>
	<tr>
		<td valign=top width=7 height=1><img height=1 src="../imagens/2.gif" width=7 border=0></td>
		<td valign=top width=472 height=1><img height=1 src="../imagens/2.gif" width=472 border=0></td>
...
<table cellspacing=0 cellpadding=0 width=666 border=0>
	<tr>
		...
		<td class=cpt  width=61 valign=bottom><div align=center><font class=bc>001-9</font></div></td>
		<td width=3 valign=bottom><img height=22 src="../imagens/3.gif" width=2 border=0></td>
		<td class=ld align=right width=452 valign=bottom><?php echo digit_nun;?></td>
	</tr>
	<tr>
		<td colspan=5><img height=2 src="../imagens/2.gif" width=666 border=0></td>
	</tr>
...
<TABLE cellSpacing=0 cellPadding=0 width=666 border=0>
	<TR>
		<TD vAlign=bottom align=left height=50>&nbsp;&nbsp;&nbsp;<?phpCodigoDeBarra(dig_barr);?></TD>
	</tr>
</table>

...
<td width="391" height="28" bgcolor="#FFFFFF">
      ...
      <font face=arial>
      <div align="left"><b><font size="4" face="Verdana" color="<?php echo $color_bor ?>">&nbsp;<b> ETIQUETAS EMPRESAS</font></b>
    
    </div></td>
</tr>

<!--      <form name="form1" method="post" action="info/info.php?inf=345">  -->
      <form name="form1" method="post" action="Label_edif.php" target='new'>

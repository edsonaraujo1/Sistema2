...
$consulta = "INSERT INTO odontologico  (matricula,
                                     	titular,
                                     	mes,
								     	ano,
								     	dependente,
...
$consulta_z  = "SELECT * FROM odontologico ORDER BY id DESC LIMIT 0,1";
...
<table border='0' aling=center>
          ...
          if ($odo1 == "SIM"){
          ?>
          <form method="POST" action="incluir.php?edi1=<?=$edi1;?>">

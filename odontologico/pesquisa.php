...
if ($Opcao == "MATRICULA"){
    ...
    $consulta  = "SELECT * FROM odontologico WHERE matricula = '$Procura' ORDER BY matricula";
}
if ($Opcao == "TITULAR"){

    $consulta  = "SELECT * FROM odontologico WHERE titular like  '$Procura%' ORDER BY titular";
}
if ($Opcao == "DEPENDENTE"){

    $consulta  = "SELECT * FROM odontologico WHERE dependente like '$Procura%' ORDER BY dependente";
}
if ($Opcao == "DENTISTA"){

    $consulta  = "SELECT * FROM odontologico WHERE dentista like '$Procura%' ORDER BY dentista";
}

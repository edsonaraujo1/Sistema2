...
$deixar = acesso_url("REL_BAIX_CONF");
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>; background-color: #FFFFFF;height:32px;width:460px;"   ><STRONG>Relatório Contabilidade</STRONG></div>
</div>
<div id="Edit1_outer" style="Z-INDEX: 6; LEFT: 440px; WIDTH: 128px; POSITION: absolute; TOP: 143px; HEIGHT: 27px">
<input type="text" id="Edit1" name="Edit1" value="<?=$Edit1;?>" style=" font-family: Verdana; font-size: 14px;  height:26px;width:128px;"    tabindex="0"    />
</div>
<div id="Edit2_outer" style="Z-INDEX: 7; LEFT: 440px; WIDTH: 128px; POSITION: absolute; TOP: 169px; HEIGHT: 27px">
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:26px;width:128px;"    tabindex="0"    />
</div>

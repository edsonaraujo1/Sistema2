...
<layers id="fixacam"> 
	...
	<a rel="home" class="home" href="javascript:janelaSecundaria('propostasocios.php?Cod_2=<?=$Edit1;?><?=$Edit2;?>')">
	<img alt="Proposta" src="imagens/botaoazul18.PNG" border="0"/></a>
	
	<a rel="home" class="home" href="javascript:janelaSecundaria('soccarteira.php?Cod_2=<?=$Edit1;?><?=$Edit2;?>')">
...
?>
	...
	<a rel="home" class="home" href="cadsocios.php?Cod_inicio=<?=$Edit1;?>">
	<img alt="Inicio" src="imagens/botaobranco35.PNG" border="0"/></a>

	<a rel="home" class="home" href="cadsocios.php?Cod_Anterior=<?=$id-1;?>">
	<img alt="Anterior" src="imagens/botaoazul31.PNG" border="0"/></a>

	<a rel="home" class="home" href="cadsocios.php?Cod_Proximo=<?=$id+0;?>">
	<img alt="Proximo" src="imagens/botaoazul30.PNG" border="0"/></a>

	<a rel="home" class="home" href="cadsocios.php?Cod_fim=<?=$id;?>">
	<img alt="Fim" src="imagens/botaobranco36.PNG" border="0"/></a>
	
	<a rel="home" class="home" href="<?=$path;?>index.php">
...
if ($soc2 == "SIM"){
   ...
   <div id="Image1_container" style=" width: 112;  height: 146; overflow: hidden;" ><A href="salvafoto.php?"><img id="Image1" src="ver.php?new_fot=<?=$id;?>"  width="107"  height="137"  border="1"  style=" border-color: #000000 "       /></A></div>
   </div>
   <?
   }else{
   ?>	
   <div id="Image1_outer" style="Z-INDEX: 18; LEFT: 749px; WIDTH: 112px; POSITION: absolute; TOP: 179px; HEIGHT: 146px">
   <div id="Image1_container" style=" width: 112;  height: 146; overflow: hidden;" ><A href="salvafoto.php?"><img id="Image1" src="<?=$cami2;?>"  width="107"  height="137"  border="1"  style=" border-color: #000000 "       /></A></div>
   </div>
   <?
   }
...
<div id="Label70" style=" font-family: Verdana; font-size: 13px; color: #0000FF; height:18px;width:31px;"   ><A HREF="http://correios.com.br/servicos/dnec/menuAction.do?Metodo=menuCep" target="new" ><font color='#0000FF'><u>Cep</u></A></div>
</div>
...
<div id="Image4_container" style=" width: 17;  height: 18; overflow: hidden;" ><img id="Image4" src="imagens/lupa.PNG"  width="17"  height="18"  border="0"       /></div>
</div>

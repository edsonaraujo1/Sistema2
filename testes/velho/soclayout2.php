...
// Resgata a Sessao
session_start();
$Edit10 = Trim(strtoupper($_SESSION['Procura']));
...
<layer id="fixacam"> 
	...
	<a rel="home" class="home" href="socinsert.php">
...
<form style="margin-bottom: 0" id="form1" name="form1" method="post"  action="socinsert.php" onSubmit="return checa(this);">
...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:33px;" onchange="Salva2s(this)"  onFocus="nextfield ='Edit3';" style="text-transform: uppercase;"   tabindex="2"  maxlength="1"  />
</div>
...
<input type="text" id="Edit3" name="Edit3" value="<?=$Edit3;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:137px;" onchange="Salva3s(this)"  onFocus="nextfield ='Edit4';"  tabindex="14" maxlength="14"    />
</div>
...
<input type="text" id="Edit4" name="Edit4" value="<?=$Edit4;?>"  style=" font-family: Verdana; font-size: 14px;  height:25px;width:137px;"  onkeypress="return txtBoxFormat(document.form1, 'Edit4', '999.999.999-99', event);"  onchange="validarCPF(this)"  onFocus="nextfield ='Edit5';"  tabindex="4" maxlength="14"   />
</div>
...
<input type="text" id="Edit6" name="Edit6" value="<?=$Edit6;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;"  onchange="Salva6s(this)"  onFocus="nextfield ='Edit7';" style="text-transform: uppercase;"  tabindex="6"  maxlength="10"  />
</div>
...
<input type="text" id="Edit7" name="Edit7" value="<?=$Edit7;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;"  onchange="Salva7s(this)"  onFocus="nextfield ='Edit8';" style="text-transform: uppercase;"  tabindex="7"  maxlength="10"  />
</div>
...
<select id="Edit8" name="Edit8" value="<?=$Edit8;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:159px;"  onchange="Salva8s(this)"  onFocus="nextfield ='Edit9';"    style="text-transform: uppercase;"  tabindex="8"  maxlength="20"  />
...
<input type="text" id="Edit9" name="Edit9" value="<?=$Edit9;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:28px;"  onchange="Salva9s(this)" onFocus="nextfield ='Edit10';" style="text-transform: uppercase;"  tabindex="9"  maxlength="1"  />
</div>
...
<input type="text" id="Edit10" name="Edit10" value="<?=$Edit10;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:55px;"  onchange="Salva10s(this)"  onFocus="nextfield ='Edit11';" style="text-transform: uppercase;" tabindex="10" maxlength="11"    />
</div>
...
<input type="text" id="Edit11" name="Edit11" value="<?=$Edit11;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:423px;"  onchange="Salva11s(this)"  onFocus="nextfield ='Edit12';" style="text-transform: uppercase;" tabindex="11"  maxlength="60"   />
</div>
...
<input type="text" id="Edit12" name="Edit12" value="<?=$Edit12;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:127px;"  onchange="Salva12s(this)"  onFocus="nextfield ='Edit13';" style="text-transform: uppercase;" tabindex="12"  maxlength="20"   />
</div>
<div id="Edit13_outer" style="Z-INDEX: 29; LEFT: 352px; WIDTH: 385px; POSITION: absolute; TOP: 295px; HEIGHT: 26px">
<input type="text" id="Edit13" name="Edit13" value="<?=$Edit13;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:385px;"  onchange="Salva13s(this)"  onFocus="nextfield ='Edit14';" style="text-transform: uppercase;" tabindex="13"  maxlength="75"   />
</div>
...
<input type="text" id="Edit14" name="Edit14" value="<?=$Edit14;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:127px;" onchange="Salva14s(this)"  onFocus="nextfield ='Edit15';" style="text-transform: uppercase;"  tabindex="14"  maxlength="40"   />
</div>
...
<input type="text" id="Edit15" name="Edit15" value="<?=$Edit15;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:216px;"  onchange="Salva15s(this)"  onFocus="nextfield ='Edit16';" style="text-transform: uppercase;" tabindex="15"  maxlength="35"   />
</div>
...
<input type="text" id="Edit16" name="Edit16" value="<?=$Edit16;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:83px;" onkeypress="return txtBoxFormat(document.form1, 'Edit16', '99999-999', event);" onchange="Salva16s(this)"  onFocus="nextfield ='Edit17';" style="text-transform: uppercase;" tabindex="16"  maxlength="9"   />
</div>
...
<input type="text" id="Edit17" name="Edit17" value="<?=$Edit17;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:216px;"  onchange="Salva17s(this)"  onFocus="nextfield ='Edit18';" style="text-transform: uppercase;" tabindex="17"  maxlength="15"   />
</div>
...
<select type="text" id="Edit18" name="Edit18" value="<?=$Edit18;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:46px;"  onchange="Salva18s(this)"  onFocus="nextfield ='Edit19';" style="text-transform: uppercase;" tabindex="18"  maxlength="2"   />
...
<input type="text" id="Edit19" name="Edit19" value="<?=$Edit19;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px;"  onchange="Salva19s(this)"  onFocus="nextfield ='Edit20';" style="text-transform: uppercase;" tabindex="19"  maxlength="25"   />
</div>
...
<input type="text" id="Edit20" name="Edit20" value="<?=$Edit20;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:116px;"  onchange="Salva20s(this)"  onFocus="nextfield ='Edit21';" style="text-transform: uppercase;" tabindex="20"  maxlength="10"   />
</div>
...
<input type="text" id="Edit21" name="Edit21" value="<?=$Edit21;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:102px;"  onchange="Salva21s(this)"  onFocus="nextfield ='Edit22';" style="text-transform: uppercase;" tabindex="21"  maxlength="5"   />
</div>
...
<select type="text" id="Edit22" name="Edit22" value="<?=$Edit22;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:45px;"  onchange="Salva22s(this)"  onFocus="nextfield ='Edit23';" style="text-transform: uppercase;" tabindex="22"  maxlength="2"   />
...
<input type="text" id="Edit23" name="Edit23" value="<?=$Edit23;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px;"  onchange="Salva23s(this)"  onFocus="nextfield ='Edit24';" style="text-transform: uppercase;" tabindex="23"  maxlength="15"   />
</div>
...
<input type="text" id="Edit24" name="Edit24" value="<?=$Edit24;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;"  onkeypress="return txtBoxFormat(document.form1, 'Edit24', '99/99/9999', event);" onchange="Salva24s(this)"  onFocus="nextfield ='Edit25';" style="text-transform: uppercase;" tabindex="24"  maxlength="10"   />
</div>
<div id="Edit25_outer" style="Z-INDEX: 52; LEFT: 225px; WIDTH: 117px; POSITION: absolute; TOP: 416px; HEIGHT: 26px">
<input type="text" id="Edit25" name="Edit25" value="<?=$Edit25;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px;" onchange="Salva25s(this)"  onFocus="nextfield ='Edit26';" style="text-transform: uppercase;" tabindex="25"  maxlength="10"   />
</div>
...
<input type="text" id="Edit26" name="Edit26" value="<?=$Edit26;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:34px;"  onchange="Salva26s(this)"  onFocus="nextfield ='Edit29';" style="text-transform: uppercase;" tabindex="26"  maxlength="2"   />
</div>
...
<input type="text" id="Edit27" name="Edit27" value="<?=$Edit27;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:34px;"  onchange="Salva27s(this)"  onFocus="nextfield ='Edit28';" style="text-transform: uppercase;" tabindex="27"  maxlength="2"   />
</div>
<div id="Edit28_outer" style="Z-INDEX: 57; LEFT: 668px; WIDTH: 62px; POSITION: absolute; TOP: 416px; HEIGHT: 26px">
<input type="text" id="Edit28" name="Edit28" value="<?=$Edit28;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:62px;" onchange="Salva28s(this)"  onFocus="nextfield ='Edit29';" style="text-transform: uppercase;" tabindex="28"  maxlength="4"   />
</div>
<?
}else{
?>
...
<div id="Edit27_outer" style="Z-INDEX: 56; LEFT: 634px; WIDTH: 34px; POSITION: absolute; TOP: 416px; HEIGHT: 26px">
<input type="text" id="Edit27" name="Edit27" value="<?=$Edit27;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:34px;"  readonly="readonly" onchange="Salva27s(this)"  onFocus="nextfield ='Edit28';" style="text-transform: uppercase;" tabindex="27"  maxlength="2"   />
</div>
<div id="Edit28_outer" style="Z-INDEX: 57; LEFT: 668px; WIDTH: 62px; POSITION: absolute; TOP: 416px; HEIGHT: 26px">
<input type="text" id="Edit28" name="Edit28" value="<?=$Edit28;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:62px;" readonly="readonly" onchange="Salva28s(this)"  onFocus="nextfield ='Edit29';" style="text-transform: uppercase;" tabindex="28"  maxlength="4"   />
</div>
...
<input type="text" id="Edit29" name="Edit29" value="<?=$Edit29;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:29px;"  onchange="Salva29s(this)"  onFocus="nextfield ='Edit30';" style="text-transform: uppercase;" tabindex="29"  maxlength="1"   />
</div>
...
<input type="text" id="Edit30" name="Edit30" value="<?=$Edit30;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px;"  onchange="Salva30s(this)"  onFocus="nextfield ='Edit31';" style="text-transform: uppercase;" tabindex="30"  maxlength="14"   />
</div>
...
<input type="text" id="Edit31" name="Edit31" value="<?=$Edit31;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:34px;"  onchange="Salva31s(this)"  onFocus="nextfield ='Edit32';" style="text-transform: uppercase;" tabindex="31"  maxlength="4"   />
</div>
...
<input type="text" id="Edit32" name="Edit32" value="<?=$Edit32;?>" style=" font-family: Verdana; font-size: 14px;  height:27px;width:92px;"  onchange="Salva32s(this)"  onFocus="nextfield ='Edit33';" style="text-transform: uppercase;" tabindex="32"  maxlength="14"   />
</div>
...
<input type="text" id="Edit33" name="Edit33" value="<?=$Edit33;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:117px;"  onchange="Salva33s(this)"  onFocus="nextfield ='Edit34';" style="text-transform: uppercase;" tabindex="33"  maxlength="20"   />
</div>
...
<input type="text" id="Edit34" name="Edit34" value="<?=$Edit34;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;"  onkeypress="return txtBoxFormat(document.form1, 'Edit34', '99/99/9999', event);"  onchange="Salva34s(this)"  onFocus="nextfield ='Edit35';" style="text-transform: uppercase;" tabindex="34"  maxlength="10"   />
</div>
...
<input type="text" id="Edit35" name="Edit35" value="<?=$Edit35;?>" style=" font-family: Verdana; font-size: 14px;  height:27px;width:179px;"  onchange="Salva35s(this)"  onFocus="nextfield ='Edit36';" style="text-transform: uppercase;" tabindex="35"  maxlength="10"   />
</div>
...
<input type="text" id="Edit36" name="Edit36" value="<?=$Edit36;?>" style=" font-family: Verdana; font-size: 14px;  height:26px;width:409px;"  onchange="Salva36s(this)"  onFocus="nextfield ='Edit37';" style="text-transform: uppercase;" tabindex="36"  maxlength="45"   />
</div>
...
<input type="text" id="Edit37" name="Edit37" value="<?=$Edit37;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:409px;"  onchange="Salva37s(this)"  onFocus="nextfield ='Edit38';" style="text-transform: uppercase;" tabindex="37"  maxlength="45"   />
</div>
...
<input type="text" id="Edit38" name="Edit38" value="<?=$Edit38;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;"  onchange="Salva38s(this)"  onFocus="nextfield ='Edit39';" style="text-transform: uppercase;" tabindex="38"  maxlength="35"   />
</div>
...
<input type="text" id="Edit39" name="Edit39" value="<?=$Edit39;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;"  onkeypress="return txtBoxFormat(document.form1, 'Edit4', '99/99/9999', event);" onchange="Salva39s(this)"  onFocus="nextfield ='Edit40';" style="text-transform: uppercase;" tabindex="39"  maxlength="10"   />
</div>
...
<input type="text" id="Edit40" name="Edit40" value="<?=$Edit40;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;"  onchange="Salva40s(this)"  onFocus="nextfield ='Edit41';" style="text-transform: uppercase;" tabindex="40"  maxlength="35"   />
</div>
...
<input type="text" id="Edit41" name="Edit41" value="<?=$Edit41;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;" onkeypress="return txtBoxFormat(document.form1, 'Edit41', '99/99/9999', event);"   onchange="Salva41s(this)"  onFocus="nextfield ='Edit42';" style="text-transform: uppercase;" tabindex="41"  maxlength="10"   />
</div>
...
<select type="text" id="Edit42" name="Edit42" value="<?=$Edit42;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;" onchange="Salva42s(this)"  onFocus="nextfield ='Edit43';" style="text-transform: uppercase;" tabindex="42"  maxlength="1"   />
...
<input type="text" id="Edit43" name="Edit43" value="<?=$Edit43;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;"  onchange="Salva43s(this)"  onFocus="nextfield ='Edit44';" style="text-transform: uppercase;" tabindex="43"  maxlength="35"   />
</div>
...
<input type="text" id="Edit44" name="Edit44" value="<?=$Edit44;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;" onkeypress="return txtBoxFormat(document.form1, 'Edit44', '99/99/9999', event);"   onchange="Salva44s(this)"  onFocus="nextfield ='Edit45';" style="text-transform: uppercase;" tabindex="44"  maxlength="10"   />
</div>
...
<select type="text" id="Edit45" name="Edit45" value="<?=$Edit45;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;"  onchange="Salva45s(this)"  onFocus="nextfield ='Edit46';" style="text-transform: uppercase;" tabindex="45"  maxlength="1"   />
...
<textarea id="Edit70" name="Edit70" style=" font-family: Verdana; font-size: 14px;  height:77px;width:501px;"  onchange="Salva70s(this)"  onFocus="nextfield ='done';" style="text-transform: uppercase;" tabindex="70"    wrap="virtual"><?=$Edit70;?></textarea>
</div>
...
<div id="Image4_container" style=" width: 17;  height: 18; overflow: hidden;" ><A HREF="edifconsulta.php?Cod_pp=<?=$Edit1.$Edit2;?>"  ><img id="Image4" src="imagens/lupa.PNG"  width="17"  height="18"  border="0"       /></A></div>
</div>
...
<input type="text" id="Edit46" name="Edit46" value="<?=$Edit46;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;"  onchange="Salva46s(this)"  onFocus="nextfield ='Edit47';" style="text-transform: uppercase;" tabindex="46" maxlength="35"    />
</div>
<div id="Edit47_outer" style="Z-INDEX: 127; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 641px; HEIGHT: 26px">
<input type="text" id="Edit47" name="Edit47" value="<?=$Edit47;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;" onkeypress="return txtBoxFormat(document.form1, 'Edit47', '99/99/9999', event);"   onchange="Salva47s(this)"  onFocus="nextfield ='Edit48';" style="text-transform: uppercase;" tabindex="47"  maxlength="10"   />
</div>
<div id="Edit48_outer" style="Z-INDEX: 128; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 644px; HEIGHT: 26px">
<select type="text" id="Edit48" name="Edit48" value="<?=$Edit48;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;" onchange="Salva48s(this)"  onFocus="nextfield ='Edit49';" style="text-transform: uppercase;" tabindex="48"  maxlength="1"   />
...
<input type="text" id="Edit49" name="Edit49" value="<?=$Edit49;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;"  onchange="Salva49s(this)"  onFocus="nextfield ='Edit50';" style="text-transform: uppercase;" tabindex="49"  maxlength="35"   />
</div>
<div id="Edit50_outer" style="Z-INDEX: 130; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 666px; HEIGHT: 26px">
<input type="text" id="Edit50" name="Edit50" value="<?=$Edit50;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;" onkeypress="return txtBoxFormat(document.form1, 'Edit50', '99/99/9999', event);"   onchange="Salva50s(this)"  onFocus="nextfield ='Edit51';" style="text-transform: uppercase;" tabindex="50"  maxlength="10"   />
</div>
<div id="Edit51_outer" style="Z-INDEX: 131; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 669px; HEIGHT: 26px">
<select type="text" id="Edit51" name="Edit51" value="<?=$Edit51;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;"  onchange="Salva51s(this)"  onFocus="nextfield ='Edit52';" style="text-transform: uppercase;" tabindex="51" maxlength="1"    />
...
<input type="text" id="Edit52" name="Edit52" value="<?=$Edit52;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;"  onchange="Salva52s(this)"  onFocus="nextfield ='Edit53';" style="text-transform: uppercase;" tabindex="52"  maxlength="35"   />
</div>
<div id="Edit53_outer" style="Z-INDEX: 133; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 691px; HEIGHT: 26px">
<input type="text" id="Edit53" name="Edit53" value="<?=$Edit53;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;" onkeypress="return txtBoxFormat(document.form1, 'Edit53', '99/99/9999', event);"   onchange="Salva53s(this)"  onFocus="nextfield ='Edit54';" style="text-transform: uppercase;" tabindex="53"  maxlength="10"   />
</div>
<div id="Edit54_outer" style="Z-INDEX: 134; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 694px; HEIGHT: 26px">
<select type="text" id="Edit54" name="Edit54" value="<?=$Edit54;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;"  onchange="Salva54s(this)"  onFocus="nextfield ='Edit55';" style="text-transform: uppercase;" tabindex="54"  maxlength="1"   />
...
<input type="text" id="Edit55" name="Edit55" value="<?=$Edit55;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;"  onchange="Salva55s(this)"  onFocus="nextfield ='Edit56';" style="text-transform: uppercase;" tabindex="55"  maxlength="35"   />
</div>
<div id="Edit56_outer" style="Z-INDEX: 136; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 716px; HEIGHT: 26px">
<input type="text" id="Edit56" name="Edit56" value="<?=$Edit56;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;" onkeypress="return txtBoxFormat(document.form1, 'Edit56', '99/99/9999', event);"   onchange="Salva56s(this)"  onFocus="nextfield ='Edit57';" style="text-transform: uppercase;" tabindex="56"  maxlength="10"   />
</div>
<div id="Edit57_outer" style="Z-INDEX: 137; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 719px; HEIGHT: 26px">
<select type="text" id="Edit57" name="Edit57" value="<?=$Edit57;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;" onchange="Salva57s(this)"  onFocus="nextfield ='Edit58';" style="text-transform: uppercase;" tabindex="57"  maxlength="1"   />
...
<input type="text" id="Edit58" name="Edit58" value="<?=$Edit58;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;" onchange="Salva58s(this)"  onFocus="nextfield ='Edit59';" style="text-transform: uppercase;" tabindex="58"  maxlength="35"   />
</div>
<div id="Edit59_outer" style="Z-INDEX: 139; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 741px; HEIGHT: 26px">
<input type="text" id="Edit59" name="Edit59" value="<?=$Edit59;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;" onkeypress="return txtBoxFormat(document.form1, 'Edit59', '99/99/9999', event);"   onchange="Salva59s(this)"  onFocus="nextfield ='Edit60';" style="text-transform: uppercase;" tabindex="59"  maxlength="10"   />
</div>
<div id="Edit60_outer" style="Z-INDEX: 140; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 744px; HEIGHT: 26px">
<select type="text" id="Edit60" name="Edit60" value="<?=$Edit60;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;" onchange="Salva60s(this)"  onFocus="nextfield ='Edit61';" style="text-transform: uppercase;" tabindex="60"  maxlength="1"   />
...
<input type="text" id="Edit61" name="Edit61" value="<?=$Edit61;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;" onchange="Salva61s(this)"  onFocus="nextfield ='Edit62';" style="text-transform: uppercase;" tabindex="61"  maxlength="35"   />
</div>
<div id="Edit62_outer" style="Z-INDEX: 142; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 766px; HEIGHT: 26px">
<input type="text" id="Edit62" name="Edit62" value="<?=$Edit62;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;"  onkeypress="return txtBoxFormat(document.form1, 'Edit62', '99/99/9999', event);"   onchange="Salva62s(this)"  onFocus="nextfield ='Edit63';" style="text-transform: uppercase;" tabindex="62"  maxlength="10"   />
</div>
<div id="Edit63_outer" style="Z-INDEX: 143; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 769px; HEIGHT: 26px">
<select type="text" id="Edit63" name="Edit63" value="<?=$Edit63;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;" onchange="Salva63s(this)"  onFocus="nextfield ='Edit64';" style="text-transform: uppercase;" tabindex="63"  maxlength="1"   />
...
<input type="text" id="Edit64" name="Edit64" value="<?=$Edit64;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;" onchange="Salva64s(this)"  onFocus="nextfield ='Edit65';" style="text-transform: uppercase;" tabindex="64"  maxlength="35"   />
</div>
<div id="Edit65_outer" style="Z-INDEX: 145; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 791px; HEIGHT: 26px">
<input type="text" id="Edit65" name="Edit65" value="<?=$Edit65;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;" onkeypress="return txtBoxFormat(document.form1, 'Edit65', '99/99/9999', event);"    onchange="Salva65s(this)"  onFocus="nextfield ='Edit66';" style="text-transform: uppercase;" tabindex="65"  maxlength="10"   />
</div>
<div id="Edit66_outer" style="Z-INDEX: 146; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 794px; HEIGHT: 26px">
<select type="text" id="Edit66" name="Edit66" value="<?=$Edit66;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;" onchange="Salva66s(this)"  onFocus="nextfield ='Edit61';" style="text-transform: uppercase;" tabindex="66"  maxlength="1"   />
...
<input type="text" id="Edit67" name="Edit67" value="<?=$Edit67;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:329px;" onchange="Salva67s(this)"  onFocus="nextfield ='Edit68';" style="text-transform: uppercase;" tabindex="67"  maxlength="35"   />
</div>
<div id="Edit68_outer" style="Z-INDEX: 148; LEFT: 633px; WIDTH: 91px; POSITION: absolute; TOP: 816px; HEIGHT: 26px">
<input type="text" id="Edit68" name="Edit68" value="<?=$Edit68;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:91px;" onkeypress="return txtBoxFormat(document.form1, 'Edit68', '99/99/9999', event);"   onchange="Salva68s(this)"  onFocus="nextfield ='Edit69';" style="text-transform: uppercase;" tabindex="68"  maxlength="10"   />
</div>
<div id="Edit69_outer" style="Z-INDEX: 149; LEFT: 815px; WIDTH: 41px; POSITION: absolute; TOP: 819px; HEIGHT: 26px">
<select type="text" id="Edit69" name="Edit69" value="<?=$Edit69;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:41px;" onchange="Salva69s(this)"  onFocus="nextfield ='Edit70';" style="text-transform: uppercase;" tabindex="69"  maxlength="1"   />

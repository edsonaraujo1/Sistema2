...
/*
 --------------------------------
 Ferifica se o arquivo de foto 
 existe no Banco imagens
 --------------------------------
 */
 
//include("pg_soc.php");

if (file_exists($cami2))
{
	// OK 
}
else
{
   //$cami2 = 'http://192.168.1.100/mysql/imagens/fotos/Branco.bmp'; 	
}
...
<layer id="fixacam"> 
	...
	<a rel="home" class="home" href="socdelete.php?Cod_2=<?=$Edit1;?><?=$Edit2;?>">
...
<div id="Menssage" style=" font-family: Verdana; font-size: 14px;  height:24px;width:208px;"  align="Center"   ><strong><font color="#FF0000"><?=$menssagens;?></font> </strong></div>
</div>

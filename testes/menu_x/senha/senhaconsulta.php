...
/*
 ...
 Finalidade.........: Consultar Cadastro Senha
...
<form name="form1" type='hidden' method='POST' action='senhapesquisa.php'>
...
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>;font-weight: bold;text-align: left; height:32px;width:320px;"   > Consultar Permissão </div>
</div>

...
/*
 ...
 Finalidade.........: Layout Cadastro Senha Premissão
...
<textarea id="Memo1" name="Memo1" style=" font-family: Verdana; font-size: 14px;  height:145px;width:600px; color: #696969; background-color: #FFFFFF;"  readonly   tabindex="0"    wrap="virtual"><?=$programas;?></textarea>
</div>

<div id="Edit5_outer" style="Z-INDEX: 26; LEFT: 254px; WIDTH: 165px; POSITION: absolute; TOP: 190px; HEIGHT: 26px">
<input type="text" id="Edit5" name="Edit5" value="<?=$permissao;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:165px; background-color: #FFFFFF;" disabled  tabindex="5"    />
</div>
<div id="Edit4_outer" style="Z-INDEX: 27; LEFT: 254px; WIDTH: 303px; POSITION: absolute; TOP: 165px; HEIGHT: 26px">
<input type="text" id="Edit4" name="Edit4" value="<?=$nome;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:303px; background-color: #FFFFFF;"  disabled tabindex="3"    />
</div>
...
<input type="text" id="Edit89" name="Edit89" value="<?=$maquina;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:203px; background-color: #FFFFFF;" disabled tabindex="6"    />
</div>


<div id="Edit1_outer" style="Z-INDEX: 28; LEFT: 254px; WIDTH: 165px; POSITION: absolute; TOP: 140px; HEIGHT: 26px">
<input type="text" id="Edit1" name="Edit1" value="<?=$login;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:165px; background-color: #FFFFFF;" disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit2" name="Edit2" value="<?=$senha;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:137px; background-color: #FFFFFF;" disabled tabindex="1"    />
</div>
...
<input type="text" id="Edit3" name="Edit3" value="<?=$data;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:93px; background-color: #FFFFFF;"  disabled   tabindex="2"    />
</div>

<div id="Edit6_outer" style="Z-INDEX: 33; LEFT: 501px; WIDTH: 55px; POSITION: absolute; TOP: 190px; HEIGHT: 26px">
<input type="text" id="Edit6" name="Edit6" value="<?=$permis2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:55px; background-color: #FFFFFF;" disabled tabindex="6"    />
</div>
...
<input type="text" id="Edit88" name="Edit6" value="<?=$acesso;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:203px; background-color: #FFFFFF;" disabled tabindex="6"    />
</div>
...
<input type="text" id="Edit7" name="Edit7" value="<?=$hora1;?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:74px;" disabled   tabindex="0"    />
</div>
<div id="Edit8_outer" style="Z-INDEX: 11; LEFT: 362px; WIDTH: 74px; POSITION: absolute; TOP: 386px; HEIGHT: 26px">
<input type="text" id="Edit8" name="Edit8" value="<?=$hora2;?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:74px;" disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit37" name="Edit37" value="<?=$semana;?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:320px;" disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit11" name="Edit11" value="<?=$email;?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:417px;" disabled   tabindex="0"    />
</div>
...
<input type="text" id="Edit12" name="Edit12" value="<?=$tipo;?>" style=" font-family: Verdana; font-size: 14px;  background-color: #FFFFFF;height:25px;width:128px;" disabled   tabindex="0"    />
</div>
</td></tr></table>
</body>

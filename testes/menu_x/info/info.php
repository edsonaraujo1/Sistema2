...
if (bName == "Microsoft Internet Explorer" & bVer >= 4.00){
    ...
    document.write("<center><img id='Image1' src='../imagens/Internet_7.png'  width='80'  height='80'  border='0'/></center><br>");
    document.write("<center>* * - Colaboradores - * *</center><br>");
    document.write("<center>Edson de Araujo</center>");
    document.write("<center>Jean Carlos de Araujo</center>");
    document.write("<center>Valdecir Araujo</center>");
    document.write("<center>Jorge Luciano</center><br>");
    document.write("<center>''Mas a DEUS tudo</center>");
    document.write("<center> e Possível !!!''</center>");
    ...
    document.write("<center><img id='Image1' src='../imagens/Firefox.png'  width='80'  height='80'  border='0'/></center><br>");
    document.write("<center>* * - Colaboradores - * *</center><br>");
    document.write("<center>Edson de Araujo</center>");
    document.write("<center>Jean Carlos de Araujo</center>");
    document.write("<center>Valdecir Araujo</center>");
...
<div id="Label4_outer" style="Z-INDEX: 13; LEFT: 222px; WIDTH: 426px; POSITION: absolute; TOP: 260px; HEIGHT: 19px">
<div id="Label4" style=" font-family: Verdana; font-size: 16px;  height:19px;width:426px;" align=center><FONT face=Arial><STRONG>&nbsp;&nbsp;Versao&nbsp;&nbsp;<?=$versao_1;?></STRONG> </FONT> </div>
</div>

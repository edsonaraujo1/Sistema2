...
if ($Opcao == "CODIGO"){
   ...
   $sql  = "SELECT * FROM aposentados WHERE CODIGO >= '$Procura' ORDER BY CODIGO ASC";
	
}
if ($Opcao == "NOME"){

   $sql  = "SELECT * FROM aposentados WHERE NOME >= '$Procura' ORDER BY NOME ASC";
	
}
if ($Opcao == "C.P.F."){

   $sql  = "SELECT * FROM aposentados WHERE CPF >= '$Procura' ORDER BY CPF ASC";
     ...
     <td><input type=image name='Voltar' src='../imagens/botao_voltar.PNG'></td>
      ...
      echo "
       ...
       while ($linha = mysql_fetch_array($resultado))
       {
		...
		$coluna2  = substr(trim($linha["NOME"]),0,25);
		$coluna3  = $linha["ENDER"];
        ...
        if ($faz == 1){
           ?>
  	       ...
  	       <td valign=top><b>CODIGO</b><th><b>NOME</b><th><b>ENDERECO</b><th><b>FONE</b></td>

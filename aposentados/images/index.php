...
$consulta = "SELECT * FROM tb_terceira WHERE codp = '$mat'";
...
$consulta2 = "DELETE FROM tb_terceira WHERE id_imagem = '$id_imagem'";
...
$sql = @mysql_query("INSERT INTO tb_terceira(codp,cod_foto,imagem,tipo_imagem,bytes_imagem,dados_imagem)

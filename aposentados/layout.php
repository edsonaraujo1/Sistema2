...
$new_fot = $_SESSION['codp'];
   ...
   ?>	
	 ...
	 <div id="Image1_container" style=" width: 96;  height: 112; overflow: hidden;" ><A href="cadastro.php?cod_5=<?=$Edit1;?>"><img id="Image1" src="ver.php?new_fot=<?=$Edit1;?>"  width="96"  height="112"  border="0"       /></a></div>
	 </div>
...
?>	
	 ...
	 <div id="Image1_outer" style="Z-INDEX: 45; LEFT: 704px; WIDTH: 96px; POSITION: absolute; TOP: 144px; HEIGHT: 112px">
	 <div id="Image1_container" style=" width: 96;  height: 112; overflow: hidden;" ><A href="cadastro.php?cod_5=<?=$Edit1;?>"><img id="Image1" src="<?=$cami2;?>"  width="96"  height="112"  border="0"       /></a></div>
	 </div>

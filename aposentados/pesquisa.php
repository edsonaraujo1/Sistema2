...
if ($Opcao == "CODIGO"){
    ...
    $consulta  = "SELECT * FROM aposentados WHERE CODIGO = '$Procura' ORDER BY CODIGO";
}
if ($Opcao == "NOME"){

    $consulta  = "SELECT * FROM aposentados WHERE NOME like '$Procura%' ORDER BY NOME";
}
if ($Opcao == "C.P.F"){

    $consulta  = "SELECT * FROM aposentados WHERE CPF like '$Procura%' ORDER BY CPF";
}

...
$consultax  = "SELECT * FROM $nome3 LIMIT 0,50";
...
$consulta  = "SELECT * FROM aposentados ORDER BY CODIGO DESC LIMIT 0,1";
...
$add3 = "UPDATE $nome3         SET Edit1    = '$novo_1' WHERE Nome1 = '$nome3'";

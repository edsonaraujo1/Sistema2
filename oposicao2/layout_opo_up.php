...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:93px; background-color: #FFFFFF;" onchange="Salva2(this.value)" onFocus="nextfield ='Edit3';" style="text-transform: uppercase;"  tabindex="2"    />
</div>
...
<input type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:254px; background-color: #FFFFFF;" onchange="Salva5(this.value)" onFocus="nextfield ='Edit6';" style="text-transform: uppercase;"  tabindex="5"    />
</div>

...
<form style="margin-bottom: 0" id="Form1" name="Form1" method="post"  action="oposicaolayout.php">
...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:93px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit2', '99/99/9999', event);" onchange="Salva2(this.value)" onFocus="nextfield ='Edit4';" style="text-transform: uppercase;"  tabindex="2"    />
</div>
...
<input type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:254px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit5', '999.999.999-99', event);" onchange="Salva5(this.value)" onFocus="nextfield ='Edit6';" style="text-transform: uppercase;"  tabindex="5"    />
</div>
...
<input type="text" id="Edit6" name="Edit6" value="<?=$Edit6;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:98px; background-color: #FFFFFF;" onchange="Salva6(this.value)" onFocus="nextfield ='Edit7';" style="text-transform: uppercase;"  tabindex="6"    />
</div>
<div id="Edit7_outer" style="Z-INDEX: 15; LEFT: 568px; WIDTH: 254px; POSITION: absolute; TOP: 192px; HEIGHT: 26px">
<select type="text" id="Edit7" name="Edit7" value="<?=$Edit7;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:254px; background-color: #FFFFFF;" onchange="Salva7(this.value)" onFocus="nextfield ='Edit8';"  tabindex="7"    />
...
<input type="text" id="Edit8" name="Edit8" value="<?=$Edit8;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:434px; background-color: #FFFFFF;" onchange="Salva8(this.value)" onFocus="nextfield ='Edit9';"  tabindex="8"    />
</div>

<div id="Edit9_outer" style="Z-INDEX: 50; LEFT: 278px; WIDTH: 354px; POSITION: absolute; TOP: 240px; HEIGHT: 26px">
<input type="text" id="Edit9" name="Edit9" value="<?=$Edit9;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:354px; background-color: #FFFFFF;" onchange="Salva9(this.value)" onFocus="nextfield ='Edit10';"  tabindex="9"    />
</div>
...
<input type="text" id="Edit10" name="Edit10" value="<?=$Edit10;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:90px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit10', '99999-999', event);" onchange="Salva10(this.value)" onFocus="nextfield ='Edit11';"  tabindex="10"    />
</div>
...
<input type="text" id="Edit11" name="Edit11" value="<?=$Edit11;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:74px; background-color: #FFFFFF;" onchange="Salva11(this.value)" onFocus="nextfield ='Edit12';"  tabindex="11"    />
</div>
...
<input type="text" id="Edit12" name="Edit12" value="<?=$Edit12;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit12', '99.999.999/9999-99', event);" onchange="Salva12(this.value)" onFocus="nextfield ='Edit13';"  tabindex="12"    />
</div>
...
<textarea id="Edit15" name="Edit15" style=" font-family: Verdana; font-size: 14px;  height:106px;width:544px;color: #696969; background-color: #FFFFFF;" onchange="Salva15(this.value)" onFocus="nextfield ='Edit16';" tabindex="15" wrap="virtual"><?=$Edit15;?></textarea>
</div>
<div id="Edit14_outer" style="Z-INDEX: 29; LEFT: 278px; WIDTH: 194px; POSITION: absolute; TOP: 340px; HEIGHT: 26px">
<input type="text" id="Edit14" name="Edit14" value="<?=$Edit14;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:194px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit14', '99.999.999/9999-99', event);" onchange="Salva14(this.value)" onFocus="nextfield ='Edit15';"  tabindex="14"    />
</div>
...
<input type="text" id="Edit13" name="Edit13" value="<?=$Edit13;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:74px; background-color: #FFFFFF;" onchange="Salva13(this.value)" onFocus="nextfield ='Edit14';"  tabindex="13"    />
</div>

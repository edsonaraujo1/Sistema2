...
if (!empty($id)){
    ...
    $add4 = "UPDATE $nome3 SET Edit6    = '$new_fot',
                               Edit4    = '$Edit4',
                               Edit5    = '$cpf_soc',
                               Edit7    = '$cate_soc',
                               Edit11   = '$edif_soc',
                               Edit8    = '$nome_soc',
							   Edit9    = '$end_soc',
							   Edit10   = '$cep_soc' WHERE Nome1 = '$nome3'";
...
if (!empty($id)){
    ...
    $add5 = "UPDATE $nome3 SET Edit6    = '$new_fot',
                               Edit4    = '$rg_soc,
                               Edit5    = '$Edit5',
                               Edit7    = '$cate_soc',
                               Edit11   = '$edif_soc',
    ...
    $Edit5 = retirar_carac($_GET["Edit5"]);
    $add5 = "UPDATE $nome3 SET Edit5    = '$Edit5',
	                           mensage1 = '$menssagem1' WHERE Nome1 = '$nome3'";
...
if (!empty($_GET["Edit6"]))   {
	...
	if (!empty($id_soc)){
	     ...
	     $add6 = "UPDATE $nome3 SET Edit6    = '$Edit6',
	                                Edit4    = '$rg_soc',
	                                Edit5    = '$cpf_soc',
	                                Edit7    = '$cate_soc',
	                                Edit11   = '$edif_soc',
...
$cod_edif   = @$row10["COD"];
$cond  = trim(@$row10["COND"].@$row10["NOME"]);
$Cnpj_Edif  = @$row10["CGC"];
...
if (!empty($cod_edif)){
    ...
    $add11 = "UPDATE $nome3 SET Edit11    = '$Edit11',
                                Edit12    = '$Cnpj_Edif', 
	                            mensage2  = '$cond' WHERE Nome1 = '$nome3'";
...
$cod_edif   = @$row12["COD"];
$cond  = trim(@$row12["COND"].@$row12["NOME"]);
$Cnpj_Edif  = @$row12["CGC"];
...
if (!empty($cod_edif)){
    ...
    $add12 = "UPDATE $nome3 SET Edit12    = '$Edit12',
                                Edit11    = '$cod_edif',
	                            mensage2  = '$cond' WHERE Nome1 = '$nome3'";
    ...
    $Edit12 = retirar_carac($_GET["Edit12"]);
    $add11 = "UPDATE $nome3 SET Edit12    = '$Edit12' WHERE Nome1 = '$nome3'";
...
if (!empty($_GET["Edit13"]))   {
    ...
    $Cod_adms   = @$row13["cod"];
    $Nome_adms  = @$row13["nomeadm"];
    $Cnpj_Adms  = @$row13["cgc"];

if (!empty($Cod_adms)){
	
    $Edit13 = retirar_carac($_GET["Edit13"]);
    $add13 = "UPDATE $nome3 SET Edit13    = '$Edit13',
                                Edit14    = '$Cnpj_Adms',
	                            mensage3  = '$Nome_adms' WHERE Nome1 = '$nome3'";
...
if (!empty($_GET["Edit14"]))   {
    ...
    $Cod_adms   = @$row14["cod"];
    $Nome_adms  = @$row14["nomeadm"];
    $Cnpj_Adms  = @$row14["cgc"];

if (!empty($Cod_adms)){
	
    $Edit14 = retirar_carac($_GET["Edit14"]);
    $add14 = "UPDATE $nome3 SET Edit13    = '$Cod_adms',
                                Edit14    = '$Cnpj_Adms',
	                            mensage3  = '$Nome_adms' WHERE Nome1 = '$nome3'";
...
if (!empty($_GET["Edit15"]))   {
    ...
    $add15 = "UPDATE $nome3 SET memo1    = '$Edit15' WHERE Nome1 = '$nome3'";
    @mysql_query($add15, $link);

}

require("layout_opo_up.php");

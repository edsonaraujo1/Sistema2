...
<input type="text" id="Edit10" name="Edit10" value="<?=$Edit10;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:90px; background-color: #FFFFFF;" onchange="Salva10(this.value)" onFocus="nextfield ='Edit11';"  tabindex="10"    />
</div>
...
<input type="text" id="Edit12" name="Edit12" value="<?=$Edit12;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px; background-color: #FFFFFF;" onchange="Salva12(this.value)" onFocus="nextfield ='Edit13';"  tabindex="12"    />
</div>
...
<input type="text" id="Edit14" name="Edit14" value="<?=$Edit14;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:194px; background-color: #FFFFFF;" onchange="Salva14(this.value)" onFocus="nextfield ='Edit15';"  tabindex="14"    />
</div>

...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:23px;width:446px; background-color: #FFFFFF;" onkeypress="return txtBoxFormat(document.Form1, 'Edit2', '99/99/9999', event);"  maxlength='18'  tabindex="0"    />
</div>
...
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>;font-weight: bold;text-align: left; height:32px;width:320px;"   >Receb. Diversos</div>
</div>

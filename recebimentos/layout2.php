...
<div id="Label9" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:123px;"   ><STRONG>Observação.:</STRONG></div>
</div>
<div id="Edit7_outer" style="Z-INDEX: 20; LEFT: 305px; WIDTH: 495px; POSITION: absolute; TOP: 320px; HEIGHT: 64px">
<textarea  id="Edit8" name="Edit8"  style=" font-family: Verdana; font-size: 14px;  height:63px;width:495px;" onfocus="this.className='anormal'; nextfield ='done';" onblur="this.className='normal'"  onchange="Salva8(this.value)"   tabindex="0"    /><?=$Edit8;?></textarea>
</div>
</td></tr></table>
</form></body>
</html>

...
if (strlen($cod_1) > 0){
   ...
   $consulta  = "SELECT * FROM recebimentos WHERE id = '$cod_1'";

}else{

   $consulta  = "SELECT * FROM recebimentos ORDER BY id ASC LIMIT 0,50";
	
}
if (!empty($Cod_xx)){
	
   $consulta  = "SELECT * FROM recebimentos WHERE id = '$Cod_xx'";
	
}

if (!empty($cod_3)){
	
   $consulta  = "SELECT * FROM recebimentos WHERE id = '$cod_3'";
	
}

if (!empty($cod_5)){
	
   $consulta  = "SELECT * FROM recebimentos WHERE CODIGO = '$cod_5'";

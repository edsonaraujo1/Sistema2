...
<form style="margin-bottom: 0" id="Unit2" name="Unit2" method="post"  action="/recebimentos_layout.php">
<table  width="1000"   style="height:528px"  border="0" cellpadding="0" cellspacing="0"   align="Center" ><tr><td valign="top">
<div id="Shape1_outer" style="Z-INDEX: 0; LEFT: 141px; WIDTH: 724px; POSITION: absolute; TOP: 44px; HEIGHT: 470px">
<script type="text/javascript">
  var Shape1_Canvas = new jsGraphics("Shape1_outer");
  Shape1_Canvas.setColor("#FFFFFF");
  Shape1_Canvas.fillRect(16, 16, 692 - 16, 438 - 16);
  Shape1_Canvas.fillRect(16, 16, 692 - 16 + 1, 438 - 16 + 1);
  Shape1_Canvas.setStroke(16);
  Shape1_Canvas.setColor("<?=$color_bor;?>");
  Shape1_Canvas.drawRect(16, 16, 692 - 16 + 1, 438 - 16 + 1);
  Shape1_Canvas.paint();
</script>
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>; background-color: #FFFFFF;height:32px;width:361px;"   ><STRONG>Recebimentos Diversos</STRONG></div>
</div>
...
<div id="Shape3_outer" style="Z-INDEX: 4; LEFT: 174px; WIDTH: 658px; POSITION: absolute; TOP: 133px; HEIGHT: 347px">
<script type="text/javascript">
...
<div id="Label3" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:107px;"   ><STRONG>Valor.:</STRONG></div>
</div>
<div id="Edit1_outer" style="Z-INDEX: 8; LEFT: 305px; WIDTH: 127px; POSITION: absolute; TOP: 166px; HEIGHT: 26px">
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:127px;" disabled   tabindex="0"    />
</div>
<div id="Label4_outer" style="Z-INDEX: 9; LEFT: 189px; WIDTH: 107px; POSITION: absolute; TOP: 196px; HEIGHT: 26px">
<div id="Label4" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:107px;"   ><STRONG>Fornecedor.:</STRONG></div>
</div>
...
<div id="Label5" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:99px;"   ><STRONG>Produto.:</STRONG></div>
</div>
<div id="Edit3_outer" style="Z-INDEX: 12; LEFT: 305px; WIDTH: 495px; POSITION: absolute; TOP: 217px; HEIGHT: 26px">
<input type="text" id="Edit4" name="Edit4" value="<?=$Edit4;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:495px;" disabled   tabindex="0"    />
</div>
<div id="Label6_outer" style="Z-INDEX: 13; LEFT: 189px; WIDTH: 115px; POSITION: absolute; TOP: 247px; HEIGHT: 26px">
<div id="Label6" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:115px;"   ><STRONG>Tipo Pagto.:</STRONG></div>
</div>
<div id="Edit4_outer" style="Z-INDEX: 14; LEFT: 305px; WIDTH: 167px; POSITION: absolute; TOP: 243px; HEIGHT: 26px">
<input type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:167px;" disabled   tabindex="0"    />
</div>
<div id="Label7_outer" style="Z-INDEX: 15; LEFT: 189px; WIDTH: 115px; POSITION: absolute; TOP: 273px; HEIGHT: 26px">
<div id="Label7" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:115px;"   ><STRONG>Data Cheque.:</STRONG></div>
</div>
<div id="Edit5_outer" style="Z-INDEX: 16; LEFT: 305px; WIDTH: 127px; POSITION: absolute; TOP: 269px; HEIGHT: 26px">
<input type="text" id="Edit6" name="Edit6" value="<?=$Edit6;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:127px;" disabled   tabindex="0"    />
</div>
<div id="Label8_outer" style="Z-INDEX: 17; LEFT: 189px; WIDTH: 123px; POSITION: absolute; TOP: 299px; HEIGHT: 26px">
<div id="Label8" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:123px;"   ><STRONG>Data do Pagto.:</STRONG></div>
</div>
<div id="Edit6_outer" style="Z-INDEX: 18; LEFT: 305px; WIDTH: 127px; POSITION: absolute; TOP: 295px; HEIGHT: 26px">
<input type="text" id="Edit7" name="Edit7" value="<?=$Edit7;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:127px;" disabled   tabindex="0"    />
</div>
<div id="Label9_outer" style="Z-INDEX: 19; LEFT: 189px; WIDTH: 123px; POSITION: absolute; TOP: 324px; HEIGHT: 26px">
<div id="Label9" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:26px;width:123px;"   ><STRONG>Observacao.:</STRONG></div>
</div>
<div id="Edit7_outer" style="Z-INDEX: 20; LEFT: 305px; WIDTH: 495px; POSITION: absolute; TOP: 320px; HEIGHT: 64px">
<textarea type="text" id="Edit8" name="Edit8"  style=" font-family: Verdana; font-size: 14px;  height:63px;width:495px; color: #696969; background-color: #FFFFFF;"  readonly  tabindex="0"    /><?=$Edit8;?></textarea>
</div>
</td></tr></table>
</form></body>
</html>
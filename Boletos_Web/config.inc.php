 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://www.sindificios.com.br/phpmyadmin/';
...
$i++;
$cfg['Servers'][$i]['host']          = 'mysql.sindificios.com.br'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['password']      = 'dx2005yw';          // MySQL password (only needed

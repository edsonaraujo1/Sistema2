...
$dadosboleto["instrucoes3"] = "NÃO, SENDO O PISO SALARIAL ATUAL DE ZELADOR R$ 636,00, PORTEIRO R$ 609,50 ";
$dadosboleto["instrucoes4"] = "FAXINEIROS E OUTROS R$ 583,00.                                            ";

//formatando os dados
$codigobanco 		= "001";
$nummoeda 			= "9";
$fator_vencimento 	= fator_vencimento($dadosboleto["data_vencimento"]);
$loc_pagto          = 'Pagável em qualquer banco até o vencimento';
...
$div_xxx = modulo_11("$convenio$nossonumero");
...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr>    
		...
		<td class=cp valign=top width=472 height=12><?=$loc_pagto;?> </td>
		<td class=cp valign=top width=7 height=12><img height=15 src="imagens/1.gif" width=1 border=0></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr>
		...
		<td class=cp valign=top width=7 height=12><img height=12 src="imagens/1.gif" width=1 border=0></td>
		<td class=cp valign=top width=163 height=12><?=Trim(nudoc);?>/<?=Trim($_EDI2);?></td>
		<td class=cp valign=top width=7 height=12><img height=12 src="imagens/1.gif" width=1 border=0></td>

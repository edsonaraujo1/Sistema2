...
@mysql_select_db($db);
	...
	$consulta3  = "SELECT * FROM iedificios WHERE COD = '$inudoc'";
...
$consulta3 = "UPDATE aberto   SET QTD     = '$qtd_aber' WHERE confcod = '$nudoc' AND descricao = '$des_aberto' AND vencto = '$vencto' AND total = '$total_aber'";

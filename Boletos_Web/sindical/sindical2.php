...
$iCNPJ      = addslashes($_POST['CNPJ']);
$nudoc      = addslashes(trim($_POST['nudoc']));
$sacado     = addslashes(strtoupper($_POST['sacado']));
$CNPJ       = addslashes(trim($_POST['CNPJ']));
$dat_1gui   = $dat_insc = date("d/m/Y");
...
if(!empty($CNPJ)){
	...
	$consulta2  = "SELECT * FROM edificios WHERE CGC = '". anti_sql_injection($CNPJ) ."'";
    ...
    //echo "Primeira <br>CNPJ = ".$CNPJ."<br>";
    //echo "nudoc = ".$nudoc."<br>";
    //echo "nudocX = ".$nudocX."<br>";
    //echo "id  = ".$_EDI_id."<br>";
    //echo "fim primeira <br>";
    ...
    if (!empty($_EDI_id)){
		...
		$consulta3z = "UPDATE aberto   SET QTD     = '". anti_sql_injection($qtd_aber) ."', HORA = '". anti_sql_injection($hora_log) ."' WHERE confcod = '". anti_sql_injection($nudoc) ."' AND descricao = '". anti_sql_injection($tipo_w) ."' AND vencto = '". anti_sql_injection($vencto) ."'";
		
		@mysql_query($consulta3z, $link);
			
		}else{
		
		//echo 'entrei aqui 2<br><br>';
		
        //echo "nudoc =".$nudoc."<br>";
		//echo "dat_1gui =".$dat_1gui."<br>";
		//echo "tipo_w =".$tipo_w."<br>";
		//echo "pag_aber =".$pag_aber."<br>";
		//echo "vencto =".$vencto."<br>";
		//echo "Edit10 =".$Edit10."<br>";
		//echo "Edit11 =".$Edit11."<br>";
		//echo "Edit12 =".$Edit12."<br>";
		//echo "Edit13 =".$Edit13."<br>";
		//echo "total_aber =".$total_aber."<br>";
		//echo "Edit12 =".$Edit12."<br>";
		//echo "Edit12 =".$Edit12."<br>";
		//echo "Edit12 =".$Edit12."<br>";		
	...
	$consulta3  = "SELECT * FROM edificios WHERE COD = '". anti_sql_injection($inudoc) ."'";
...
<html>
<head>
<title>Sindificios - GRCSU - Sindical</title>
...
<td colspan=0 class=ct valign=top width=400 height=7><font face=verdana size=1><b>GRCSU - Guia de Recolhimento da Contribuição Sindical Urbana</b></font><font color=#FFFFFF></font></td>

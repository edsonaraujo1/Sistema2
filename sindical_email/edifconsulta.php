...
<select id="Edit1_ed" name="Edit1_ed" value="<?=$Edit1_ed;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:176px;"  onchange="Salva_Etq_edif1(this)"  tabindex="0"    />

...
die("<br><div align=center>
     ...
     <table align=center>
     <form method='POST' action='mostra_grid.php?var_w1=$Edit1'>
     ...
     echo "<br><div align=center>
	       ...
	       <tr>
	       <td>
	       <font face=arial><b>*** Permissão Incluido com Sucesso !!! ***</b>
	       <table align=center>
	       <form method='POST' action='mostra_grid.php?var_w1=$Edit1'>
	       <td><input type=image name='consulta' src='../imagens/botao_voltar.PNG'></td>
	       </form> 
...
die("<br><div align=center>
     ...
     echo "<br><div align=center>
	       ...
	       <tr>
	       <td>
	       <font face=arial><b>*** Permissão Alterada com Sucesso !!! ***</b>
	       <table align=center>
	       <form method='POST' action='mostra_grid.php?var_w1=$Edit1'>
	       <td><input type=image name='consulta' src='../imagens/botao_voltar.PNG'></td>
	       </form> 
...
die("<br><div align=center>
     ...
     echo "<br><div align=center>
	       ...
	       <tr>
	       <td>
	       <font face=arial><b>*** Permissão Excluida com Sucesso !!! ***</b>
	       <table align=center>
	       <form method='POST' action='mostra_grid.php?var_w1=$Edit1'>
	       <td><input type=image name='consulta' src='../imagens/botao_voltar.PNG'></td>
	       </form> 

...
?>	
	...
	<div id="bubble_tooltip" style="Z-INDEX: 50000;">
		...
		<div class="wrap" style="Z-INDEX: 5000;">
		            <a href="javascript:janela_help_sys('../info/help_sys.php?nome_hel=<?=$nome3;?>')" onmouseover="showToolTip(event,'<?=$tes_x1;?>');return false" onmouseout="hideToolTip()"><img id="topo" src="../imagens/qmark.gif" /></a>
		</div>            

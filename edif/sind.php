...
$volta_1 = $_SESSION['volta_sind'];

if (empty($Cod_Edif)){
   $Cod_Edif = addslashes($_SESSION['lista_soc']);
}else{
   $volta_1  = addslashes($Cod_Edif);	
}
...
<div align=center>
	...
	if (empty($agencia)){
	   ...
	   <th>           <b>AGENCIA</b>
        ...
        <tr> 
	    <td valign=top align='center'><b>$cod</b><td>$vencto<td align='center'>$dat_pag<td align='right'>$total<td align='center'>$local<td align='center'>$agencia<td>";
	    
if ($mens2 == "SIM"){
	    
	    echo "
	    <A HREF='excluir_sind.php?Cod_2=$id_sind'><img id='Image3' src='../imagens/excluir.gif' border='0'></A>";
	    
}
if ($mens3 == "SIM"){
	    
	    echo "
	    <td><A HREF='alterar_sind.php?Cod_2=$id_sind'><img id='Image3' src='../imagens/editar.gif' border='0'></A>
	    </td>";

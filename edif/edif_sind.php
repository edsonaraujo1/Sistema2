...
<form name="form1" type="hidden" method="POST" action="novo.php?ti_wy=02" target="new">
<br>
...
<div id="Label1" style=" font-family: Verdana; font-size: 14px; color: <?=$color_bor;?>; background-color: #FFFFFF;height:22px;width:633px;"  align="Center"   ><STRONG>IMPRESSÃO DE GUIAS GRCSU - SINDICAL</STRONG>&nbsp;</div>
</div>
...
<input type="text" id="valor" name="valor" value="" onfocus="this.className='anormal'" onblur="this.className='normal'" style=" font-family: Verdana; font-size: 14px;  height:25px;width:111px;"     tabindex="0"    />
</div>
...
<input type="text" id="vencto" name="vencto" onkeypress="return txtBoxFormat(document.form1, 'vencto', '99/99/9999', event);" value="" onfocus="this.className='anormal'" onblur="this.className='normal'" style=" font-family: Verdana; font-size: 14px;  height:25px;width:111px;"     tabindex="0"    />
</div>
...
<input type="text" id="nudoc" name="nudoc" value="<?=$cod;?>" onfocus="this.className='anormal'" onblur="this.className='normal'" style=" font-family: Verdana; font-size: 14px;  height:25px;width:88px;" disabled   tabindex="0"    />

<input type="hidden" id="nudoc" name="nudoc" value="<?=$cod;?>"/>

</div>
<div id="Label5_outer" style="Z-INDEX: 10; LEFT: 181px; WIDTH: 190px; POSITION: absolute; TOP: 203px; HEIGHT: 19px">
<div id="Label5" style=" font-family: Verdana; font-size: 14px; color: #000000;font-weight: normal; height:19px;width:190px;"   ><STRONG>Nome/Razão Social.:</STRONG></div>
</div>
...
<input type="text" id="cep" name="cep" value="<?=$cep;?>" onfocus="this.className='anormal'" onblur="this.className='normal'" style=" font-family: Verdana; font-size: 14px;  height:25px;width:123px;"     tabindex="0"    />
</div>
...
<input type="text" id="exec" name="exec" value="" onfocus="this.className='anormal'" onblur="this.className='normal'" style=" font-family: Verdana; font-size: 14px;  height:25px;width:88px;"     tabindex="0"    />
</div>

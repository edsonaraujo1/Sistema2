...
$consulta  = "SELECT * FROM ABERTO WHERE CONFCOD = '". anti_sql_injection($Cod_Edif) ."' ORDER BY str_to_date( VENCTO, '%d/%m/%Y')";
...
<div align=center>
	...
	$consulta0  = "SELECT * FROM conf WHERE CONFCOD = '". anti_sql_injection($Cod_Edif) ."' AND VENCTO = '". anti_sql_injection($vencto) ."'";
	...
	if ($cod_conf != 0){
    	...
    	$consulta9 = "UPDATE aberto SET PAGTO 	  = '$bai_conf',
                                        DAT_BAI	  = '$bai_conf',
			  						    TOTAL     = '$val_conf',
									    LOCAL     = '$age_conf' WHERE CONFCOD = '". anti_sql_injection($cod_conf) ."' AND VENCTO = '". anti_sql_injection($vencto) ."'";

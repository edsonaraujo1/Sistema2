...
<input type="text" id="cep" name="cep" value="<?=$cep;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:123px;" onkeypress="return txtBoxFormat(document.form1, 'cep', '99999-999', event);"  tabindex="0"    />
</div>

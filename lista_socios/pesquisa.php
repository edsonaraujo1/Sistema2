...
if ($Opcao == "CNPJ"){
    ...
    $consulta  = "SELECT * FROM lis_fun_sind WHERE cnpj = '$Procura' ORDER BY cnpj";
}
if ($Opcao == "CODIGO"){

    $consulta  = "SELECT * FROM lis_fun_sind WHERE codigo = '$Procura' ORDER BY codigo";
}
...
$adm3       = @$row3["adm3"];
			...
			$data_log = date("d/m/Y");
			$hora_log = date("H:i:s"); 
			$even_log = "CONSULTA/LISTA_FUNC_SIND".$Edit1;

...
$titulo_tabela = "2ª Tela de 'Funcionarios' - ".$cnpj." - Alterar";
...
<input type="text" name="nome" value="<?=$nome;?>"  style=" font-family: Verdana; font-size: 14px;  height:25px;width:300px;" onfocus="this.className='anormal'; nextfield ='salario';" onblur="this.className='normal'"></b>
<td align='right'>    <font style=' font-family: Verdana; font-size: 12px;'>
<input type="text" name="salario" value="<?=$salario;?>"  style=" font-family: Verdana; font-size: 14px;  height:25px;width:100px;" onfocus="this.className='anormal'; nextfield ='desconto';" onblur="this.className='normal'"></b>
<td align='right'>    <font style=' font-family: Verdana; font-size: 12px;'>
<input type="text" name="desconto" value="<?=$desconto;?>"  style=" font-family: Verdana; font-size: 14px;  height:25px;width:100px;" onfocus="this.className='anormal'; nextfield ='done';" onblur="this.className='normal'"></b>

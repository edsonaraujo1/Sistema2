...
$deixar = acesso_url("REL_BAIX_MENS");
...
<div id="Label1_outer" style="Z-INDEX: 5; LEFT: 274px; WIDTH: 460px; POSITION: absolute; TOP: 87px; HEIGHT: 32px">
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?php echo $color_bor ?>; background-color: #FFFFFF;height:32px;width:460px;"   ><STRONG>Rel. Baixa Mensalidades</STRONG></div>
</div>
<div id="Edit1_outer" style="Z-INDEX: 6; LEFT: 440px; WIDTH: 128px; POSITION: absolute; TOP: 143px; HEIGHT: 27px">
<input type="text" id="Edit1" name="Edit1" value="<?php echo $Edit1 ?>" onkeypress="return txtBoxFormat(document.form1, 'Edit1', '99/99/9999', event);" style=" font-family: Verdana; font-size: 14px;  height:26px;width:128px;"    tabindex="0"    />
</div>
<div id="Edit2_outer" style="Z-INDEX: 7; LEFT: 440px; WIDTH: 128px; POSITION: absolute; TOP: 169px; HEIGHT: 27px">
<input type="text" id="Edit2" name="Edit2" value="<?php echo $Edit2 ?>" onkeypress="return txtBoxFormat(document.form1, 'Edit2', '99/99/9999', event);" style=" font-family: Verdana; font-size: 14px;  height:26px;width:128px;"    tabindex="0"    />
</div>

</td></tr></table>
</body>

<div style="Z-INDEX: 34; LEFT: 400px; WIDTH: 544px; POSITION: absolute; TOP: 215px; HEIGHT: 80px">
<table border='0'>
         <td> </td>

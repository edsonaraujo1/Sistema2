...
$consulta  = "SELECT * FROM oposicao3 ORDER BY NOMEASSOC";
		     ...
		     if ($faz == 1){
		        ...
		        $faz = 0;
					  ...
					  if ($negrita==1){
						 ...
						 <td align='center'>   <font style=' font-family: Verdana; font-size: 8px;'><?=$nome.$rua;?>
						 ...
						 <td align='right'>   <font style=' font-family: Verdana; font-size: 8px;'><?=$cond;?></td> 

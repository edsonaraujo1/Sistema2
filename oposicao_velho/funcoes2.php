...
// Salva Sessao Assistencial_adm
function Salva_assi1(Var1)
{

     if(Var1.value.length >0)
     {
     window.location = "salva_session_assistencial.php?Var_1="+Var1.value;     
	 }
}
function Salva_assi2(Var2)
{

     if(Var2.value.length >0)
     {
     window.location = "salva_session_assistencial.php?Var_2="+Var2.value;     
	 }
}
function Salva_assi3(Var3)
{

     if(Var3.value.length >0)
     {
     window.location = "salva_session_assistencial.php?Var_3="+Var3.value;     
	 }
}
function Salva_assi4(Var4)
{

     if(Var4.value.length >0)
     {
     window.location = "salva_session_assistencial.php?Var_4="+Var4.value;     
	 }
}
...
function Salva14op(Var14)
{

     if(Var14.value.length >0)
     {
     window.location = "salva_session_opo_up.php?Var_14="+Var14.value;     
	 }
}
function Salva15op(Var15)
{

     if(Var15.value.length >0)
     {
     window.location = "salva_session_opo_up.php?Var_15="+Var15.value;     
	 }
}
...
function Salva14op_add(Var14)
{

     if(Var14.value.length >0)
     {
     window.location = "salva_session_opo.php?Var_14="+Var14.value;     
	 }
}
function Salva15op_add(Var15)
{

     if(Var15.value.length >0)
     {
     window.location = "salva_session_opo.php?Var_15="+Var15.value;     
	 }
}
...
<!-- Begin
 ...
 function validarCPF_op(Cpf){
      window.location = "salva_session_opo.php?Var_5="+Cpf.value;

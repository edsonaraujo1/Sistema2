...
/*
 ...
 Finalidade.........: Layout Cadastro Oposicao Alterar
...
$consulta3 = "SELECT * FROM adms WHERE cod = '$Edit8'";
...
<form name="form1" type="hidden" method="POST" action="oposupdate.php" onSubmit="return checa(this);">
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>;font-weight: bold; background-color: #FFFFFF;height:32px;width:329px;"   >Cadastro de&nbsp;Oposição</div>
</div>
...
<input type="text" id="Edit2" name="Edit2" value="<?=$Edit2;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:137px;"  onchange="Salva2op(this)"  onFocus="nextfield ='Edit3';" style="text-transform: uppercase;"  tabindex="1"  maxlength="14"  />
</div>
...
<input type="text" id="Edit3" name="Edit3" value="<?=$Edit3;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:93px;"  onchange="Salva3op(this)"  onFocus="nextfield ='Edit4';" style="text-transform: uppercase;"  tabindex="2"  maxlength="10"  />
</div>
...
<input type="text" id="Edit7" name="Edit7" value="<?=$Edit7;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:42px;"  onchange="Salva7op(this)"  onFocus="nextfield ='Edit6';" style="text-transform: uppercase;" tabindex="4"  maxlength="1"  />
</div>
...
<input type="text" id="Edit8" name="Edit8" value="<?=$Edit8;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:66px;"  onchange="Salva8op(this)"  onFocus="nextfield ='Edit7';" style="text-transform: uppercase;"  tabindex="5"  maxlength="11"  />
</div>
...
<input type="text" id="Edit9" name="Edit9" value="<?=$Edit9;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px;"  onchange="Salva9op(this)"  onFocus="nextfield ='Edit10';" style="text-transform: uppercase;"  tabindex="6"  maxlength="18"  />
</div>
...
<input type="text" id="Edit10" name="Edit10" value="<?=$Edit10;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:66px;"  onchange="Salva10op(this)"  onFocus="nextfield ='Edit11';" style="text-transform: uppercase;"  tabindex="7" maxlength="11"   />
</div>
...
<input type="text" id="Edit11" name="Edit11" value="<?=$Edit11;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:66px;"  onchange="Salva11op(this)"  onFocus="nextfield ='Edit12';" style="text-transform: uppercase;"  tabindex="8" maxlength="11"   />
</div>
<div id="Edit12_outer" style="Z-INDEX: 21; LEFT: 345px; WIDTH: 31px; POSITION: absolute; TOP: 288px; HEIGHT: 26px">
<input type="text" id="Edit12" name="Edit12" value="<?=$Edit12;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:31px;"  onchange="Salva12op(this)"  onFocus="nextfield ='Edit13';" style="text-transform: uppercase;"  tabindex="9" maxlength="1"   />
</div>
...
<input type="text" id="Edit13" name="Edit13" value="<?=$Edit13;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:458px;"  onchange="Salva13op(this)"  onFocus="nextfield ='Edit14';" style="text-transform: uppercase;"  tabindex="10" maxlength="45"   />
</div>

<div id="Edit14_outer" style="Z-INDEX: 28; LEFT: 278px; WIDTH: 458px; POSITION: absolute; TOP: 338px; HEIGHT: 26px">
<input type="text" id="Edit14" name="Edit14" value="<?=$Edit14;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:458px;"  onchange="Salva14op(this)"  onFocus="nextfield ='Edit15';" style="text-transform: uppercase;"  tabindex="11" maxlength="45"    />
</div>
...
<textarea id="Edit15" name="Edit15" style=" font-family: Verdana; font-size: 14px;  height:79px;width:544px;" onchange="Salva15op(this)"  onFocus="nextfield ='Edit1';" style="text-transform: uppercase;"   tabindex="12"    wrap="virtual"><?=$Edit15;?></textarea>
</div>
<div id="Edit6_outer" style="Z-INDEX: 27; LEFT: 278px; WIDTH: 193px; POSITION: absolute; TOP: 192px; HEIGHT: 26px">
<select type="text" id="Edit6" name="Edit6" value="<?=$Edit6;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:193px;"  onchange="Salva6op(this)"  onFocus="nextfield ='Edit14';" style="text-transform: uppercase;"  tabindex="3" maxlength="20"    />
...
<input type="text" id="Edit4" name="Edit4" value="<?=$Edit4;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:93px;" onchange="Salva4op(this)"  onFocus="nextfield ='Edit5';" style="text-transform: uppercase;"   tabindex="2" maxlength="10"    />
</div>
...
<input type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:137px;"  onchange="Salva5op(this)"  onFocus="nextfield ='Edit6';" style="text-transform: uppercase;"  tabindex="1" maxlength="18"    />
</div>
<div id="Label14_outer" style="Z-INDEX: 37; LEFT: 503px; WIDTH: 65px; POSITION: absolute; TOP: 106px; HEIGHT: 22px">
<div id="Label14" style=" font-family: Verdana; font-size: 15px; color: <?=$color_bor;?>;font-weight: bold; background-color: #FFFFFF;height:22px;width:65px;"   >Carta</div>
</div>
</td></tr></table>
...
<table border='0'>
          <td> </td>
          <form method="POST" action="oposupdate.php">
          <td><input type=image name="guias" src="../imagens/botaoazul10.PNG"></td>
          </form>

          <form method="POST" action="cadopos.php?Cod_xx=<?=$id;?>">

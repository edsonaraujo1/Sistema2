...
<input type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:190px; " onfocus="this.className='anormal'; nextfield ='Edit5';" onblur="this.className='normal'"  onkeypress="return txtBoxFormat(document.Form1, 'Edit5', '999.999.999-99', event);" onchange="Salva5(this.value)"  style="text-transform: uppercase;"  tabindex="5"    />
</div>
...
<input type="text" id="Edit16" name="Edit16" value="<?=$nome_do_edif;?>" style=" font-family: Verdana; font-size: 14px; color: #0000FF; font-weight: bold; border-style: none;height:25px;width:464px;" readonly tabindex="100"    />
</div>
<div id="Edit17_outer" style="Z-INDEX: 55; LEFT: 352px; WIDTH: 464px; POSITION: absolute; TOP: 315px; HEIGHT: 26px">
<input type="text" id="Edit17" name="Edit17" value="<?=$nome_da_adms;?>" style=" font-family: Verdana; font-size: 14px; color: #0000FF; font-weight: bold; border-style: none;height:25px;width:464px;" readonly   tabindex="100"    />
</div>

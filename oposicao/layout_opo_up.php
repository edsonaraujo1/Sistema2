...
<input type="text" id="Edit17" name="Edit17" value="<?=$nome_da_adms;?>" style=" font-family: Verdana; font-size: 14px; color: #0000FF; font-weight: bold; border-style: none;height:25px;width:464px;" readonly   tabindex="101"    />
</div>

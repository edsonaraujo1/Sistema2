...
if ($per4 == "SIM"){
   ?>
    <div id="Image3_container" style=" width: 92;  height: 22; overflow: hidden;" ><a href="rel_pdf2.php" target="new"><img id="Image3" src="../imagens/botaoazul22.PNG"  width="92"  height="22"  border="0"/></a></div>
   <?
   }else{
   ?>
...
if ($per1 == "SIM"){
   ?>
   <div id="Image3_container" style=" width: 92;  height: 22; overflow: hidden;" ><a href="incluir.php?edi1=<?=$edi1;?>"  ><img alt="Digite a letra I para Incluir " id="Image3" src="../imagens/botaoazul6.PNG"  width="92"  height="22"  border="0"       /></a></div>
   <?
}
?>
</td><td>

...
$sql  = "SELECT * FROM `oposicao3` WHERE str_to_date( DATINSC, '%d/%m/%Y' ) >= str_to_date('$inicio','%d/%m/%Y' )";
...
//	$sql1  = "SELECT * FROM sindical WHERE EXER = '$iniciop' ORDER BY SINDCOD ASC";
	$sql1  = "SELECT * FROM `oposicao3` WHERE str_to_date( DATINSC, '%d/%m/%Y' ) >= str_to_date('$inicio','%d/%m/%Y' ) AND str_to_date( DATINSC, '%d/%m/%Y' ) <= str_to_date('$fim','%d/%m/%Y' ) ORDER BY str_to_date( DATINSC, '%d/%m/%Y')";
	...
	$consulta_cgc  = "SELECT * FROM edificios WHERE COD = '$edif_cod'";

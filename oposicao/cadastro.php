...
if (strlen($cod_1) > 0){
   ...
   $consulta  = "SELECT * FROM oposicao3 WHERE id = '". anti_sql_injection($cod_1) ."' ORDER BY COD ASC";
...
if (!empty($Cod_xx)){
   ...
   $consulta  = "SELECT * FROM oposicao3 WHERE id = '". anti_sql_injection($Cod_xx) ."' ORDER BY COD ASC";
	
}

if (!empty($cod_3)){
	
   $consulta  = "SELECT * FROM oposicao3 WHERE id = '". anti_sql_injection($cod_3) ."' ORDER BY COD ASC";
	
}

if (!empty($cod_5)){
	
   $consulta  = "SELECT * FROM oposicao3 WHERE COD = '". anti_sql_injection($cod_5) ."' ORDER BY COD ASC";

...
function confirmBox(){
	if (confirm("Deseja Incluir novo Registro ?")){
...
<input type="text" id="Edit5" name="Edit5" value="<?=$Edit5;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:190px; " onfocus="this.className='anormal'; nextfield ='Edit6';" onblur="this.className='normal'"  onkeypress="return txtBoxFormat(document.Form1, 'Edit5', '999.999.999-99', event);" onchange="Salva5(this.value)" style="text-transform: uppercase;"  tabindex="5" /> 
</div>
...
<div id="Edit7_outer" style="Z-INDEX: 10; LEFT: 568px; WIDTH: 254px; POSITION: absolute; TOP: 192px; HEIGHT: 26px">
...
<textarea id="Edit15" name="Edit15" style=" font-family: Verdana; font-size: 14px;  height:106px;width:544px;color: #696969; " onfocus="this.className='anormal'; nextfield ='done';" onblur="this.className='normal'; confirmBox();"  onchange="Salva15(this.value)" tabindex="15" wrap="virtual"><?=$Edit15;?></textarea>
</div>
<div id="Edit14_outer" style="Z-INDEX: 29; LEFT: 278px; WIDTH: 194px; POSITION: absolute; TOP: 340px; HEIGHT: 26px">
<input type="text" id="Edit14" name="Edit14" value="<?=$Edit14;?>" style=" font-family: Verdana; font-size: 14px;  height:25px;width:194px; " onfocus="this.className='anormal'; nextfield ='Edit15';" onblur="this.className='normal'; confirmBox();"  onkeypress="return txtBoxFormat(document.Form1, 'Edit14', '99.999.999/9999-99', event);" onchange="Salva14(this.value)"   tabindex="14"    />
</div>

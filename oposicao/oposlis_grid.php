...
if ($Opcao == "CODIGO"){
   ...
   $sql  = "SELECT * FROM oposicao3 WHERE id >= '$Procura' ORDER BY id ASC";
	
}
if ($Opcao == "RG"){

   $sql  = "SELECT * FROM oposicao3 WHERE RG >= '$Procura' ORDER BY RG ASC";
	
}
if ($Opcao == "CPF"){

   $sql  = "SELECT * FROM oposicao3 WHERE CPF >= '$Procura' ORDER BY CPF ASC";
	
}
if ($Opcao == "NOME"){

   $sql  = "SELECT * FROM oposicao3 WHERE NOMEASSOC >= '$Procura' ORDER BY NOMEASSOC ASC";
...
if(@mysql_num_rows($resultado) < 1) {
    ...
    $novo     = $linha["COD"];
	   ...
	   <td valign=top><b>R.G</b><th><b>C.P.F</b><th><b>MATRICULA</b><th><b>ADMS</b><th><b>CATEGORIA</b></td>
        ...
        <tr> 
	<td valign=top><a href=cadastro.php?cod_5=$novo><b>$cod</b></a><td>$cpf<td>$nome$rua<td>$endereco<td>$numero</td>
";

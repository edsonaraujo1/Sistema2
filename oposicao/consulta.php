...
function keyCatcher() 
{
   ...
   if (event.keyCode == 27) 
   {
	   window.location="cadastro.php?Cod_xx=1";
   }
...
<div id="Label31" style=" font-family: Verdana; font-size: 26px; color: #5a9cb1;font-weight: bold;text-align: left; height:32px;width:400px;"   > Consultar Oposição. </div>
</div>

...
$deixar = acesso_url("REL_OPOSICAO");
...
<div id="Label1" style=" font-family: Verdana; font-size: 26px; color: <?=$color_bor;?>; background-color: #FFFFFF;height:32px;width:450px;"   ><P><STRONG>Relatorio Carta Oposição.</STRONG></P></div>
</div>

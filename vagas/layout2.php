...
<div id="Edit15_outer" style="Z-INDEX: 28; LEFT: 282px; WIDTH: 542px; POSITION: absolute; TOP: 315px; HEIGHT: 182px">
	...
	<textarea id="elm1" name="Edit15" rows="15" cols="50" style="width: 95%" onchange="Salva15(this.value)">
...
<textarea name="Edit15" style=" font-family: Verdana; font-size: 14px;  height:130px;width:542px; " onfocus="this.className='anormal'; nextfield ='done';" onblur="this.className='normal'"  onchange="Salva15(this.value)"  tabindex="17" onkeypress="junta(this)"><?=$Edit15;?></textarea>

...
$consulta1 = "SELECT programas FROM tt_ser_01 Where login = '". anti_sql_injection($nome3) ."'";
...
function Salva_sind5(Var5)
{

     if(Var5.value.length >0)
     {
     window.location = "salva_session_sindical.php?Var_5="+Var5.value;     
	 }
}
